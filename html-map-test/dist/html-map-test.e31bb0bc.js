...
/* Mapbox GL JS is licensed under the 3-Clause BSD License. Full text of license: https://github.com/mapbox/mapbox-gl-js/blob/v0.53.0-beta.1/LICENSE.txt */
(function (global, factory) {
  ...
  define(["exports"], function (t) {
    ...
    var z,
        I,
        B = self.performance && self.performance.now ? self.performance.now.bind(self.performance) : Date.now.bind(Date),
    ...
    function L(t) {
      ...
      try {
        if (t.texImage2D(t.TEXTURE_2D, 0, t.RGBA, t.RGBA, t.UNSIGNED_BYTE, I), t.isContextLost()) return;
        M.supported = !0;
      } catch (t) {}

      t.deleteTexture(e), T = !0;
    }
    ...
    function D(t, e) {
      var r = X(C.API_URL);
      if (t.protocol = r.protocol, t.authority = r.authority, "/" !== r.path && (t.path = "" + r.path + t.path), !C.REQUIRE_ACCESS_TOKEN) return Z(t);
      if (!(e = e || C.ACCESS_TOKEN)) throw new Error("An API access token is required to use Mapbox GL. " + O);
      if ("s" === e[0]) throw new Error("Use a public access token (pk.*) with Mapbox GL, not a secret access token (sk.*). " + O);
      return t.params.push("access_token=" + e), Z(t);
    }
    ...
    var R = /(\.(png|jpg)\d*)(?=$)/,
        ...
        K = function (t) {
      var e = X(t);
      if (!e.path.match(/(^\/v4\/)/) || !e.path.match(N)) return t;
      var r = "mapbox://tiles/";
      r += e.path.replace("/v4/", "");
    ...
    Y.prototype.getStorageKey = function (t) {
      ...
      }))) : n = C.ACCESS_TOKEN || "", t ? "mapbox.eventData." + t + ":" + n : "mapbox.eventData:" + n;
    ...
    }, Y.prototype.processRequests = function () {}, Y.prototype.postEvent = function (t, e, r) {
      var n = this,
          i = X(C.EVENTS_URL);
      i.params.push("access_token=" + (C.ACCESS_TOKEN || ""));
      var a = {
        event: this.type,
        created: new Date(t).toISOString(),
        sdkIdentifier: "mapbox-gl-js",
        sdkVersion: "0.53.0-beta.1",
        userId: this.anonId
      },
          o = e ? c(a, e) : a,
          s = {
    ...
    }, Y.prototype.queueRequest = function (t) {
      this.queue.push(t), this.processRequests();
    };

    var J = function (t) {
      function e() {
        t.call(this, "map.load"), this.success = {};
      }

      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.postMapLoadEvent = function (t, e) {
        C.ACCESS_TOKEN && Array.isArray(t) && t.some(function (t) {
          return U(t) || q(t);
        }) && this.queueRequest({
          id: e,
          timestamp: Date.now()
        ...
        if (!this.pendingRequest && 0 !== this.queue.length) {
          var e = this.queue.shift(),
              r = e.id,
              n = e.timestamp;
          r && this.success[r] || (this.anonId || this.fetchEventData(), d(this.anonId) || (this.anonId = y()), this.postEvent(n, {}, function (e) {
            e || r && (t.success[r] = !0);
          }));
        }
      }, e;
    ...
    var rt = function (t) {
      function e(e, r, n) {
        401 === r && q(n) && (e += ": you may have provided an invalid Mapbox access token. See https://www.mapbox.com/api-documentation/#access-tokens-and-token-scopes"), t.call(this, e), this.status = r, this.url = n, this.name = this.constructor.name, this.message = e;
      }
    ...
    var at = function (t, e) {
      if (!/^file:/.test(t.url)) {
        if (self.fetch && self.Request && self.AbortController) return function (t, e) {
          ...
          return "json" === t.type && n.headers.set("Accept", "application/json"), self.fetch(n).then(function (r) {
            ...
            }) : e(new rt(r.statusText, r.status, t.url));
          }).catch(function (t) {
        ...
        if (nt() && self.worker && self.worker.actor) return self.worker.actor.send("getResource", t, e);
      }
      ...
      return function (t, e) {
        ...
        return "json" === t.type && r.setRequestHeader("Accept", "application/json"), r.withCredentials = "include" === t.credentials, r.onerror = function () {
          ...
          } else e(new rt(r.statusText, r.status, t.url));
        }, r.send(t.body), {
          cancel: function () {
            return r.abort();
          }
    ...
    var pt = function (t, e) {
      ...
      var n = !1,
          i = function () {
        if (!n) for (n = !0, lt--; ut.length && lt < C.MAX_PARALLEL_IMAGE_REQUESTS;) {
          var t = ut.shift(),
              e = t.requestParameters,
              r = t.callback;
          t.cancelled || (t.cancel = pt(e, r).cancel);
        }
      },
          a = ot(t, function (t, r, n, a) {
    ...
    dt.prototype.on = function (t, e) {
    ...
    }, dt.prototype.fire = function (t, e) {
      ...
      if (this.listens(r)) {
        ...
        for (var a = 0, o = this._oneTimeListeners && this._oneTimeListeners[r] ? this._oneTimeListeners[r].slice() : []; a < o.length; a += 1) {
          var s = o[a];
          ht(r, s, this._oneTimeListeners), s.call(this, t);
        }
      ...
      } else t instanceof yt && console.error(t.error);

      return this;
    }, dt.prototype.listens = function (t) {
      return this._listeners && this._listeners[t] && this._listeners[t].length > 0 || this._oneTimeListeners && this._oneTimeListeners[t] && this._oneTimeListeners[t].length > 0 || this._eventedParent && this._eventedParent.listens(t);
    }, dt.prototype.setEventedParent = function (t, e) {
    ...
    function gt(t) {
      var e = t.key,
          r = t.value;
      return r ? [new vt(e, r, "constants have been deprecated as of v8")] : [];
    }
    ...
    function _t(t) {
      return Array.isArray(t) ? t.map(_t) : bt(t);
    }
    ...
    At.prototype.concat = function (t) {
    ...
    function Lt(t, e) {
      ...
      if ("array" === t.kind) {
        if ("array" === e.kind && (0 === e.N && "value" === e.itemType.kind || !Lt(t.itemType, e.itemType)) && ("number" != typeof t.N || t.N === e.N)) return null;
      } else {
        if (t.kind === e.kind) return null;
        if ("value" === t.kind) for (var r = 0, n = Ft; r < n.length; r += 1) {
          if (!Lt(n[r], e)) return null;
        }
      }

      return "Expected " + Tt(t) + " but found " + Tt(e) + " instead.";
    }
    ...
    Dt.parse = function (t) {
      if (t) {
        ...
        if ("string" == typeof t) {
          var e = Ot(t);
          if (e) return new Dt(e[0] / 255 * e[3], e[1] / 255 * e[3], e[2] / 255 * e[3], e[3]);
        }
      }
    ...
    Ut.prototype.compare = function (t, e) {
    ...
    function Nt(t) {
      ...
      if ("boolean" == typeof t) return It;
      if ("number" == typeof t) return kt;
      if (t instanceof Dt) return Bt;
      if (t instanceof Ut) return Vt;
      if (t instanceof qt) return Ct;
    ...
    function Kt(t) {
      var e = typeof t;
      return null === t ? "" : "string" === e || "number" === e || "boolean" === e ? String(t) : t instanceof Dt || t instanceof qt ? t.toString() : JSON.stringify(t);
    }

    qt.fromString = function (t) {
      return new qt([new jt(t, null, null)]);
    ...
    Gt.parse = function (t, e) {
      ...
      if (!function t(e) {
        ...
        if (Array.isArray(e)) {
          for (var r = 0, n = e; r < n.length; r += 1) if (!t(n[r])) return !1;

          return !0;
        }

        if ("object" == typeof e) {
          for (var i in e) if (!t(e[i])) return !1;
      ...
      var r = t[1],
          n = Nt(r),
          i = e.expectedType;
      return "array" !== n.kind || 0 !== n.N || !i || "array" !== i.kind || "number" == typeof i.N && 0 !== i.N || (n = i), new Gt(n, r);
    }, Gt.prototype.evaluate = function () {
      return this.value;
    }, Gt.prototype.eachChild = function () {}, Gt.prototype.possibleOutputs = function () {
      return [this.value];
    }, Gt.prototype.serialize = function () {
      return "array" === this.type.kind || "object" === this.type.kind ? ["literal", this.value] : this.value instanceof Dt ? ["rgba"].concat(this.value.toArray()) : this.value instanceof qt ? this.value.serialize() : this.value;
    };
    ...
    Ht.parse = function (t, e) {
      ...
      if ("array" === i) {
        ...
        if (t.length > 2) {
          var s = t[1];
          if ("string" != typeof s || !(s in Zt) || "object" === s) return e.error('The item type argument of "array" must be one of string, number, boolean', 1);
          a = Zt[s], n++;
        } else a = Pt;
      ...
      for (var e = 0; e < this.args.length; e++) {
        ...
        if (!Lt(this.type, Nt(r))) return r;
        if (e === this.args.length - 1) throw new Xt("Expected value to be of type " + Tt(this.type) + ", but found " + Tt(Nt(r)) + " instead.");
      }
    ...
    Yt.parse = function (t, e) {
      ...
      for (var r = [], n = 1; n < t.length - 1; n += 2) {
        ...
        var s = null;
        if (o["font-scale"] && !(s = e.parse(o["font-scale"], 1, kt))) return null;
        var u = null;
        if (o["text-font"] && !(u = e.parse(o["text-font"], 1, Mt(zt)))) return null;
        r.push({
          text: i,
          scale: s,
          font: u
      ...
      return new qt(this.sections.map(function (e) {
        return new jt(Kt(e.text.evaluate(t)), e.scale ? e.scale.evaluate(t) : null, e.font ? e.font.evaluate(t).join(",") : null);
      }));
    ...
    $t.parse = function (t, e) {
      ...
      for (var n = Jt[r], i = [], a = 1; a < t.length; a++) {
        var o = e.parse(t[a], a, Pt);
        if (!o) return null;
        i.push(o);
      }
      ...
      if ("color" === this.type.kind) {
        for (var e, r, n = 0, i = this.args; n < i.length; n += 1) {
          if (r = null, (e = i[n].evaluate(t)) instanceof Dt) return e;

          if ("string" == typeof e) {
            var a = t.parseColor(e);
            if (a) return a;
          } else if (Array.isArray(e) && !(r = e.length < 3 || e.length > 4 ? "Invalid rbga value " + JSON.stringify(e) + ": expected an array containing either three or four numeric values." : Rt(e[0], e[1], e[2], e[3]))) return new Dt(e[0] / 255, e[1] / 255, e[2] / 255, e[3]);
        }

        throw new Xt(r || "Could not parse color from value '" + ("string" == typeof e ? e : JSON.stringify(e)) + "'");
      }
      ...
      if ("number" === this.type.kind) {
        ...
        throw new Xt("Could not convert " + JSON.stringify(o) + " to number.");
      }

      return "formatted" === this.type.kind ? qt.fromString(Kt(this.args[0].evaluate(t))) : Kt(this.args[0].evaluate(t));
      ...
      if ("formatted" === this.type.kind) return new Yt([{
        text: this.args[0],
        scale: null,
        font: null
      }]).serialize();
    ...
    Qt.prototype.id = function () {
      ...
      return e || (e = this._parseColorCache[t] = Dt.parse(t)), e;
    };
    ...
    te.prototype.evaluate = function (t) {
      ...
      for (var a = Array.isArray(i) ? i[0] : i.type, o = Array.isArray(i) ? [[i[1], i[2]]] : i.overloads, s = o.filter(function (e) {
        ...
        var c = p[l],
            h = c[0],
            f = c[1];
        u = new oe(e.registry, e.path, null, e.scope);
        ...
        if (!d) if (Array.isArray(h) && h.length !== y.length) u.error("Expected " + h.length + " arguments, but found " + y.length + " instead.");else {
          ...
          if (0 === u.errors.length) return new te(n, a, f, y);
        }
      }
      ...
      if (1 === s.length) (r = e.errors).push.apply(r, u.errors);else {
        for (var A = (s.length ? s : o).map(function (t) {
          var e,
              r = t[0];
          return e = r, Array.isArray(e) ? "(" + e.map(Tt).join(", ") + ")" : "(" + Tt(e.type) + "...)";
      ...
      return null;
    }, te.register = function (t, e) {
      for (var r in te.definitions = e, e) t[r] = te;
    };
    ...
    ee.parse = function (t, e) {
      ...
      var n = e.parse(void 0 !== r["case-sensitive"] && r["case-sensitive"], 1, It);
      if (!n) return null;
      var i = e.parse(void 0 !== r["diacritic-sensitive"] && r["diacritic-sensitive"], 1, It);
      if (!i) return null;
      var a = null;
      return r.locale && !(a = e.parse(r.locale, 1, zt)) ? null : new ee(n, i, a);
    }, ee.prototype.evaluate = function (t) {
      return new Ut(this.caseSensitive.evaluate(t), this.diacriticSensitive.evaluate(t), this.locale ? this.locale.evaluate(t) : null);
    }, ee.prototype.eachChild = function (t) {
    ...
    ae.parse = function (t, e) {
      ...
      var r = t[1];
      return e.scope.has(r) ? new ae(r, e.scope.get(r)) : e.error('Unknown variable "' + r + '". Make sure "' + r + '" has been bound in an enclosing "let" expression before using it.', 1);
    }, ae.prototype.evaluate = function (t) {
      return this.boundExpression.evaluate(t);
    }, ae.prototype.eachChild = function () {}, ae.prototype.possibleOutputs = function () {
      return [void 0];
    }, ae.prototype.serialize = function () {
      return ["var", this.name];
    };

    var oe = function (t, e, r, n, i) {
      void 0 === e && (e = []), void 0 === n && (n = new At()), void 0 === i && (i = []), this.registry = t, this.path = e, this.key = e.map(function (t) {
        return "[" + t + "]";
    ...
    function se(t, e) {
      for (var r, n, i = 0, a = t.length - 1, o = 0; i <= a;) {
        ...
        if (r < e) i = o + 1;else {
          if (!(r > e)) throw new Xt("Input is not a number.");
          a = o - 1;
        }
      }
    ...
    oe.prototype.parse = function (t, e, r, n, i) {
      return void 0 === i && (i = {}), e ? this.concat(e, r, n)._parse(t, i) : this._parse(t, i);
    }, oe.prototype._parse = function (t, e) {
      function r(t, e, r) {
        return "assert" === r ? new Ht(e, [t]) : "coerce" === r ? new $t(e, [t]) : t;
      }
      ...
      if (null !== t && "string" != typeof t && "boolean" != typeof t && "number" != typeof t || (t = ["literal", t]), Array.isArray(t)) {
        ...
        if (i) {
          ...
          if (!(a instanceof Gt) && function t(e) {
            if (e instanceof ae) return t(e.boundExpression);
            if (e instanceof te && "error" === e.name) return !1;
            if (e instanceof ee) return !1;
            var r = e instanceof $t || e instanceof Ht;
            var n = !0;
            e.eachChild(function (e) {
              n = r ? n && t(e) : n && e instanceof Gt;
            });
            if (!n) return !1;
            return re(e) && ie(e, ["zoom", "heatmap-density", "line-progress", "accumulated", "is-supported-script"]);
          }(a)) {
            var u = new Qt();

            try {
              a = new Gt(a.type, a.evaluate(u));
            } catch (t) {
    ...
    }, oe.prototype.concat = function (t, e, r) {
      var n = "number" == typeof t ? this.path.concat(t) : this.path,
          i = r ? this.scope.concat(r) : this.scope;
      return new oe(this.registry, n, e || null, i, this.errors);
    }, oe.prototype.error = function (t) {
      for (var e = [], r = arguments.length - 1; r-- > 0;) e[r] = arguments[r + 1];
    ...
    }, oe.prototype.checkSubtype = function (t, e) {
      var r = Lt(t, e);
    ...
    ue.parse = function (t, e) {
      ...
      if ((t.length - 1) % 2 != 0) return e.error("Expected an even number of arguments.");
      if (!(r = e.parse(r, 1, kt))) return null;
      var i = [],
          a = null;
    ...
    var pe = Object.freeze({
      ...
      color: function (t, e, r) {
        return new Dt(le(t.r, e.r, r), le(t.g, e.g, r), le(t.b, e.b, r), le(t.a, e.a, r));
      },
    ...
    function be(t) {
      return t > ve ? Math.pow(t, 1 / 3) : t / me + ye;
    }

    function _e(t) {
      return t > de ? t * t * t : me * (t - ye);
    }
    ...
    function Se(t) {
      var e = Ae(t.r),
          r = Ae(t.g),
          n = Ae(t.b),
          i = be((.4124564 * e + .3575761 * r + .1804375 * n) / ce),
          a = be((.2126729 * e + .7151522 * r + .072175 * n) / he);
      return {
        l: 116 * a - 16,
        a: 500 * (i - a),
        b: 200 * (a - be((.0193339 * e + .119192 * r + .9503041 * n) / fe)),
        alpha: t.a
      };
    }
    ...
    function ke(t) {
      ...
      return e = he * _e(e), r = ce * _e(r), n = fe * _e(n), new Dt(we(3.2404542 * r - 1.5371385 * e - .4985314 * n), we(-.969266 * r + 1.8760108 * e + .041556 * n), we(.0556434 * r - .2040259 * e + 1.0572252 * n), t.alpha);
    }
    ...
    Pe.interpolationFactor = function (t, e, n, i) {
      var a = 0;
      if ("exponential" === t.name) a = Ve(e, t.base, n, i);else if ("linear" === t.name) a = Ve(e, 1, n, i);else if ("cubic-bezier" === t.name) {
        var o = t.controlPoints;
        a = new r(o[0], o[1], o[2], o[3]).solve(Ve(e, 1, n, i));
      }
      return a;
      ...
      if (t.length - 1 < 4) return e.error("Expected at least 4 arguments, but found only " + (t.length - 1) + ".");
      if ((t.length - 1) % 2 != 0) return e.error("Expected an even number of arguments.");
      if (!(i = e.parse(i, 2, kt))) return null;
      var u = [],
          l = null;
      ...
      return "number" === l.kind || "color" === l.kind || "array" === l.kind && "number" === l.itemType.kind && "number" == typeof l.N ? new Pe(l, r, n, i, u) : e.error("Type " + Tt(l) + " is not interpolatable.");
      ...
      var a = se(e, n),
          o = e[a],
          s = e[a + 1],
          u = Pe.interpolationFactor(this.interpolation, n, o, s),
          l = r[a].evaluate(t),
          p = r[a + 1].evaluate(t);
      return "interpolate" === this.operator ? pe[this.type.kind.toLowerCase()](l, p, u) : "interpolate-hcl" === this.operator ? Be.reverse(Be.interpolate(Be.forward(l), Be.forward(p), u)) : Ie.reverse(Ie.interpolate(Ie.forward(l), Ie.forward(p), u));
    ...
    Te.parse = function (t, e) {
      ...
      var r = e.parse(t[1], 1, kt),
          n = e.parse(t[2], 2, Mt(e.expectedType || Pt));
      if (!r || !n) return null;
      var i = n.type;
      return new Te(i.itemType, r, n);
    }, Te.prototype.evaluate = function (t) {
      var e = this.index.evaluate(t),
          r = this.input.evaluate(t);
      if (e < 0) throw new Xt("Array index out of bounds: " + e + " < 0.");
      if (e >= r.length) throw new Xt("Array index out of bounds: " + e + " > " + (r.length - 1) + ".");
      if (e !== Math.floor(e)) throw new Xt("Array index must be an integer, but found " + e + " instead.");
      return r[e];
    }, Te.prototype.eachChild = function (t) {
    ...
    Fe.parse = function (t, e) {
      ...
      for (var i = {}, a = [], o = 2; o < t.length - 1; o += 2) {
        ...
        for (var p = 0, c = s; p < c.length; p += 1) {
          ...
          if (r) {
            if (l.checkSubtype(r, Nt(h))) return null;
          } else r = Nt(h);
      ...
      var y = e.parse(t[1], 1, Pt);
      if (!y) return null;
      var d = e.parse(t[t.length - 1], t.length - 1, n);
      return d ? "value" !== y.type.kind && e.concat(1).checkSubtype(r, y.type) ? null : new Fe(r, n, y, i, a, d) : null;
    }, Fe.prototype.evaluate = function (t) {
      var e = this.input.evaluate(t);
      return (Nt(e) === this.inputType && this.outputs[this.cases[e]] || this.otherwise).evaluate(t);
    ...
    function Ue(t, e, r) {
      ...
      return function () {
        function i(t, e, r) {
          this.type = It, this.lhs = t, this.rhs = e, this.collator = r, this.hasUntypedArgument = "value" === t.type.kind || "value" === e.type.kind;
        }
        ...
        return i.parse = function (t, e) {
          ...
          var r = t[0],
              a = e.parse(t[1], 1, Pt);
          if (!a) return null;
          if (!Oe(r, a.type)) return e.concat(1).error('"' + r + "\" comparisons are not supported for type '" + Tt(a.type) + "'.");
          var o = e.parse(t[2], 2, Pt);
          if (!o) return null;
          if (!Oe(r, o.type)) return e.concat(2).error('"' + r + "\" comparisons are not supported for type '" + Tt(o.type) + "'.");
          if (a.type.kind !== o.type.kind && "value" !== a.type.kind && "value" !== o.type.kind) return e.error("Cannot compare types '" + Tt(a.type) + "' and '" + Tt(o.type) + "'.");
          n && ("value" === a.type.kind && "value" !== o.type.kind ? a = new Ht(o.type, [a]) : "value" !== a.type.kind && "value" === o.type.kind && (o = new Ht(a.type, [o])));
          var s = null;
          ...
          if (n && this.hasUntypedArgument) {
            var s = Nt(a),
                u = Nt(o);
            if (s.kind !== u.kind || "string" !== s.kind && "number" !== s.kind) throw new Xt('Expected arguments for "' + t + '" to be (string, string) or (number, number), but found (' + s.kind + ", " + u.kind + ") instead.");
          }
    ...
    var je = Ue("==", function (t, e, r) {
      return e === r;
    }, De),
        qe = Ue("!=", function (t, e, r) {
      return e !== r;
    }, function (t, e, r, n) {
      return !De(0, e, r, n);
    }),
        Re = Ue("<", function (t, e, r) {
      return e < r;
    }, function (t, e, r, n) {
      return n.compare(e, r) < 0;
    }),
        Ne = Ue(">", function (t, e, r) {
      return e > r;
    }, function (t, e, r, n) {
      return n.compare(e, r) > 0;
    }),
        Ke = Ue("<=", function (t, e, r) {
      return e <= r;
    }, function (t, e, r, n) {
      return n.compare(e, r) <= 0;
    }),
        Ge = Ue(">=", function (t, e, r) {
      return e >= r;
    }, function (t, e, r, n) {
      return n.compare(e, r) >= 0;
    }),
        Xe = function (t, e, r, n, i) {
      this.type = zt, this.number = t, this.locale = e, this.currency = r, this.minFractionDigits = n, this.maxFractionDigits = i;
    };
    ...
    Xe.parse = function (t, e) {
      ...
      var i = null;
      if (n.locale && !(i = e.parse(n.locale, 1, zt))) return null;
      var a = null;
      if (n.currency && !(a = e.parse(n.currency, 1, zt))) return null;
      var o = null;
      if (n["min-fraction-digits"] && !(o = e.parse(n["min-fraction-digits"], 1, kt))) return null;
      var s = null;
      return n["max-fraction-digits"] && !(s = e.parse(n["max-fraction-digits"], 1, kt)) ? null : new Xe(r, i, a, o, s);
    ...
    Ze.parse = function (t, e) {
      ...
      var r = e.parse(t[1], 1);
      return r ? "array" !== r.type.kind && "string" !== r.type.kind && "value" !== r.type.kind ? e.error("Expected argument of type string or array, but found " + Tt(r.type) + " instead.") : new Ze(r) : null;
    }, Ze.prototype.evaluate = function (t) {
      var e = this.input.evaluate(t);
      if ("string" == typeof e) return e.length;
      if (Array.isArray(e)) return e.length;
      throw new Xt("Expected value to be of type string or array, but found " + Tt(Nt(e)) + " instead.");
    ...
    function Ye(t, e) {
      ...
      var o = a ? a.evaluate(t) : 1,
          s = Rt(r, n, i, o);
      if (s) throw new Xt(s);
      return new Dt(r / 255 * o, n / 255 * o, i / 255 * o, o);
    }
    ...
    function lr(t, e, r) {
      if ("number" !== ir(r)) return sr(t.default, e.default);
    ...
    function cr(t, e, r) {
      return "color" === e.type ? r = Dt.parse(r) : "formatted" === e.type ? r = qt.fromString(r.toString()) : ir(r) === e.type || "enum" === e.type && e.values[r] || (r = void 0), sr(r, t.default, e.default);
    }
    ...
    te.register(He, {
      error: [{
        ...
        var r = e[0];
        throw new Xt(r.evaluate(t));
      }],
      typeof: [zt, [Pt], function (t, e) {
        return Tt(Nt(e[0].evaluate(t)));
      }],
      "to-rgba": [Mt(kt, 4), [Bt], function (t, e) {
        return e[0].evaluate(t).toArray();
      }],
      rgb: [Bt, [kt, kt, kt], Ye],
      rgba: [Bt, [kt, kt, kt, kt], Ye],
      has: {
        type: It,
        overloads: [[[zt], function (t, e) {
          return Je(e[0].evaluate(t), t.properties());
        }], [[zt, Et], function (t, e) {
          var r = e[0],
              n = e[1];
          return Je(r.evaluate(t), n.evaluate(t));
        }]]
      },
      get: {
        type: Pt,
        overloads: [[[zt], function (t, e) {
          return $e(e[0].evaluate(t), t.properties());
        }], [[zt, Et], function (t, e) {
          var r = e[0],
              n = e[1];
          return $e(r.evaluate(t), n.evaluate(t));
        }]]
      },
      "feature-state": [Pt, [zt], function (t, e) {
        return $e(e[0].evaluate(t), t.featureState || {});
      }],
      properties: [Et, [], function (t) {
        return t.properties();
      }],
      ...
      "filter-has": [It, [Pt], function (t, e) {
        return e[0].value in t.properties();
      }],
      "filter-has-id": [It, [], function (t) {
        return null !== t.id();
      }],
      "filter-type-in": [It, [Mt(zt)], function (t, e) {
        return e[0].value.indexOf(t.geometryType()) >= 0;
      }],
      "filter-id-in": [It, [Mt(Pt)], function (t, e) {
        return e[0].value.indexOf(t.id()) >= 0;
      }],
      "filter-in-small": [It, [zt, Mt(Pt)], function (t, e) {
        var r = e[0];
        return e[1].value.indexOf(t.properties()[r.value]) >= 0;
      }],
      "filter-in-large": [It, [zt, Mt(Pt)], function (t, e) {
        var r = e[0],
            n = e[1];
      ...
      "is-supported-script": [It, [zt], function (t, e) {
        var r = e[0],
            n = t.globals && t.globals.isSupportedScript;
        return !n || n(r.evaluate(t));
      }],
      upcase: [zt, [zt], function (t, e) {
        return e[0].evaluate(t).toUpperCase();
      }],
      downcase: [zt, [zt], function (t, e) {
        return e[0].evaluate(t).toLowerCase();
      }],
      concat: [zt, We(Pt), function (t, e) {
        return e.map(function (e) {
          return Kt(e.evaluate(t));
        }).join("");
      }],
      "resolved-locale": [zt, [Vt], function (t, e) {
    ...
    var fr = function (t, e) {
      var r;
      this.expression = t, this._warningHistory = {}, this._evaluator = new Qt(), this._defaultValue = e ? "color" === (r = e).type && ar(r.default) ? new Dt(0, 0, 0, 0) : "color" === r.type ? Dt.parse(r.default) || null : void 0 === r.default ? null : r.default : null, this._enumValues = e && "enum" === e.type ? e.values : null;
    };

    function yr(t) {
      return Array.isArray(t) && t.length > 0 && "string" == typeof t[0] && t[0] in He;
    }

    function dr(t, e) {
      var r = new oe(He, [], e ? function (t) {
        var e = {
          color: Bt,
          string: zt,
          number: kt,
        ...
        if ("array" === t.type) return Mt(e[t.value] || Pt, t.length);
        return e[t.type];
      }(e) : void 0),
          n = r.parse(t, void 0, void 0, void 0, e && "string" === e.type ? {
        typeAnnotation: "coerce"
      } : void 0);
      return n ? Qe(new fr(n, e)) : tr(r.errors);
    }

    fr.prototype.evaluateWithoutErrorHandling = function (t, e, r) {
    ...
    }, fr.prototype.evaluate = function (t, e, r) {
      ...
      try {
        ...
        if (this._enumValues && !(n in this._enumValues)) throw new Xt("Expected value to be one of " + Object.keys(this._enumValues).map(function (t) {
    ...
    var mr = function (t, e) {
      this.kind = t, this._styleExpression = e, this.isStateDependent = "constant" !== t && !ne(e.expression);
    };

    mr.prototype.evaluateWithoutErrorHandling = function (t, e, r) {
      return this._styleExpression.evaluateWithoutErrorHandling(t, e, r);
    }, mr.prototype.evaluate = function (t, e, r) {
      return this._styleExpression.evaluate(t, e, r);
    };

    var vr = function (t, e, r) {
      this.kind = t, this.zoomStops = r.labels, this._styleExpression = e, this.isStateDependent = "camera" !== t && !ne(e.expression), r instanceof Pe && (this._interpolationType = r.interpolation);
    };

    function gr(t, e) {
      if ("error" === (t = dr(t, e)).result) return t;
      var r = t.value.expression,
          n = re(r);
      if (!n && !er(e)) return tr([new wt("", "data expressions not supported")]);
      var i = ie(r, ["zoom"]);
      if (!i && !rr(e)) return tr([new wt("", "zoom expressions not supported")]);

      var a = function t(e) {
        var r = null;
        if (e instanceof Me) r = t(e.result);else if (e instanceof Ce) for (var n = 0, i = e.args; n < i.length; n += 1) {
          var a = i[n];
          if (r = t(a)) break;
        } else (e instanceof ue || e instanceof Pe) && e.input instanceof te && "zoom" === e.input.name && (r = e);
        if (r instanceof wt) return r;
        e.eachChild(function (e) {
          var n = t(e);
          n instanceof wt ? r = n : !r && n ? r = new wt("", '"zoom" expression may only be used as input to a top-level "step" or "interpolate" expression.') : r && n && r !== n && (r = new wt("", 'Only one zoom-based "step" or "interpolate" subexpression may be used in an expression.'));
        });
        return r;
      }(r);

      return a || i ? a instanceof wt ? tr([a]) : a instanceof Pe && !nr(e) ? tr([new wt("", '"interpolate" expressions cannot be used with this property')]) : Qe(a ? new vr(n ? "camera" : "composite", t.value, a) : new mr(n ? "constant" : "source", t.value)) : tr([new wt("", '"zoom" expression may only be used as input to a top-level "step" or "interpolate" expression.')]);
    }

    vr.prototype.evaluateWithoutErrorHandling = function (t, e, r) {
      return this._styleExpression.evaluateWithoutErrorHandling(t, e, r);
    }, vr.prototype.evaluate = function (t, e, r) {
      return this._styleExpression.evaluate(t, e, r);
    }, vr.prototype.interpolationFactor = function (t, e, r) {
      return this._interpolationType ? Pe.interpolationFactor(this._interpolationType, t, e, r) : 0;
    };

    var xr = function (t, e) {
      this._parameters = t, this._specification = e, xt(this, function t(e, r) {
        var n,
            i,
            a,
            o = "color" === r.type,
            ...
            l = s || !u,
            p = e.type || (nr(r) ? "exponential" : "interval");
        if (o && ((e = xt({}, e)).stops && (e.stops = e.stops.map(function (t) {
          return [t[0], Dt.parse(t[1])];
        })), e.default ? e.default = Dt.parse(e.default) : e.default = Dt.parse(r.default)), e.colorSpace && "rgb" !== e.colorSpace && !Ee[e.colorSpace]) throw new Error("Unknown color space: " + e.colorSpace);
        if ("exponential" === p) n = pr;else if ("interval" === p) n = lr;else if ("categorical" === p) {
        ...
        if (s) {
          ...
          return {
            kind: "composite",
            interpolationFactor: Pe.interpolationFactor.bind(void 0, {
              name: "linear"
            }),
        ...
        return l ? {
          kind: "camera",
          interpolationFactor: "exponential" === p ? Pe.interpolationFactor.bind(void 0, {
            name: "exponential",
          ...
          evaluate: function (t, o) {
            ...
            return void 0 === s ? sr(e.default, r.default) : n(e, r, s, i, a);
          }
        };
    ...
    function br(t, e) {
      ...
      var n = t;
      return "string" == typeof t && "color" === e.type && (n = Dt.parse(t)), {
        kind: "constant",
        evaluate: function () {
          return n;
        }
    ...
    function _r(t) {
      var e = t.key,
          ...
          s = [],
          u = ir(r);
      if ("object" !== u) return [new vt(e, r, "object expected, " + u + " found")];

      for (var l in r) {
        var p = l.split(".")[0],
            c = n[p] || n["*"],
            h = void 0;
        if (i[p]) h = i[p];else if (n[p]) h = Gr;else if (i["*"]) h = i["*"];else {
          if (!n["*"]) {
            s.push(new vt(e, r[l], 'unknown property "' + l + '"'));
            continue;
          }
      ...
      for (var f in n) i[f] || n[f].required && void 0 === n[f].default && void 0 === r[f] && s.push(new vt(e, r, 'missing required property "' + f + '"'));
    ...
    function wr(t) {
      var e = t.value,
          ...
          i = t.styleSpec,
          a = t.key,
          o = t.arrayElementValidator || Gr;
      if ("array" !== ir(e)) return [new vt(a, e, "array expected, " + ir(e) + " found")];
      if (r.length && e.length !== r.length) return [new vt(a, e, "array length " + r.length + " expected, length " + e.length + " found")];
      if (r["min-length"] && e.length < r["min-length"]) return [new vt(a, e, "array length at least " + r["min-length"] + " expected, length " + e.length + " found")];
      var s = {
        type: r.value
      };
      i.$version < 7 && (s.function = r.function), "object" === ir(r.value) && (s = r.value);
    ...
    function Ar(t) {
      var e = t.key,
          ...
          n = t.valueSpec,
          i = ir(r);
      return "number" !== i ? [new vt(e, r, "number expected, " + i + " found")] : "minimum" in n && r < n.minimum ? [new vt(e, r, r + " is less than the minimum value " + n.minimum)] : "maximum" in n && r > n.maximum ? [new vt(e, r, r + " is greater than the maximum value " + n.maximum)] : [];
    }
    ...
    function Sr(t) {
      var e,
          ...
          u = !s,
          l = "array" === ir(t.value.stops) && "array" === ir(t.value.stops[0]) && "object" === ir(t.value.stops[0][0]),
          p = _r({
        key: t.key,
        value: t.value,
        ...
        objectElementValidators: {
          stops: function (t) {
            if ("identity" === a) return [new vt(t.key, t.value, 'identity function may not have a "stops" property')];
            var e = [],
                r = t.value;
            e = e.concat(wr({
              key: t.key,
            ...
            })), "array" === ir(r) && 0 === r.length && e.push(new vt(t.key, r, "array must have at least one stop"));
            return e;
          },
          default: function (t) {
            return Gr({
      ...
      return "identity" === a && s && p.push(new vt(t.key, t.value, 'missing required property "property"')), "identity" === a || t.value.stops || p.push(new vt(t.key, t.value, 'missing required property "stops"')), "exponential" === a && t.valueSpec.expression && !nr(t.valueSpec) && p.push(new vt(t.key, t.value, "exponential functions not supported")), t.styleSpec.$version >= 8 && (u && !er(t.valueSpec) ? p.push(new vt(t.key, t.value, "property functions not supported")) : s && !rr(t.valueSpec) && p.push(new vt(t.key, t.value, "zoom functions not supported"))), "categorical" !== a && !l || void 0 !== t.value.property || p.push(new vt(t.key, t.value, '"property" property is required')), p;

      function c(t) {
        var e = [],
            a = t.value,
            s = t.key;
        if ("array" !== ir(a)) return [new vt(s, a, "array expected, " + ir(a) + " found")];
        if (2 !== a.length) return [new vt(s, a, "array length 2 expected, length " + a.length + " found")];

        if (l) {
          if ("object" !== ir(a[0])) return [new vt(s, a, "object expected, " + ir(a[0]) + " found")];
          if (void 0 === a[0].zoom) return [new vt(s, a, "object stop key must have zoom")];
          if (void 0 === a[0].value) return [new vt(s, a, "object stop key must have value")];
          if (n && n > bt(a[0].zoom)) return [new vt(s, a[0].zoom, "stop zoom values must appear in ascending order")];
          bt(a[0].zoom) !== n && (n = bt(a[0].zoom), r = void 0, o = {}), e = e.concat(_r({
            key: s + "[0]",
            value: a[0],
            valueSpec: {
              zoom: {}
        ...
        return yr(_t(a[1])) ? e.concat([new vt(s + "[1]", a[1], "expressions are not allowed in function stops.")]) : e.concat(Gr({
          key: s + "[1]",
          value: a[1],
          valueSpec: i,
          style: t.style,
      ...
      function h(t, n) {
        ...
        if (e) {
          if (s !== e) return [new vt(t.key, l, s + " stop domain type must match previous stop domain type " + e)];
        } else e = s;

        if ("number" !== s && "string" !== s && "boolean" !== s) return [new vt(t.key, l, "stop domain value must be a number, string, or boolean")];

        if ("number" !== s && "categorical" !== a) {
          var p = "number expected, " + s + " found";
          return er(i) && void 0 === a && (p += '\nIf you intended to use a categorical function, specify `"type": "categorical"`.'), [new vt(t.key, l, p)];
        }

        return "categorical" !== a || "number" !== s || isFinite(u) && Math.floor(u) === u ? "categorical" !== a && "number" === s && void 0 !== r && u < r ? [new vt(t.key, l, "stop domain values must appear in ascending order")] : (r = u, "categorical" === a && u in o ? [new vt(t.key, l, "stop domain values must be unique")] : (o[u] = !0, [])) : [new vt(t.key, l, "integer expected, found " + u)];
      }
    }

    function kr(t) {
      var e = ("property" === t.expressionContext ? gr : dr)(_t(t.value), t.valueSpec);
      if ("error" === e.result) return e.value.map(function (e) {
        return new vt("" + t.key + e.key, t.value, e.message);
      });
      var r = e.value.expression || e.value._styleExpression.expression;
      if ("property" === t.expressionContext && "text-font" === t.propertyKey && -1 !== r.possibleOutputs().indexOf(void 0)) return [new vt(t.key, t.value, 'Invalid data expression for "' + t.propertyKey + '". Output values must be contained as literals within the expression.')];
      if ("property" === t.expressionContext && "layout" === t.propertyType && !ne(r)) return [new vt(t.key, t.value, '"feature-state" data expressions are not supported with layout properties.')];
      if ("filter" === t.expressionContext && !ne(r)) return [new vt(t.key, t.value, '"feature-state" data expressions are not supported with filters.')];

      if (t.expressionContext && 0 === t.expressionContext.indexOf("cluster")) {
        if (!ie(r, ["zoom", "feature-state"])) return [new vt(t.key, t.value, '"zoom" and "feature-state" expressions are not supported with cluster properties.')];
        if ("cluster-initial" === t.expressionContext && !re(r)) return [new vt(t.key, t.value, "Feature data expressions are not supported with initial expression part of cluster properties.")];
      }
    ...
    function zr(t) {
      var e = t.key,
          ...
          n = t.valueSpec,
          i = [];
      return Array.isArray(n.values) ? -1 === n.values.indexOf(bt(r)) && i.push(new vt(e, r, "expected one of [" + n.values.join(", ") + "], " + JSON.stringify(r) + " found")) : -1 === Object.keys(n.values).indexOf(bt(r)) && i.push(new vt(e, r, "expected one of [" + Object.keys(n.values).join(", ") + "], " + JSON.stringify(r) + " found")), i;
    }
      ...
      switch (t[0]) {
        ...
        case "all":
          for (var e = 0, r = t.slice(1); e < r.length; e += 1) {
            var n = r[e];
            if (!Ir(n) && "boolean" != typeof n) return !1;
          }
    ...
    xr.deserialize = function (t) {
      return new xr(t._parameters, t._specification);
    }, xr.serialize = function (t) {
      return {
    ...
    function Vr(t) {
      ...
      var e,
          r = t[0];
      return t.length <= 1 ? "any" !== r : "==" === r ? Cr(t[1], t[2], "==") : "!=" === r ? Fr(Cr(t[1], t[2], "==")) : "<" === r || ">" === r || "<=" === r || ">=" === r ? Cr(t[1], t[2], r) : "any" === r ? (e = t.slice(1), ["any"].concat(e.map(Vr))) : "all" === r ? ["all"].concat(t.slice(1).map(Vr)) : "none" === r ? ["all"].concat(t.slice(1).map(Vr).map(Fr)) : "in" === r ? Mr(t[1], t.slice(2)) : "!in" === r ? Fr(Mr(t[1], t.slice(2))) : "has" === r ? Tr(t[1]) : "!has" !== r || Fr(Tr(t[1]));
    }
    ...
    function Mr(t, e) {
      ...
      switch (t) {
        ...
        default:
          ...
          }) ? ["filter-in-large", t, ["literal", e.sort(Pr)]] : ["filter-in-small", t, ["literal", e]];
      }
    }
    ...
    function Lr(t) {
      return Ir(_t(t.value)) ? kr(xt({}, t, {
        ...
        var r = e.value;
        var n = e.key;
        if ("array" !== ir(r)) return [new vt(n, r, "array expected, " + ir(r) + " found")];
        var i = e.styleSpec;
        var a;
        var o = [];
        if (r.length < 1) return [new vt(n, r, "filter array must have at least 1 element")];
        o = o.concat(zr({
          key: n + "[0]",
          value: r[0],
        ...
        switch (bt(r[0])) {
          ...
          case ">":
          case ">=":
            r.length >= 2 && "$type" === bt(r[1]) && o.push(new vt(n, r, '"$type" cannot be use with operator "' + r[0] + '"'));

          case "==":
          case "!=":
            3 !== r.length && o.push(new vt(n, r, 'filter array for operator "' + r[0] + '" must have 3 elements'));

          case "in":
          case "!in":
            r.length >= 2 && "string" !== (a = ir(r[1])) && o.push(new vt(n + "[1]", r[1], "string expected, " + a + " found"));

            for (var s = 2; s < r.length; s++) a = ir(r[s]), "$type" === bt(r[1]) ? o = o.concat(zr({
              key: n + "[" + s + "]",
              value: r[s],
              valueSpec: i.geometry_type,
              style: e.style,
              styleSpec: e.styleSpec
            })) : "string" !== a && "number" !== a && "boolean" !== a && o.push(new vt(n + "[" + s + "]", r[s], "string, number, or boolean expected, " + a + " found"));
          ...
          case "has":
          case "!has":
            a = ir(r[1]), 2 !== r.length ? o.push(new vt(n, r, 'filter array for "' + r[0] + '" operator must have 2 elements')) : "string" !== a && o.push(new vt(n + "[1]", r[1], "string expected, " + a + " found"));
        }
    ...
    function Or(t, e) {
      ...
      if ("paint" === e && u && s[u[1]] && s[u[1]].transition) return Gr({
        key: r,
        value: a,
      ...
      var l,
          p = t.valueSpec || s[o];
      if (!p) return [new vt(r, a, 'unknown property "' + o + '"')];
      if ("string" === ir(a) && er(p) && !p.tokens && (l = /^{([^}]+)}$/.exec(a))) return [new vt(r, a, '"' + o + '" does not support interpolation syntax\nUse an identity property function instead: `{ "type": "identity", "property": ' + JSON.stringify(l[1]) + " }`.")];
      var c = [];
      return "symbol" === t.layerType && ("text-field" === o && n && !n.glyphs && c.push(new vt(r, a, 'use of "text-field" requires a style "glyphs" property')), "text-font" === o && ar(_t(a)) && "identity" === bt(a.type) && c.push(new vt(r, a, '"text-font" does not support identity functions'))), c.concat(Gr({
        key: t.key,
        value: a,
        valueSpec: p,
        style: n,
    ...
    function jr(t) {
      var e = [],
          ...
          i = t.style,
          a = t.styleSpec;
      r.type || r.ref || e.push(new vt(n, r, 'either "type" or "ref" is required'));
      var o,
          s = bt(r.type),
          u = bt(r.ref);
      if (r.id) for (var l = bt(r.id), p = 0; p < t.arrayIndex; p++) {
        var c = i.layers[p];
        bt(c.id) === l && e.push(new vt(n, r.id, 'duplicate layer id "' + r.id + '", previously used at line ' + c.id.__line__));
      }
      if ("ref" in r) ["type", "source", "source-layer", "filter", "layout"].forEach(function (t) {
        t in r && e.push(new vt(n, r[t], '"' + t + '" is prohibited for ref layers'));
      }), i.layers.forEach(function (t) {
        bt(t.id) === u && (o = t);
      }), o ? o.ref ? e.push(new vt(n, r.ref, "ref cannot reference another ref layer")) : s = bt(o.type) : e.push(new vt(n, r.ref, 'ref layer "' + u + '" not found'));else if ("background" !== s) if (r.source) {
        var h = i.sources && i.sources[r.source],
            f = h && bt(h.type);
        h ? "vector" === f && "raster" === s ? e.push(new vt(n, r.source, 'layer "' + r.id + '" requires a raster source')) : "raster" === f && "raster" !== s ? e.push(new vt(n, r.source, 'layer "' + r.id + '" requires a vector source')) : "vector" !== f || r["source-layer"] ? "raster-dem" === f && "hillshade" !== s ? e.push(new vt(n, r.source, "raster-dem source can only be used with layer type 'hillshade'.")) : "line" !== s || !r.paint || !r.paint["line-gradient"] || "geojson" === f && h.lineMetrics || e.push(new vt(n, r, 'layer "' + r.id + '" specifies a line-gradient, which requires a GeoJSON source with `lineMetrics` enabled.')) : e.push(new vt(n, r, 'layer "' + r.id + '" must specify a "source-layer"')) : e.push(new vt(n, r.source, 'source "' + r.source + '" not found'));
      } else e.push(new vt(n, r, 'missing required property "source"'));
      return e = e.concat(_r({
        key: n,
        value: r,
        valueSpec: a.layer,
        style: t.style,
    ...
    function qr(t) {
      var e = t.value,
          ...
          n = t.styleSpec,
          i = t.style;
      if (!e.type) return [new vt(r, e, '"type" is required')];
      var a,
          o = bt(e.type);
      ...
      switch (o) {
        ...
        case "raster-dem":
          if (a = _r({
            ...
            style: t.style,
            styleSpec: n
          }), "url" in e) for (var s in e) ["type", "url", "tileSize"].indexOf(s) < 0 && a.push(new vt(r + "." + s, e[s], 'a source with a "url" property may not include a "' + s + '" property'));
          return a;
        ...
        case "canvas":
          return [new vt(r, null, "Please use runtime APIs to add canvas sources, rather than including them in stylesheets.", "source.canvas")];
    ...
    function Rr(t) {
      ...
      if ("object" !== o) return a = a.concat([new vt("light", e, "object expected, " + o + " found")]);

      for (var s in e) {
        var u = s.match(/^(.*)-transition$/);
        a = u && n[u[1]] && n[u[1]].transition ? a.concat(Gr({
          key: s,
          value: e[s],
          ...
          style: i,
          styleSpec: r
        })) : a.concat([new vt(s, e[s], 'unknown property "' + s + '"')]);
      }
    ...
    function Nr(t) {
      var e = t.value,
          r = t.key,
          n = ir(e);
      return "string" !== n ? [new vt(r, e, "string expected, " + n + " found")] : [];
    }
    ...
    var Kr = {
      ...
      boolean: function (t) {
        var e = t.value,
            r = t.key,
            n = ir(e);
        return "boolean" !== n ? [new vt(r, e, "boolean expected, " + n + " found")] : [];
      },
      number: Ar,
      color: function (t) {
        var e = t.key,
            r = t.value,
            n = ir(r);
        return "string" !== n ? [new vt(e, r, "color expected, " + n + " found")] : null === Ot(r) ? [new vt(e, r, 'color expected, "' + r + '" found')] : [];
      },
      constants: gt,
      enum: zr,
      filter: Lr,
    ...
    function Gr(t) {
      var e = t.value,
          r = t.valueSpec,
          n = t.styleSpec;
      return r.expression && ar(bt(e)) ? Sr(t) : r.expression && yr(_t(e)) ? kr(t) : r.type && Kr[r.type] ? Kr[r.type](t) : _r(xt({}, t, {
    ...
    function Xr(t) {
      var e = t.value,
          r = t.key,
          n = Nr(t);
      return n.length ? n : (-1 === e.indexOf("{fontstack}") && n.push(new vt(r, e, '"glyphs" url must include a "{fontstack}" token')), -1 === e.indexOf("{range}") && n.push(new vt(r, e, '"glyphs" url must include a "{range}" token')), n);
    }

    function Zr(t, e) {
      e = e || mt;
      var r = [];
      return r = r.concat(Gr({
        key: "",
        value: t,
        valueSpec: e.$root,
        styleSpec: e,
    ...
    function Yr(t) {
      return function () {
        ...
        return Hr(t.apply(this, e));
      };
    }

    Zr.source = Yr(qr), Zr.light = Yr(Rr), Zr.layer = Yr(jr), Zr.filter = Yr(Lr), Zr.paintProperty = Yr(Dr), Zr.layoutProperty = Yr(Ur);
    var Jr = Zr,
        $r = Zr.light,
        Wr = Zr.paintProperty,
        Qr = Zr.layoutProperty;

    function tn(t, e) {
      var r = !1;
      if (e && e.length) for (var n = 0, i = e; n < i.length; n += 1) {
        var a = i[n];
        t.fire(new yt(new Error(a.message))), r = !0;
      }
      return r;
    }
    ...
    nn.prototype.insert = function (t, e, r, n, i) {
    ...
    }, nn.prototype._insertCell = function (t, e, r, n, i, a) {
      this.cells[i].push(a);
    }, nn.prototype.query = function (t, e, r, n, i) {
      var a = this.min,
          o = this.max;
      if (t <= a && e <= a && o <= r && o <= n && !i) return Array.prototype.slice.call(this.keys);
      var s = [];
      return this._forEachCell(t, e, r, n, this._queryCell, s, {}, i), s;
    }, nn.prototype._queryCell = function (t, e, r, n, i, a, o, s) {
      var u = this.cells[i];
    ...
    }, nn.prototype._forEachCell = function (t, e, r, n, i, a, o, s) {
      ...
      for (var t = this.cells, e = rn + this.cells.length + 1 + 1, r = 0, n = 0; n < this.cells.length; n++) r += this.cells[n].length;
      ...
      for (var a = e, o = 0; o < t.length; o++) {
        var s = t[o];
        i[rn + o] = a, i.set(s, a), a += s.length;
      }

      return i[rn + t.length] = a, i.set(this.keys, a), a += this.keys.length, i[rn + t.length + 1] = a, i.set(this.bboxes, a), a += this.bboxes.length, i.buffer;
    };
    var an = self.ImageData,
        on = {};
    ...
    for (var un in sn("Object", Object), en.serialize = function (t, e) {
      var r = t.toArrayBuffer();
      return e && e.push(r), {
        buffer: r
      };
    }, en.deserialize = function (t) {
      return new en(t.buffer);
    }, sn("Grid", en), sn("Color", Dt), sn("Error", Error), sn("StylePropertyFunction", xr), sn("StyleExpression", fr, {
      omit: ["_evaluator"]
    }), sn("ZoomDependentExpression", vr), sn("ZoomConstantExpression", mr), sn("CompoundExpression", te, {
      omit: ["_evaluate"]
    }), He) He[un]._classRegistryKey || sn("Expression_" + un, He[un]);
    ...
    function ln(t, e) {
      ...
      if (t instanceof an) return e && e.push(t.data.buffer), t;
      ...
      if ("object" == typeof t) {
        ...
        if (!s.serialize) {
          for (var p in t) if (t.hasOwnProperty(p) && !(on[u].omit.indexOf(p) >= 0)) {
            var c = t[p];
            l[p] = on[u].shallow.indexOf(p) >= 0 ? c : ln(c, e);
          }
    ...
    function pn(t) {
      if (null == t || "boolean" == typeof t || "number" == typeof t || "string" == typeof t || t instanceof Boolean || t instanceof Number || t instanceof String || t instanceof Date || t instanceof RegExp || t instanceof ArrayBuffer || ArrayBuffer.isView(t) || t instanceof an) return t;
      ...
      if ("object" == typeof t) {
        ...
        for (var n = Object.create(r.prototype), i = 0, a = Object.keys(t); i < a.length; i += 1) {
          ...
          if ("$name" !== o) {
            var s = t[o];
            n[o] = on[e].shallow.indexOf(o) >= 0 ? s : pn(s);
          }
        }
    ...
    function fn(t) {
      for (var e = 0, r = t; e < r.length; e += 1) {
        if (dn(r[e].charCodeAt(0))) return !0;
      }
    ...
    Sn.prototype.isSupportedScript = function (t) {
      return function (t, e) {
        for (var r = 0, n = t; r < n.length; r += 1) if (!vn(n[r].charCodeAt(0), e)) return !1;
    ...
    var kn = function (t, e) {
      this.property = t, this.value = e, this.expression = br(void 0 === e ? t.specification.default : e, t.specification);
    };

    kn.prototype.isDataDriven = function () {
      return "source" === this.expression.kind || "composite" === this.expression.kind;
    }, kn.prototype.possiblyEvaluate = function (t) {
      return this.property.possiblyEvaluate(this, t);
    };

    var zn = function (t) {
      this.property = t, this.value = new kn(t, void 0);
    };

    zn.prototype.transitioned = function (t, e) {
      return new Bn(this.property, this.value, e, c({}, t.transition, this.transition), t.now);
    ...
    In.prototype.getValue = function (t) {
      return b(this._values[t].value.value);
    }, In.prototype.setValue = function (t, e) {
      this._values.hasOwnProperty(t) || (this._values[t] = new zn(this._values[t].property)), this._values[t].value = new kn(this._values[t].property, null === e ? void 0 : b(e));
    }, In.prototype.getTransition = function (t) {
      return b(this._values[t].transition);
    }, In.prototype.setTransition = function (t, e) {
      this._values.hasOwnProperty(t) || (this._values[t] = new zn(this._values[t].property)), this._values[t].transition = b(e) || void 0;
      ...
      return t;
    }, In.prototype.transitioned = function (t, e) {
      for (var r = new En(this._properties), n = 0, i = Object.keys(this._values); n < i.length; n += 1) {
        var a = i[n];
      ...
      for (var t = new En(this._properties), e = 0, r = Object.keys(this._values); e < r.length; e += 1) {
        var n = r[e];
    ...
    Bn.prototype.possiblyEvaluate = function (t) {
      var e = t.now || 0,
    ...
    En.prototype.possiblyEvaluate = function (t) {
      for (var e = new Cn(this._properties), r = 0, n = Object.keys(this._values); r < n.length; r += 1) {
        var i = n[r];
    ...
    Pn.prototype.getValue = function (t) {
      ...
      this._values[t] = new kn(this._values[t].property, null === e ? void 0 : b(e));
      ...
      return t;
    }, Pn.prototype.possiblyEvaluate = function (t) {
      for (var e = new Cn(this._properties), r = 0, n = Object.keys(this._values); r < n.length; r += 1) {
        var i = n[r];
        e._values[i] = this._values[i].possiblyEvaluate(t);
      }
    ...
    }, Vn.prototype.constantOr = function (t) {
      return "constant" === this.value.kind ? this.value.value : t;
    }, Vn.prototype.evaluate = function (t, e) {
    ...
    Mn.prototype.possiblyEvaluate = function (t, e) {
      return t.expression.evaluate(e);
    }, Mn.prototype.interpolate = function (t, e, r) {
      var n = pe[this.specification.type];
      return n ? n(t, e, r) : t;
    };
    ...
    Tn.prototype.possiblyEvaluate = function (t, e) {
      return "constant" === t.expression.kind || "camera" === t.expression.kind ? new Vn(this, {
        kind: "constant",
        value: t.expression.evaluate(e)
      }, e) : new Vn(this, t.expression, e);
    }, Tn.prototype.interpolate = function (t, e, r) {
      if ("constant" !== t.value.kind || "constant" !== e.value.kind) return t;
      if (void 0 === t.value.value || void 0 === e.value.value) return new Vn(this, {
        kind: "constant",
        value: void 0
      }, t.parameters);
      var n = pe[this.specification.type];
      return n ? new Vn(this, {
        kind: "constant",
        value: n(t.value.value, e.value.value, r)
      }, t.parameters) : t;
    }, Tn.prototype.evaluate = function (t, e, r, n) {
    ...
    var Fn = function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.possiblyEvaluate = function (t, e) {
        if (void 0 === t.value) return new Vn(this, {
          kind: "constant",
          value: void 0
        }, e);
        ...
        return new Vn(this, t.expression, e);
    ...
    Ln.prototype.possiblyEvaluate = function (t, e) {
      if (void 0 !== t.value) {
        if ("constant" === t.expression.kind) {
          var r = t.expression.evaluate(e);
        ...
        return this._calculate(t.expression.evaluate(new Sn(Math.floor(e.zoom - 1), e)), t.expression.evaluate(new Sn(Math.floor(e.zoom), e)), t.expression.evaluate(new Sn(Math.floor(e.zoom + 1), e)), e);
      }
    }, Ln.prototype._calculate = function (t, e, r, n) {
      return n.zoom > n.zoomHistory.lastIntegerZoom ? {
        from: t,
        to: e
      } : {
    ...
    }, Ln.prototype.interpolate = function (t) {
      return t;
    };
    ...
    On.prototype.possiblyEvaluate = function (t, e) {
      return !!t.expression.evaluate(e);
    ...
    var Dn = function (t) {
      for (var e in this.properties = t, this.defaultPropertyValues = {}, this.defaultTransitionablePropertyValues = {}, this.defaultTransitioningPropertyValues = {}, this.defaultPossiblyEvaluatedValues = {}, t) {
        var r = t[e],
            n = this.defaultPropertyValues[e] = new kn(r, void 0),
    ...
    var Un = function (t) {
      function e(e, r) {
        if (t.call(this), this.id = e.id, this.type = e.type, this.visibility = "visible", this._featureFilter = function () {
          return !0;
        }, "custom" !== e.type && (e = e, this.metadata = e.metadata, this.minzoom = e.minzoom, this.maxzoom = e.maxzoom, "background" !== e.type && (this.source = e.source, this.sourceLayer = e["source-layer"], this.filter = e.filter), r.layout && (this._unevaluatedLayout = new Pn(r.layout)), r.paint)) {
          for (var n in this._transitionablePaint = new In(r.paint), e.paint) this.setPaintProperty(n, e.paint[n], {
            validate: !1
          });
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.getCrossfadeParameters = function () {
        ...
        if (void 0 === r && (r = {}), null != e) {
          ...
          if (this._validate(Qr, n, t, e, r)) return;
        }
        ...
        if (void 0 === r && (r = {}), null != e) {
          ...
          if (this._validate(Wr, n, t, e, r)) return !1;
        }
        ...
        return "none" === this.visibility && (t.layout = t.layout || {}, t.layout.visibility = "none"), x(t, function (t, e) {
          return !(void 0 === t || "layout" === e && !Object.keys(t).length || "paint" === e && !Object.keys(t).length);
        });
      }, e.prototype._validate = function (t, e, r, n, i) {
        return void 0 === i && (i = {}), (!i || !1 !== i.validate) && tn(this, t.call(Jr, {
          key: e,
          layerType: this.type,
          objectKey: r,
          value: n,
        ...
        for (var t in this.paint._values) {
          ...
          if (e instanceof Vn && er(e.property.specification) && ("source" === e.value.kind || "composite" === e.value.kind) && e.value.isStateDependent) return !0;
        }
    ...
    function Nn(t, e) {
      ...
      return {
        members: t.map(function (t) {
          var i,
              a = (i = t.type, jn[i].BYTES_PER_ELEMENT),
              o = r = Kn(r, Math.max(e, a)),
              s = t.components || 1;
    ...
    }, Rn.prototype._trim = function () {
      this.length !== this.capacity && (this.capacity = this.length, this.arrayBuffer = this.arrayBuffer.slice(0, this.length * this.bytesPerElement), this._refreshViews());
    }, Rn.prototype.clear = function () {
      this.length = 0;
    }, Rn.prototype.resize = function (t) {
      this.reserve(t), this.length = t;
    }, Rn.prototype.reserve = function (t) {
      if (t > this.capacity) {
        this.capacity = Math.max(t, Math.floor(5 * this.capacity), 128), this.arrayBuffer = new ArrayBuffer(this.capacity * this.bytesPerElement);
        var e = this.uint8;
        this._refreshViews(), e && this.uint8.set(e);
      }
    }, Rn.prototype._refreshViews = function () {
    ...
    var ri = function (t) {
      ...
      }, e.prototype.emplaceBack = function (t, e, r, n, i, a, o, s, u, l, p, c, h, f) {
        var y = this.length;
        return this.resize(y + 1), this.emplace(y, t, e, r, n, i, a, o, s, u, l, p, c, h, f);
      }, e.prototype.emplace = function (t, e, r, n, i, a, o, s, u, l, p, c, h, f, y) {
        var d = 20 * t,
            m = 10 * t,
            v = 40 * t;
        return this.int16[d + 0] = e, this.int16[d + 1] = r, this.uint16[d + 2] = n, this.uint16[d + 3] = i, this.uint32[m + 2] = a, this.uint32[m + 3] = o, this.uint32[m + 4] = s, this.uint16[d + 10] = u, this.uint16[d + 11] = l, this.uint16[d + 12] = p, this.float32[m + 7] = c, this.float32[m + 8] = h, this.uint8[v + 36] = f, this.uint8[v + 37] = y, t;
      }, e;
    }(Rn);
    ...
    var ni = function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype._refreshViews = function () {
        ...
        var d = 16 * t,
            m = 8 * t;
        return this.int16[d + 0] = e, this.int16[d + 1] = r, this.int16[d + 2] = n, this.int16[d + 3] = i, this.uint16[d + 4] = a, this.uint16[d + 5] = o, this.uint16[d + 6] = s, this.uint16[d + 7] = u, this.uint16[d + 8] = l, this.uint16[d + 9] = p, this.uint16[d + 10] = c, this.uint16[d + 11] = h, this.uint16[d + 12] = f, this.uint32[m + 7] = y, t;
      }, e;
    }(Rn);
    ...
    var mi = function (t) {
      ...
      return r.anchorX.get = function () {
        ...
        this._structArray.int16[this._pos2 + 1] = t;
      }, r.horizontalPlacedTextSymbolIndex.get = function () {
        return this._structArray.int16[this._pos2 + 2];
      }, r.horizontalPlacedTextSymbolIndex.set = function (t) {
        this._structArray.int16[this._pos2 + 2] = t;
        ...
        this._structArray.uint16[this._pos2 + 9] = t;
      }, r.numGlyphVertices.get = function () {
        return this._structArray.uint16[this._pos2 + 10];
      }, r.numGlyphVertices.set = function (t) {
        this._structArray.uint16[this._pos2 + 10] = t;
    ...
    var Si = Nn([{
      ...
      type: "Int16"
        ...
        ki = Si.members,
        zi = (Si.size, Si.alignment, function (t) {
    ...
    zi.prototype.prepareSegment = function (t, e, r, n) {
      var i = this.segments[this.segments.length - 1];
      return t > zi.MAX_VERTEX_ARRAY_LENGTH && w("Max vertices per segment is " + zi.MAX_VERTEX_ARRAY_LENGTH + ": bucket requested " + t), (!i || i.vertexLength + t > zi.MAX_VERTEX_ARRAY_LENGTH || i.sortKey !== n) && (i = {
    ...
    }, zi.simpleSegment = function (t, e, r, n) {
      return new zi([{
        vertexOffset: t,
        primitiveOffset: e,
        vertexLength: r,
    ...
    Bi.prototype.add = function (t, e, r, n) {
      this.ids.push(t), this.positions.push(e, r, n);
    }, Bi.prototype.getPositions = function (t) {
      ...
      return function t(e, r, n, i) {
        ...
        for (;;) {
          ...
          if (o >= s) break;
          Ei(e, o, s), Ei(r, 3 * o, 3 * s), Ei(r, 3 * o + 1, 3 * s + 1), Ei(r, 3 * o + 2, 3 * s + 2);
        }
    ...
    var Pi = function (t, e) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.set = function (t) {
        ...
        Li = function (t) {
      function e(e, r) {
        t.call(this, e, r), this.current = Dt.transparent;
      }
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.set = function (t) {
        ...
        Di = function (t) {
      function e(e, r) {
        t.call(this, e, r), this.current = Oi;
      }
    ...
    function Ui(t) {
      return [Ii(255 * t.r, 255 * t.g), Ii(255 * t.b, 255 * t.a)];
    }
    ...
    }, ji.prototype.setConstantPatternPositions = function () {}, ji.prototype.populatePaintArray = function () {}, ji.prototype.updatePaintArray = function () {}, ji.prototype.upload = function () {}, ji.prototype.destroy = function () {}, ji.prototype.setUniforms = function (t, e, r, n) {
      e.set(n.constantOr(this.value));
    }, ji.prototype.getBinding = function (t, e) {
      return "color" === this.type ? new Li(t, e) : new Ci(t, e);
    }, ji.serialize = function (t) {
      var e = t.value,
          r = t.names,
          n = t.type;
      return {
    ...
    }, qi.prototype.populatePaintArray = function () {}, qi.prototype.updatePaintArray = function () {}, qi.prototype.upload = function () {}, qi.prototype.destroy = function () {}, qi.prototype.setConstantPatternPositions = function (t, e) {
      this.patternPositions.patternTo = t.tlbr, this.patternPositions.patternFrom = e.tlbr;
    }, qi.prototype.setUniforms = function (t, e, r, n, i) {
    ...
    Ri.prototype.defines = function () {
      return [];
    }, Ri.prototype.setConstantPatternPositions = function () {}, Ri.prototype.populatePaintArray = function (t, e) {
      var r = this.paintVertexArray,
          n = r.length;
      r.reserve(t);
      var i = this.expression.evaluate(new Sn(0), e, {});
      if ("color" === this.type) for (var a = Ui(i), o = n; o < t; o++) r.emplaceBack(a[0], a[1]);else {
        for (var s = n; s < t; s++) r.emplaceBack(i);

        this.maxValue = Math.max(this.maxValue, i);
      }
    }, Ri.prototype.updatePaintArray = function (t, e, r, n) {
      var i = this.paintVertexArray,
          a = this.expression.evaluate({
        zoom: 0
      }, r, n);
      if ("color" === this.type) for (var o = Ui(a), s = t; s < e; s++) i.emplace(s, o[0], o[1]);else {
        for (var u = t; u < e; u++) i.emplace(u, a);

        this.maxValue = Math.max(this.maxValue, a);
      }
    }, Ri.prototype.upload = function (t) {
      this.paintVertexArray && this.paintVertexArray.arrayBuffer && (this.paintVertexBuffer && this.paintVertexBuffer.buffer ? this.paintVertexBuffer.updateData(this.paintVertexArray) : this.paintVertexBuffer = t.createVertexBuffer(this.paintVertexArray, this.paintVertexAttributes, this.expression.isStateDependent));
    }, Ri.prototype.destroy = function () {
      this.paintVertexBuffer && this.paintVertexBuffer.destroy();
    }, Ri.prototype.setUniforms = function (t, e) {
      e.set(0);
    }, Ri.prototype.getBinding = function (t, e) {
      return new Ci(t, e);
    };

    var Ni = function (t, e, r, n, i, a) {
    ...
    Ni.prototype.defines = function () {
      return [];
    }, Ni.prototype.setConstantPatternPositions = function () {}, Ni.prototype.populatePaintArray = function (t, e) {
      var r = this.paintVertexArray,
          n = r.length;
      r.reserve(t);
      var i = this.expression.evaluate(new Sn(this.zoom), e, {}),
          a = this.expression.evaluate(new Sn(this.zoom + 1), e, {});
      if ("color" === this.type) for (var o = Ui(i), s = Ui(a), u = n; u < t; u++) r.emplaceBack(o[0], o[1], s[0], s[1]);else {
        for (var l = n; l < t; l++) r.emplaceBack(i, a);

        this.maxValue = Math.max(this.maxValue, i, a);
      }
    }, Ni.prototype.updatePaintArray = function (t, e, r, n) {
      var i = this.paintVertexArray,
          a = this.expression.evaluate({
        zoom: this.zoom
      }, r, n),
      ...
      if ("color" === this.type) for (var s = Ui(a), u = Ui(o), l = t; l < e; l++) i.emplace(l, s[0], s[1], u[0], u[1]);else {
        for (var p = t; p < e; p++) i.emplace(p, a, o);

        this.maxValue = Math.max(this.maxValue, a, o);
      }
    }, Ni.prototype.upload = function (t) {
      this.paintVertexArray && this.paintVertexArray.arrayBuffer && (this.paintVertexBuffer && this.paintVertexBuffer.buffer ? this.paintVertexBuffer.updateData(this.paintVertexArray) : this.paintVertexBuffer = t.createVertexBuffer(this.paintVertexArray, this.paintVertexAttributes, this.expression.isStateDependent));
    }, Ni.prototype.destroy = function () {
      this.paintVertexBuffer && this.paintVertexBuffer.destroy();
    }, Ni.prototype.interpolationFactor = function (t) {
    ...
    }, Ni.prototype.setUniforms = function (t, e, r) {
      e.set(this.interpolationFactor(r.zoom));
    }, Ni.prototype.getBinding = function (t, e) {
      return new Ci(t, e);
    };

    var Ki = function (t, e, r, n, i, a, o) {
      this.expression = t, this.names = e, this.type = r, this.uniformNames = this.names.map(function (t) {
        return "a_" + t + "_t";
    ...
    Ki.prototype.defines = function () {
      return [];
    }, Ki.prototype.setConstantPatternPositions = function () {}, Ki.prototype.populatePaintArray = function (t, e, r) {
    ...
    }, Ki.prototype.updatePaintArray = function (t, e, r, n, i) {
    ...
    }, Ki.prototype.upload = function (t) {
    ...
    }, Ki.prototype.setUniforms = function (t, e) {
      e.set(0);
    }, Ki.prototype.getBinding = function (t, e) {
      return new Ci(t, e);
    };
    ...
    Gi.createDynamic = function (t, e, r) {
      var n = new Gi(),
          i = [];

      for (var a in t.paint._values) if (r(a)) {
        var o = t.paint.get(a);

        if (o instanceof Vn && er(o.property.specification)) {
          var s = Zi(a, t.type),
          ...
          if ("cross-faded" === o.property.specification["property-type"] || "cross-faded-data-driven" === o.property.specification["property-type"]) {
            if ("constant" === o.value.kind) n.binders[a] = new qi(o.value.value, s, u), i.push("/u_" + a);else {
              var p = Hi(a, u, "source");
              n.binders[a] = new Ki(o.value, s, u, l, e, p, t.id), i.push("/a_" + a);
            }
          } else if ("constant" === o.value.kind) n.binders[a] = new ji(o.value.value, s, u), i.push("/u_" + a);else if ("source" === o.value.kind) {
            var c = Hi(a, u, "source");
            n.binders[a] = new Ri(o.value, s, u, c), i.push("/a_" + a);
          } else {
            var h = Hi(a, u, "composite");
            n.binders[a] = new Ni(o.value, s, u, l, e, h), i.push("/z_" + a);
          }
        }
      }

      return n.cacheKey = i.sort().join(""), n;
    }, Gi.prototype.populatePaintArrays = function (t, e, r, n) {
    ...
    }, Gi.prototype.setConstantPatternPositions = function (t, e) {
      for (var r in this.binders) {
        this.binders[r].setConstantPatternPositions(t, e);
      }
    }, Gi.prototype.updatePaintArrays = function (t, e, r, n) {
      var i = !1;

      for (var a in t) for (var o = 0, s = this._featureMap.getPositions(+a); o < s.length; o += 1) {
        var u = s[o],
            l = e.feature(u.index);
        ...
        for (var p in this.binders) {
          ...
          if (!(c instanceof ji || c instanceof qi) && !0 === c.expression.isStateDependent) {
            var h = r.paint.get(p);
    ...
    }, Gi.prototype.getUniforms = function (t, e) {
      var r = {};

      for (var n in this.binders) for (var i = this.binders[n], a = 0, o = i.uniformNames; a < o.length; a += 1) {
        var s = o[a];
        r[s] = i.getBinding(t, e[s]);
      }

      return r;
    }, Gi.prototype.setUniforms = function (t, e, r, n) {
      for (var i in this.binders) for (var a = this.binders[i], o = 0, s = a.uniformNames; o < s.length; o += 1) {
        var u = s[o];
        a.setUniforms(t, e[u], n, r.get(i), u);
      }
    }, Gi.prototype.updatePatternPaintBuffers = function (t) {
      var e = [];
      ...
      for (var r in this.binders) {
        ...
        if (n instanceof Ki) {
          ...
          i && e.push(i);
        } else (n instanceof Ri || n instanceof Ni) && n.paintVertexBuffer && e.push(n.paintVertexBuffer);
      }

      this._buffers = e;
    }, Gi.prototype.upload = function (t) {
      ...
      for (var n in this.binders) {
        ...
        (i instanceof Ri || i instanceof Ni) && i.paintVertexBuffer && r.push(i.paintVertexBuffer);
      }
    ...
    var Xi = function (t, e, r, n) {
      ...
      for (var i = 0, a = e; i < a.length; i += 1) {
        var o = a[i];
        this.programConfigurations[o.id] = Gi.createDynamic(o, r, n), this.programConfigurations[o.id].layoutAttributes = t;
      }
    ...
    Xi.prototype.populatePaintArrays = function (t, e, r, n) {
      for (var i in this.programConfigurations) this.programConfigurations[i].populatePaintArrays(t, e, r, n);

      this.needsUpload = !0;
    }, Xi.prototype.updatePaintArrays = function (t, e, r, n) {
    ...
    }, Xi.prototype.upload = function (t) {
      if (this.needsUpload) {
    ...
    }, sn("ConstantBinder", ji), sn("CrossFadedConstantBinder", qi), sn("SourceExpressionBinder", Ri), sn("CrossFadedCompositeBinder", Ki), sn("CompositeExpressionBinder", Ni), sn("ProgramConfiguration", Gi, {
      omit: ["_buffers"]
    }), sn("ProgramConfigurationSet", Xi);
    var Yi = 8192;
    var Ji,
        $i = (Ji = 16, {
      min: -1 * Math.pow(2, Ji - 1),
      max: Math.pow(2, Ji - 1) - 1
    });

    function Wi(t) {
      for (var e = Yi / t.extent, r = t.loadGeometry(), n = 0; n < r.length; n++) for (var i = r[n], a = 0; a < i.length; a++) {
        var o = i[a];
        o.x = Math.round(o.x * e), o.y = Math.round(o.y * e), (o.x < $i.min || o.x > $i.max || o.y < $i.min || o.y > $i.max) && w("Geometry exceeds allowed extent, reduce your vector tile buffer size");
      }
    ...
    var ta = function (t) {
      this.zoom = t.zoom, this.overscaling = t.overscaling, this.layers = t.layers, this.layerIds = this.layers.map(function (t) {
        return t.id;
      }), this.index = t.index, this.hasPattern = !1, this.layoutVertexArray = new Gn(), this.indexArray = new si(), this.segments = new zi(), this.programConfigurations = new Xi(ki, t.layers, t.zoom), this.stateDependentLayerIds = this.layers.filter(function (t) {
    ...
    function ea(t, e) {
      for (var r = 0; r < t.length; r++) if (pa(e, t[r])) return !0;

      for (var n = 0; n < e.length; n++) if (pa(t, e[n])) return !0;

      return !!aa(t, e);
    }

    function ra(t, e, r) {
      return !!pa(t, e) || !!sa(e, t, r);
    }

    function na(t, e) {
      if (1 === t.length) return la(e, t[0]);

      for (var r = 0; r < e.length; r++) for (var n = e[r], i = 0; i < n.length; i++) if (pa(t, n[i])) return !0;
    ...
    function ia(t, e, r) {
      if (t.length > 1) {
        ...
        for (var n = 0; n < e.length; n++) if (sa(e[n], t, r)) return !0;
      }

      for (var i = 0; i < t.length; i++) if (sa(t[i], e, r)) return !0;
    ...
    function aa(t, e) {
      ...
      for (var r = 0; r < t.length - 1; r++) for (var n = t[r], i = t[r + 1], a = 0; a < e.length - 1; a++) {
        if (oa(n, i, e[a], e[a + 1])) return !0;
      }
    ...
    function la(t, e) {
      for (var r, n, i, a = !1, o = 0; o < t.length; o++) for (var s = 0, u = (r = t[o]).length - 1; s < r.length; u = s++) n = r[s], i = r[u], n.y > e.y != i.y > e.y && e.x < (i.x - n.x) * (e.y - n.y) / (i.y - n.y) + n.x && (a = !a);
    ...
    ta.prototype.populate = function (t, e) {
      for (var r = 0, n = t; r < n.length; r += 1) {
        ...
        if (this.layers[0]._featureFilter(new Sn(this.zoom), a)) {
          var u = Wi(a);
          this.addFeature(a, u, o), e.featureIndex.insert(a, u, o, s, this.index);
        }
      }
    }, ta.prototype.update = function (t, e, r) {
      ...
      this.uploaded || (this.layoutVertexBuffer = t.createVertexBuffer(this.layoutVertexArray, ki), this.indexBuffer = t.createIndexBuffer(this.indexArray)), this.programConfigurations.upload(t), this.uploaded = !0;
    }, ta.prototype.destroy = function () {
      this.layoutVertexBuffer && (this.layoutVertexBuffer.destroy(), this.indexBuffer.destroy(), this.programConfigurations.destroy(), this.segments.destroy());
    }, ta.prototype.addFeature = function (t, e, r) {
      for (var n = 0, i = e; n < i.length; n += 1) for (var a = 0, o = i[n]; a < o.length; a += 1) {
        var s = o[a],
            u = s.x,
            l = s.y;

        if (!(u < 0 || u >= Yi || l < 0 || l >= Yi)) {
          var p = this.segments.prepareSegment(4, this.layoutVertexArray, this.indexArray),
              c = p.vertexLength;
          Qi(this.layoutVertexArray, u, l, -1, -1), Qi(this.layoutVertexArray, u, l, 1, -1), Qi(this.layoutVertexArray, u, l, 1, 1), Qi(this.layoutVertexArray, u, l, -1, 1), this.indexArray.emplaceBack(c, c + 1, c + 2), this.indexArray.emplaceBack(c, c + 3, c + 2), p.vertexLength += 4, p.primitiveLength += 2;
        }
      }
    ...
    var da = {
      paint: new Dn({
        "circle-radius": new Tn(mt.paint_circle["circle-radius"]),
        "circle-color": new Tn(mt.paint_circle["circle-color"]),
        "circle-blur": new Tn(mt.paint_circle["circle-blur"]),
        "circle-opacity": new Tn(mt.paint_circle["circle-opacity"]),
        "circle-translate": new Mn(mt.paint_circle["circle-translate"]),
        "circle-translate-anchor": new Mn(mt.paint_circle["circle-translate-anchor"]),
        "circle-pitch-scale": new Mn(mt.paint_circle["circle-pitch-scale"]),
        "circle-pitch-alignment": new Mn(mt.paint_circle["circle-pitch-alignment"]),
        "circle-stroke-width": new Tn(mt.paint_circle["circle-stroke-width"]),
        "circle-stroke-color": new Tn(mt.paint_circle["circle-stroke-color"]),
        "circle-stroke-opacity": new Tn(mt.paint_circle["circle-stroke-opacity"])
      })
    },
        ma = 1e-6,
        va = "undefined" != typeof Float32Array ? Float32Array : Array;
    Math.PI;

    function ga() {
      var t = new va(9);
      return va != Float32Array && (t[1] = 0, t[2] = 0, t[3] = 0, t[5] = 0, t[6] = 0, t[7] = 0), t[0] = 1, t[4] = 1, t[8] = 1, t;
    }

    function xa() {
      var t = new va(3);
      return va != Float32Array && (t[0] = 0, t[1] = 0, t[2] = 0), t;
    }
    ...
    !function () {
      var t,
          e = (t = new va(4), va != Float32Array && (t[0] = 0, t[1] = 0, t[2] = 0, t[3] = 0), t);
    }();

    function ka() {
      var t = new va(4);
      return va != Float32Array && (t[0] = 0, t[1] = 0, t[2] = 0), t[3] = 1, t;
    }
    ...
    function za(t, e, r, n) {
      var i,
          ...
          d = r[2],
          m = r[3];
      return (a = l * f + p * y + c * d + h * m) < 0 && (a = -a, f = -f, y = -y, d = -d, m = -m), 1 - a > ma ? (i = Math.acos(a), o = Math.sin(i), s = Math.sin((1 - n) * i) / o, u = Math.sin(n * i) / o) : (s = 1 - n, u = n), t[0] = s * l + u * f, t[1] = s * p + u * y, t[2] = s * c + u * d, t[3] = s * h + u * m, t;
    }
    ...
    !function () {
      var t,
          e = (t = new va(2), va != Float32Array && (t[0] = 0, t[1] = 0), t);
    }();
    ...
    var Ta = function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.createBucket = function (t) {
        ...
        var e = t;
        return ha("circle-radius", this, e) + ha("circle-stroke-width", this, e) + fa(this.paint.get("circle-translate"));
      }, e.prototype.queryIntersectsFeature = function (t, e, r, n, i, a, o, s) {
        for (var u = ya(t, this.paint.get("circle-translate"), this.paint.get("circle-translate-anchor"), a.angle, o), l = this.paint.get("circle-radius").evaluate(e, r) + this.paint.get("circle-stroke-width").evaluate(e, r), p = "map" === this.paint.get("circle-pitch-alignment"), c = p ? u : function (t, e) {
          ...
          var v = m[d],
              ...
              x = h,
              b = Sa([], [v.x, v.y, 0, 1], s);
          if ("viewport" === this.paint.get("circle-pitch-scale") && "map" === this.paint.get("circle-pitch-alignment") ? x *= b[3] / a.cameraToCenterDistance : "map" === this.paint.get("circle-pitch-scale") && "viewport" === this.paint.get("circle-pitch-alignment") && (x *= a.cameraToCenterDistance / b[3]), ra(c, g, x)) return !0;
        }
    ...
    qa.prototype.resize = function (t) {
      Da(this, t, 4);
    ...
    }, qa.copy = function (t, e, r, n, i) {
      Ua(t, e, r, n, i, 4);
    }, sn("AlphaImage", ja), sn("RGBAImage", qa);
    var Ra = {
      paint: new Dn({
        "heatmap-radius": new Tn(mt.paint_heatmap["heatmap-radius"]),
        "heatmap-weight": new Tn(mt.paint_heatmap["heatmap-weight"]),
        "heatmap-intensity": new Mn(mt.paint_heatmap["heatmap-intensity"]),
        "heatmap-color": new On(mt.paint_heatmap["heatmap-color"]),
        "heatmap-opacity": new Mn(mt.paint_heatmap["heatmap-opacity"])
      })
    };
    ...
    var Ka = function (t) {
      function e(e) {
        t.call(this, e, Ra), this._updateColorRamp();
      }
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.createBucket = function (t) {
        ...
        this.colorRamp = Na(t, "heatmapDensity"), this.colorRampTexture = null;
        ...
        Ga = {
      paint: new Dn({
        "hillshade-illumination-direction": new Mn(mt.paint_hillshade["hillshade-illumination-direction"]),
        "hillshade-illumination-anchor": new Mn(mt.paint_hillshade["hillshade-illumination-anchor"]),
        "hillshade-exaggeration": new Mn(mt.paint_hillshade["hillshade-exaggeration"]),
        "hillshade-shadow-color": new Mn(mt.paint_hillshade["hillshade-shadow-color"]),
        "hillshade-highlight-color": new Mn(mt.paint_hillshade["hillshade-highlight-color"]),
        "hillshade-accent-color": new Mn(mt.paint_hillshade["hillshade-accent-color"])
      })
    },
        Xa = function (t) {
      function e(e) {
    ...
    function $a(t, e, r) {
      ...
      if (p && (h = function (t, e, r, n) {
        ...
        for (i = 0, a = e.length; i < a; i++) o = e[i] * n, s = i < a - 1 ? e[i + 1] * n : t.length, (u = Wa(t, o, s, n, !1)) === u.next && (u.steiner = !0), l.push(uo(u));

        for (l.sort(ao), i = 0; i < l.length; i++) oo(l[i], r), r = Qa(r, r.next);
      ...
      return to(h, f, r, n, i, l), f;
    }

    function Wa(t, e, r, n, i) {
      var a, o;
      if (i === bo(t, e, r, n) > 0) for (a = e; a < r; a += n) o = vo(a, t[a], t[a + 1], o);else for (a = r - n; a >= e; a -= n) o = vo(a, t[a], t[a + 1], o);
      return o && ho(o, o.next) && (go(o), o = o.next), o;
    }
    ...
    function Qa(t, e) {
      ...
      do {
        if (r = !1, n.steiner || !ho(n, n.next) && 0 !== co(n.prev, n, n.next)) n = n.next;else {
    ...
    function to(t, e, r, n, i, a, o) {
      if (t) {
        !o && a && function (t, e, r, n) {
          var i = t;

          do {
            null === i.z && (i.z = so(i.x, i.y, e, r, n)), i.prevZ = i.prev, i.nextZ = i.next, i = i.next;
          } while (i !== t);
        ...
        for (var s, u, l = t; t.prev !== t.next;) if (s = t.prev, u = t.next, a ? ro(t, n, i, a) : eo(t)) e.push(s.i / r), e.push(t.i / r), e.push(u.i / r), go(t), t = u.next, l = u.next;else if ((t = u) === l) {
          o ? 1 === o ? to(t = no(t, e, r), e, r, n, i, a, 2) : 2 === o && io(t, e, r, n, i, a) : to(Qa(t), e, r, n, i, a, 1);
          break;
        }
      }
    }
    ...
    function eo(t) {
      var e = t.prev,
          r = t,
          n = t.next;
      if (co(e, r, n) >= 0) return !1;

      for (var i = t.next.next; i !== t.prev;) {
        if (lo(e.x, e.y, r.x, r.y, n.x, n.y, i.x, i.y) && co(i.prev, i, i.next) >= 0) return !1;
        i = i.next;
      }
    ...
    function ro(t, e, r, n) {
      var i = t.prev,
          a = t,
          o = t.next;
      if (co(i, a, o) >= 0) return !1;

      for (var s = i.x < a.x ? i.x < o.x ? i.x : o.x : a.x < o.x ? a.x : o.x, u = i.y < a.y ? i.y < o.y ? i.y : o.y : a.y < o.y ? a.y : o.y, l = i.x > a.x ? i.x > o.x ? i.x : o.x : a.x > o.x ? a.x : o.x, p = i.y > a.y ? i.y > o.y ? i.y : o.y : a.y > o.y ? a.y : o.y, c = so(s, u, e, r, n), h = so(l, p, e, r, n), f = t.prevZ, y = t.nextZ; f && f.z >= c && y && y.z <= h;) {
        if (f !== t.prev && f !== t.next && lo(i.x, i.y, a.x, a.y, o.x, o.y, f.x, f.y) && co(f.prev, f, f.next) >= 0) return !1;
        if (f = f.prevZ, y !== t.prev && y !== t.next && lo(i.x, i.y, a.x, a.y, o.x, o.y, y.x, y.y) && co(y.prev, y, y.next) >= 0) return !1;
        y = y.nextZ;
      }
      ...
      for (; y && y.z <= h;) {
        if (y !== t.prev && y !== t.next && lo(i.x, i.y, a.x, a.y, o.x, o.y, y.x, y.y) && co(y.prev, y, y.next) >= 0) return !1;
        y = y.nextZ;
      }
    ...
    function no(t, e, r) {
      ...
      do {
        var i = n.prev,
            a = n.next.next;
        !ho(i, a) && fo(i, n, n.next, a) && yo(i, a) && yo(a, i) && (e.push(i.i / r), e.push(n.i / r), e.push(a.i / r), go(n), go(n.next), n = t = a), n = n.next;
      } while (n !== t);

      return n;
    }

    function io(t, e, r, n, i, a) {
      var o = t;
      ...
      do {
        for (var s = o.next.next; s !== o.prev;) {
          if (o.i !== s.i && po(o, s)) {
            var u = mo(o, s);
            return o = Qa(o, o.next), u = Qa(u, u.next), to(o, e, r, n, i, a), void to(u, e, r, n, i, a);
          }
    ...
    function oo(t, e) {
      if (e = function (t, e) {
        ...
        for (; n !== l;) i >= n.x && n.x >= p && i !== n.x && lo(a < c ? i : o, a, p, c, a < c ? o : i, a, n.x, n.y) && ((u = Math.abs(a - n.y) / (i - n.x)) < h || u === h && n.x > r.x) && yo(n, t) && (r = n, h = u), n = n.next;
    ...
    function po(t, e) {
      return t.next.i !== e.i && t.prev.i !== e.i && !function (t, e) {
        ...
        do {
          if (r.i !== t.i && r.next.i !== t.i && r.i !== e.i && r.next.i !== e.i && fo(r, r.next, t, e)) return !0;
          r = r.next;
        } while (r !== t);

        return !1;
      }(t, e) && yo(t, e) && yo(e, t) && function (t, e) {
        var r = t,
            n = !1,
            i = (t.x + e.x) / 2,
            a = (t.y + e.y) / 2;
    ...
    function fo(t, e, r, n) {
      return !!(ho(t, e) && ho(r, n) || ho(t, n) && ho(r, e)) || co(t, e, r) > 0 != co(t, e, n) > 0 && co(r, n, t) > 0 != co(r, n, e) > 0;
    }

    function yo(t, e) {
      return co(t.prev, t, t.next) < 0 ? co(t, e, t.next) >= 0 && co(t, t.prev, e) >= 0 : co(t, e, t.prev) < 0 || co(t, t.next, e) < 0;
    }

    function mo(t, e) {
      var r = new xo(t.i, t.x, t.y),
    ...
    function _o(t, e, r, n, i) {
      !function t(e, r, n, i, a) {
        for (; i > n;) {
          ...
          for (wo(e, n, r), a(e[i], f) > 0 && wo(e, n, i); y < d;) {
            for (wo(e, y, d), y++, d--; a(e[y], f) < 0;) y++;

            for (; a(e[d], f) > 0;) d--;
          }

          0 === a(e[n], f) ? wo(e, n, d) : wo(e, ++d, i), d <= r && (n = d + 1), r <= d && (i = d - 1);
        }
      }(t, e, r || 0, n || t.length - 1, i || Ao);
    }
    ...
    function So(t, e) {
      ...
      if (n && a.push(n), e > 1) for (var u = 0; u < a.length; u++) a[u].length <= e || (_o(a[u], e, 1, a[u].length - 1, ko), a[u] = a[u].slice(0, e));
      return a;
    }
    ...
    var Bo = function (t) {
      this.zoom = t.zoom, this.overscaling = t.overscaling, this.layers = t.layers, this.layerIds = this.layers.map(function (t) {
        return t.id;
      }), this.index = t.index, this.hasPattern = !1, this.layoutVertexArray = new Gn(), this.indexArray = new si(), this.indexArray2 = new ui(), this.programConfigurations = new Xi(Ha, t.layers, t.zoom), this.segments = new zi(), this.segments2 = new zi(), this.stateDependentLayerIds = this.layers.filter(function (t) {
        return t.isStateDependent();
      }).map(function (t) {
        return t.id;
      });
    ...
    Bo.prototype.populate = function (t, e) {
      this.features = [], this.hasPattern = zo("fill", this.layers, e);
      ...
      for (var r = 0, n = t; r < n.length; r += 1) {
        ...
        if (this.layers[0]._featureFilter(new Sn(this.zoom), a)) {
          ...
          void 0 !== a.id && (l.id = a.id), this.hasPattern ? this.features.push(Io("fill", this.layers, l, this.zoom, e)) : this.addFeature(l, u, o, {}), e.featureIndex.insert(a, u, o, s, this.index);
        }
      }
    }, Bo.prototype.update = function (t, e, r) {
      this.stateDependentLayers.length && this.programConfigurations.updatePaintArrays(t, e, this.stateDependentLayers, r);
    }, Bo.prototype.addFeatures = function (t, e) {
      ...
      this.uploaded || (this.layoutVertexBuffer = t.createVertexBuffer(this.layoutVertexArray, Ha), this.indexBuffer = t.createIndexBuffer(this.indexArray), this.indexBuffer2 = t.createIndexBuffer(this.indexArray2)), this.programConfigurations.upload(t), this.uploaded = !0;
    }, Bo.prototype.destroy = function () {
      this.layoutVertexBuffer && (this.layoutVertexBuffer.destroy(), this.indexBuffer.destroy(), this.indexBuffer2.destroy(), this.programConfigurations.destroy(), this.segments.destroy(), this.segments2.destroy());
    }, Bo.prototype.addFeature = function (t, e, r, n) {
      for (var i = 0, a = So(e, 500); i < a.length; i += 1) {
        ...
        for (var b = Ya(h, f), _ = 0; _ < b.length; _ += 3) this.indexArray.emplaceBack(c + b[_], c + b[_ + 1], c + b[_ + 2]);
    ...
    var Eo = {
      paint: new Dn({
        "fill-antialias": new Mn(mt.paint_fill["fill-antialias"]),
        "fill-opacity": new Tn(mt.paint_fill["fill-opacity"]),
        "fill-color": new Tn(mt.paint_fill["fill-color"]),
        "fill-outline-color": new Tn(mt.paint_fill["fill-outline-color"]),
        "fill-translate": new Mn(mt.paint_fill["fill-translate"]),
        "fill-translate-anchor": new Mn(mt.paint_fill["fill-translate-anchor"]),
        "fill-pattern": new Fn(mt.paint_fill["fill-pattern"])
      })
    },
        Po = function (t) {
      function e(e) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.recalculate = function (e) {
        ...
        return na(ya(t, this.paint.get("fill-translate"), this.paint.get("fill-translate-anchor"), a.angle, o), n);
      }, e;
    }(Un),
        Vo = Nn([{
      name: "a_pos",
      ...
      type: "Int16"
        ...
        Co = Vo.members,
        Mo = (Vo.size, Vo.alignment, Math.pow(2, 13));

    function To(t, e, r, n, i, a, o, s) {
      t.emplaceBack(e, r, 2 * Math.floor(n * Mo) + o, i * Mo * 2, a * Mo * 2, Math.round(s));
    }

    var Fo = function (t) {
      this.zoom = t.zoom, this.overscaling = t.overscaling, this.layers = t.layers, this.layerIds = this.layers.map(function (t) {
        return t.id;
      }), this.index = t.index, this.hasPattern = !1, this.layoutVertexArray = new Zn(), this.indexArray = new si(), this.programConfigurations = new Xi(Co, t.layers, t.zoom), this.segments = new zi(), this.stateDependentLayerIds = this.layers.filter(function (t) {
        return t.isStateDependent();
      }).map(function (t) {
        return t.id;
      });
    ...
    function Lo(t, e) {
      return t.x === e.x && (t.x < 0 || t.x > Yi) || t.y === e.y && (t.y < 0 || t.y > Yi);
    }
    ...
    Fo.prototype.populate = function (t, e) {
      this.features = [], this.hasPattern = zo("fill-extrusion", this.layers, e);
      ...
      for (var r = 0, n = t; r < n.length; r += 1) {
        ...
        if (this.layers[0]._featureFilter(new Sn(this.zoom), a)) {
          ...
          void 0 !== a.id && (l.id = a.id), this.hasPattern ? this.features.push(Io("fill-extrusion", this.layers, l, this.zoom, e)) : this.addFeature(l, u, o, {}), e.featureIndex.insert(a, u, o, s, this.index, !0);
        }
      }
    }, Fo.prototype.addFeatures = function (t, e) {
      for (var r = 0, n = this.features; r < n.length; r += 1) {
        var i = n[r],
            a = i.geometry;
        this.addFeature(i, a, i.index, e);
      }
    }, Fo.prototype.update = function (t, e, r) {
      this.stateDependentLayers.length && this.programConfigurations.updatePaintArrays(t, e, this.stateDependentLayers, r);
      ...
      this.uploaded || (this.layoutVertexBuffer = t.createVertexBuffer(this.layoutVertexArray, Co), this.indexBuffer = t.createIndexBuffer(this.indexArray)), this.programConfigurations.upload(t), this.uploaded = !0;
    }, Fo.prototype.destroy = function () {
      this.layoutVertexBuffer && (this.layoutVertexBuffer.destroy(), this.indexBuffer.destroy(), this.programConfigurations.destroy(), this.segments.destroy());
    }, Fo.prototype.addFeature = function (t, e, r, n) {
      for (var i = 0, a = So(e, 500); i < a.length; i += 1) {
        for (var o = a[i], s = 0, u = 0, l = o; u < l.length; u += 1) {
          s += l[u].length;
        }
        ...
        for (var p = this.segments.prepareSegment(4, this.layoutVertexArray, this.indexArray), c = 0, h = o; c < h.length; c += 1) {
          var f = h[c];
          if (0 !== f.length && !Oo(f)) for (var y = 0, d = 0; d < f.length; d++) {
            var m = f[d];
            ...
            if (d >= 1) {
              ...
              if (!Lo(m, v)) {
                p.vertexLength + 4 > zi.MAX_VERTEX_ARRAY_LENGTH && (p = this.segments.prepareSegment(4, this.layoutVertexArray, this.indexArray));

                var g = m.sub(v)._perp()._unit(),
                    x = v.dist(m);

                y + x > 32768 && (y = 0), To(this.layoutVertexArray, m.x, m.y, g.x, g.y, 0, 0, y), To(this.layoutVertexArray, m.x, m.y, g.x, g.y, 0, 1, y), y += x, To(this.layoutVertexArray, v.x, v.y, g.x, g.y, 0, 0, y), To(this.layoutVertexArray, v.x, v.y, g.x, g.y, 0, 1, y);
        ...
        p.vertexLength + s > zi.MAX_VERTEX_ARRAY_LENGTH && (p = this.segments.prepareSegment(s, this.layoutVertexArray, this.indexArray));
        ...
        for (var _ = [], w = [], A = p.vertexLength, S = 0, k = o; S < k.length; S += 1) {
          ...
          if (0 !== z.length) {
            ...
            for (var I = 0; I < z.length; I++) {
              var B = z[I];
              To(this.layoutVertexArray, B.x, B.y, 0, 0, 1, 1, 0), _.push(B.x), _.push(B.y);
            }
          }
        }

        for (var E = Ya(_, w), P = 0; P < E.length; P += 3) this.indexArray.emplaceBack(A + E[P], A + E[P + 2], A + E[P + 1]);

        p.primitiveLength += E.length / 3, p.vertexLength += s;
      }

      this.programConfigurations.populatePaintArrays(this.layoutVertexArray.length, t, r, n);
    }, sn("FillExtrusionBucket", Fo, {
      omit: ["layers", "features"]
    });

    var Do = {
      paint: new Dn({
        "fill-extrusion-opacity": new Mn(mt["paint_fill-extrusion"]["fill-extrusion-opacity"]),
        "fill-extrusion-color": new Tn(mt["paint_fill-extrusion"]["fill-extrusion-color"]),
        "fill-extrusion-translate": new Mn(mt["paint_fill-extrusion"]["fill-extrusion-translate"]),
        "fill-extrusion-translate-anchor": new Mn(mt["paint_fill-extrusion"]["fill-extrusion-translate-anchor"]),
        "fill-extrusion-pattern": new Fn(mt["paint_fill-extrusion"]["fill-extrusion-pattern"]),
        "fill-extrusion-height": new Tn(mt["paint_fill-extrusion"]["fill-extrusion-height"]),
        "fill-extrusion-base": new Tn(mt["paint_fill-extrusion"]["fill-extrusion-base"]),
        "fill-extrusion-vertical-gradient": new Mn(mt["paint_fill-extrusion"]["fill-extrusion-vertical-gradient"])
      })
    },
        Uo = function (t) {
      function e(e) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.createBucket = function (t) {
        ...
        var l = ya(t, this.paint.get("fill-extrusion-translate"), this.paint.get("fill-extrusion-translate-anchor"), o.angle, s),
          ...
          for (var a = [], o = 0, s = t; o < s.length; o += 1) {
            var u = s[o],
                l = [u.x, u.y, n, 1];
            Sa(l, l, e), a.push(new i(l[0] / l[3], l[1] / l[3]));
          }
    ...
    function $o(t, e, r) {
      if (3 === t) {
        var n = new Ho(r, r.readVarint() + r.pos);
        n.length && (e[n.name] = n);
      }
    }

    Yo.prototype.feature = function (t) {
      if (t < 0 || t >= this._features.length) throw new Error("feature index out of bounds");
      this._pbf.pos = this._features[t];

      var e = this._pbf.readVarint() + this._pbf.pos;

      return new Ko(this._pbf, e, this.extent, this._keys, this._values);
    };

    var Wo = {
      VectorTile: function (t, e) {
        this.layers = t.readFields($o, {}, e);
      },
      VectorTileFeature: Ko,
      VectorTileLayer: Ho
    },
        Qo = Wo.VectorTileFeature.types,
        ts = 63,
        es = Math.cos(Math.PI / 180 * 37.5),
        rs = .5,
        ns = Math.pow(2, 14) / rs;

    function is(t, e, r, n, i, a, o) {
      t.emplaceBack(e.x, e.y, n ? 1 : 0, i ? 1 : -1, Math.round(ts * r.x) + 128, Math.round(ts * r.y) + 128, 1 + (0 === a ? 0 : a < 0 ? -1 : 1) | (o * rs & 63) << 2, o * rs >> 6);
    }

    var as = function (t) {
      this.zoom = t.zoom, this.overscaling = t.overscaling, this.layers = t.layers, this.layerIds = this.layers.map(function (t) {
        return t.id;
      }), this.index = t.index, this.features = [], this.hasPattern = !1, this.layoutVertexArray = new Hn(), this.indexArray = new si(), this.programConfigurations = new Xi(No, t.layers, t.zoom), this.segments = new zi(), this.stateDependentLayerIds = this.layers.filter(function (t) {
        return t.isStateDependent();
      }).map(function (t) {
        return t.id;
      });
    ...
    function os(t, e) {
      return (t / e.tileTotal * (e.end - e.start) + e.start) * (ns - 1);
    }

    as.prototype.populate = function (t, e) {
      this.features = [], this.hasPattern = zo("line", this.layers, e);
      ...
      for (var r = 0, n = t; r < n.length; r += 1) {
        ...
        if (this.layers[0]._featureFilter(new Sn(this.zoom), a)) {
          ...
          void 0 !== a.id && (l.id = a.id), this.hasPattern ? this.features.push(Io("line", this.layers, l, this.zoom, e)) : this.addFeature(l, u, o, {}), e.featureIndex.insert(a, u, o, s, this.index);
        }
      }
    }, as.prototype.update = function (t, e, r) {
      this.stateDependentLayers.length && this.programConfigurations.updatePaintArrays(t, e, this.stateDependentLayers, r);
    }, as.prototype.addFeatures = function (t, e) {
      for (var r = 0, n = this.features; r < n.length; r += 1) {
        var i = n[r],
            a = i.geometry;
        this.addFeature(i, a, i.index, e);
      ...
      this.layoutVertexBuffer && (this.layoutVertexBuffer.destroy(), this.indexBuffer.destroy(), this.programConfigurations.destroy(), this.segments.destroy());
    }, as.prototype.addFeature = function (t, e, r, n) {
    ...
    }, as.prototype.addLine = function (t, e, r, n, i, a, o, s) {
      var u = null;
      ...
      for (var l = "Polygon" === Qo[e.type], p = t.length; p >= 2 && t[p - 1].equals(t[p - 2]);) p--;
      ...
      if (!(p < (l ? 3 : 2))) {
        ...
        var h = Yi / (512 * this.overscaling) * 15,
            f = t[c],
        ...
        for (var k = c; k < p; k++) if (!(w = l && k === p - 1 ? t[c + 1] : t[k + 1]) || !t[k].equals(w)) {
          ...
          if (E && k > c) {
            ...
            if (P > 2 * h) {
              var V = d.sub(d.sub(_)._mult(h / P)._round());
              this.distance += V.dist(_), this.addCurrentVertex(V, this.distance, A.mult(1), 0, 0, !1, y, u), _ = V;
            }
          }

          var C = _ && w,
              M = C ? r : w ? g : x;
          if (C && "round" === M && (B < a ? M = "miter" : B <= 2 && (M = "fakeround")), "miter" === M && B > i && (M = "bevel"), "bevel" === M && (B > 2 && (M = "flipbevel"), B < i && (M = "miter")), _ && (this.distance += d.dist(_)), "miter" === M) z._mult(B), this.addCurrentVertex(d, this.distance, z, 0, 0, !1, y, u);else if ("flipbevel" === M) {
            if (B > 100) z = S.clone().mult(-1);else {
              var T = A.x * S.y - A.y * S.x > 0 ? -1 : 1,
            ...
            if (L ? (v = 0, m = O) : (m = 0, v = O), b || this.addCurrentVertex(d, this.distance, A, m, v, !1, y, u), "fakeround" === M) {
              for (var D = Math.floor(8 * (.5 - (I - .5))), U = void 0, j = 0; j < D; j++) U = S.mult((j + 1) / (D + 1))._add(A)._unit(), this.addPieSliceVertex(d, this.distance, U, L, y, u);

              this.addPieSliceVertex(d, this.distance, z, L, y, u);

              for (var q = D - 1; q >= 0; q--) U = A.mult((q + 1) / (D + 1))._add(S)._unit(), this.addPieSliceVertex(d, this.distance, U, L, y, u);
            }
          ...
          if (E && k < p - 1) {
            ...
            if (R > 2 * h) {
              var N = d.add(w.sub(d)._mult(h / R)._round());
    ...
    }, as.prototype.addCurrentVertex = function (t, e, r, n, i, a, o, s) {
      var u,
          l = this.layoutVertexArray,
          p = this.indexArray;
      s && (e = os(e, s)), u = r.clone(), n && u._sub(r.perp()._mult(n)), is(l, t, u, a, !1, n, e), this.e3 = o.vertexLength++, this.e1 >= 0 && this.e2 >= 0 && (p.emplaceBack(this.e1, this.e2, this.e3), o.primitiveLength++), this.e1 = this.e2, this.e2 = this.e3, u = r.mult(-1), i && u._sub(r.perp()._mult(i)), is(l, t, u, a, !0, -i, e), this.e3 = o.vertexLength++, this.e1 >= 0 && this.e2 >= 0 && (p.emplaceBack(this.e1, this.e2, this.e3), o.primitiveLength++), this.e1 = this.e2, this.e2 = this.e3, e > ns / 2 && !s && (this.distance = 0, this.addCurrentVertex(t, this.distance, r, n, i, a, o));
    }, as.prototype.addPieSliceVertex = function (t, e, r, n, i, a) {
      r = r.mult(n ? -1 : 1);
      var o = this.layoutVertexArray,
          s = this.indexArray;
      a && (e = os(e, a)), is(o, t, r, !1, n, 0, e), this.e3 = i.vertexLength++, this.e1 >= 0 && this.e2 >= 0 && (s.emplaceBack(this.e1, this.e2, this.e3), i.primitiveLength++), n ? this.e2 = this.e3 : this.e1 = this.e3;
    }, sn("LineBucket", as, {
      omit: ["layers", "features"]
    });
    var ss = new Dn({
      "line-cap": new Mn(mt.layout_line["line-cap"]),
      "line-join": new Tn(mt.layout_line["line-join"]),
      "line-miter-limit": new Mn(mt.layout_line["line-miter-limit"]),
      "line-round-limit": new Mn(mt.layout_line["line-round-limit"])
    }),
        us = {
      paint: new Dn({
        "line-opacity": new Tn(mt.paint_line["line-opacity"]),
        "line-color": new Tn(mt.paint_line["line-color"]),
        "line-translate": new Mn(mt.paint_line["line-translate"]),
        "line-translate-anchor": new Mn(mt.paint_line["line-translate-anchor"]),
        "line-width": new Tn(mt.paint_line["line-width"]),
        "line-gap-width": new Tn(mt.paint_line["line-gap-width"]),
        "line-offset": new Tn(mt.paint_line["line-offset"]),
        "line-blur": new Tn(mt.paint_line["line-blur"]),
        "line-dasharray": new Ln(mt.paint_line["line-dasharray"]),
        "line-pattern": new Fn(mt.paint_line["line-pattern"]),
        "line-gradient": new On(mt.paint_line["line-gradient"])
      }),
      layout: ss
    },
        ls = new (function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.possiblyEvaluate = function (e, r) {
        return r = new Sn(Math.floor(r.zoom), {
          now: r.now,
    ...
    var ps = function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype._handleSpecialPaintPropertyUpdate = function (t) {
        ...
        this.gradient = Na(t, "lineProgress"), this.gradientTexture = null;
      }, e.prototype.recalculate = function (e) {
        t.prototype.recalculate.call(this, e), this.paint._values["line-floorwidth"] = ls.possiblyEvaluate(this._transitioningPaint._values["line-width"].value, e);
      }, e.prototype.createBucket = function (t) {
        return new as(t);
      }, e.prototype.queryRadius = function (t) {
        var e = t,
            r = cs(ha("line-width", this, e), ha("line-gap-width", this, e)),
            n = ha("line-offset", this, e);
        return r / 2 + Math.abs(n) + fa(this.paint.get("line-translate"));
      }, e.prototype.queryIntersectsFeature = function (t, e, r, n, a, o, s) {
        var u = ya(t, this.paint.get("line-translate"), this.paint.get("line-translate-anchor"), o.angle, s),
            l = s / 2 * cs(this.paint.get("line-width").evaluate(e, r), this.paint.get("line-gap-width").evaluate(e, r)),
        ...
        return p && (n = function (t, e) {
          ...
          for (var n = 0; n < e.length; n++) {
            var i = e[n];
            if (t.length >= 3) for (var a = 0; a < i.length; a++) if (pa(t, i[a])) return !0;
    ...
    function vs(t, e, r) {
      return t.sections.forEach(function (t) {
        t.text = function (t, e, r) {
          ...
          return "uppercase" === n ? t = t.toLocaleUpperCase() : "lowercase" === n && (t = t.toLocaleLowerCase()), An.applyArabicShaping && (t = An.applyArabicShaping(t)), t;
        }(t.text, e, r);
      }), t;
    }
    ...
    function _s(t, e) {
      ...
      if ("constant" === r.kind) return {
        ...
        layoutSize: r.evaluate(new Sn(t + 1))
      };
      ...
      return "composite" === r.kind ? {
        ...
        zoomRange: o,
        sizeRange: {
          min: r.evaluate(new Sn(o.min)),
          max: r.evaluate(new Sn(o.max))
        },
        propertyValue: e.value
      };
    }

    var ws = Wo.VectorTileFeature.types,
        As = [{
      name: "a_fade_opacity",
      components: 1,
      type: "Uint8",
    ...
    var zs = function (t) {
      this.layoutVertexArray = new Jn(), this.indexArray = new si(), this.programConfigurations = t, this.segments = new zi(), this.dynamicLayoutVertexArray = new $n(), this.opacityVertexArray = new Wn(), this.placedSymbolArray = new di();
    };

    zs.prototype.upload = function (t, e, r, n) {
      r && (this.layoutVertexBuffer = t.createVertexBuffer(this.layoutVertexArray, hs.members), this.indexBuffer = t.createIndexBuffer(this.indexArray, e), this.dynamicLayoutVertexBuffer = t.createVertexBuffer(this.dynamicLayoutVertexArray, fs.members, !0), this.opacityVertexBuffer = t.createVertexBuffer(this.opacityVertexArray, As, !0), this.opacityVertexBuffer.itemSize = 1), (r || n) && this.programConfigurations.upload(t);
    }, zs.prototype.destroy = function () {
      this.layoutVertexBuffer && (this.layoutVertexBuffer.destroy(), this.indexBuffer.destroy(), this.programConfigurations.destroy(), this.segments.destroy(), this.dynamicLayoutVertexBuffer.destroy(), this.opacityVertexBuffer.destroy());
    }, sn("SymbolBuffers", zs);

    var Is = function (t, e, r) {
      this.layoutVertexArray = new t(), this.layoutAttributes = e, this.indexArray = new r(), this.segments = new zi(), this.collisionVertexArray = new ei();
    };

    Is.prototype.upload = function (t) {
      this.layoutVertexBuffer = t.createVertexBuffer(this.layoutVertexArray, this.layoutAttributes), this.indexBuffer = t.createIndexBuffer(this.indexArray), this.collisionVertexBuffer = t.createVertexBuffer(this.collisionVertexArray, ys.members, !0);
    ...
    var Bs = function (t) {
      ...
      this.textSizeData = _s(this.zoom, e["text-size"]), this.iconSizeData = _s(this.zoom, e["icon-size"]);
    ...
    Bs.prototype.createArrays = function () {
      this.text = new zs(new Xi(hs.members, this.layers, this.zoom, function (t) {
        return /^text/.test(t);
      })), this.icon = new zs(new Xi(hs.members, this.layers, this.zoom, function (t) {
        return /^icon/.test(t);
    ...
    }, Bs.prototype.calculateGlyphDependencies = function (t, e, r, n) {
      for (var i = 0; i < t.length; i++) if (e[t.charCodeAt(i)] = !0, r && n) {
        var a = gs[t.charAt(i)];
      ...
      if (this.features = [], s || u) {
        for (var p = e.iconDependencies, c = e.glyphDependencies, h = new Sn(this.zoom), f = 0, y = t; f < y.length; f += 1) {
          var d = y[f],
              m = d.feature,
              v = d.index,
          ...
          if (r._featureFilter(h, m)) {
            ...
            if (s) {
              ...
              x = vs(b instanceof qt ? b : qt.fromString(b), r, m);
            }
            ...
            if (u && (_ = r.getValueAndResolveTokens("icon-image", m)), x || _) {
              ...
              if (void 0 !== m.id && (A.id = m.id), this.features.push(A), _ && (p[_] = !0), x) for (var S = i.evaluate(m, {}).join(","), k = "map" === n.get("text-rotation-alignment") && "point" !== n.get("symbol-placement"), z = 0, I = x.sections; z < I.length; z += 1) {
                var B = I[z],
                    ...
                    P = B.fontStack || S,
                    V = c[P] = c[P] || {};
                this.calculateGlyphDependencies(B.text, V, k, E);
              }
            }
          }
        }
    ...
    }, Bs.prototype.addToLineVertexArray = function (t, e) {
    ...
    }, Bs.prototype.addSymbols = function (t, e, r, n, i, a, o, s, u, l) {
      for (var p = t.indexArray, c = t.layoutVertexArray, h = t.dynamicLayoutVertexArray, f = t.segments.prepareSegment(4 * e.length, t.layoutVertexArray, t.indexArray, a.sortKey), y = this.glyphOffsetArray.length, d = f.vertexLength, m = 0, v = e; m < v.length; m += 1) {
        var g = v[m],
            ...
            S = f.vertexLength,
            k = g.glyphOffset[1];
        Ss(c, s.x, s.y, x.x, k + x.y, A.x, A.y, r), Ss(c, s.x, s.y, b.x, k + b.y, A.x + A.w, A.y, r), Ss(c, s.x, s.y, _.x, k + _.y, A.x, A.y + A.h, r), Ss(c, s.x, s.y, w.x, k + w.y, A.x + A.w, A.y + A.h, r), ks(h, s, 0), p.emplaceBack(S, S + 1, S + 2), p.emplaceBack(S + 1, S + 2, S + 3), f.vertexLength += 4, f.primitiveLength += 2, this.glyphOffsetArray.emplaceBack(g.glyphOffset[0]);
      }
    ...
    }, Bs.prototype._addCollisionDebugVertex = function (t, e, r, n, i, a) {
      return e.emplaceBack(0, 0), t.emplaceBack(r.x, r.y, n, i, Math.round(a.x), Math.round(a.y));
    }, Bs.prototype.addCollisionDebugVertices = function (t, e, r, n, a, o, s, u) {
    ...
    }, Bs.prototype.addDebugCollisionBoxes = function (t, e, r) {
      for (var n = t; n < e; n++) {
    ...
    }, Bs.prototype._deserializeCollisionBoxesForSymbol = function (t, e, r, n, i) {
      for (var a = {}, o = e; o < r; o++) {
        var s = t.get(o);
      ...
      return a;
    }, Bs.prototype.deserializeCollisionBoxes = function (t) {
    ...
    }, Bs.prototype.addIndicesForPlacedTextSymbol = function (t) {
    ...
    }, Bs.prototype.sortFeatures = function (t) {
      if (this.sortFeaturesByY && this.sortedAngle !== t && (this.sortedAngle = t, !(this.text.segments.get().length > 1 || this.icon.segments.get().length > 1))) {
        for (var e = [], r = 0; r < this.symbolInstances.length; r++) e.push(r);

        for (var n = Math.sin(t), i = Math.cos(t), a = [], o = [], s = 0; s < this.symbolInstances.length; s++) {
          var u = this.symbolInstances.get(s);
          a.push(0 | Math.round(n * u.anchorX + i * u.anchorY)), o.push(u.featureIndex);
        }

        e.sort(function (t, e) {
          return a[t] - a[e] || o[e] - o[t];
        }), this.text.indexArray.clear(), this.icon.indexArray.clear(), this.featureSortOrder = [];

        for (var l = 0, p = e; l < p.length; l += 1) {
          var c = p[l],
              h = this.symbolInstances.get(c);
          this.featureSortOrder.push(h.featureIndex), h.horizontalPlacedTextSymbolIndex >= 0 && this.addIndicesForPlacedTextSymbol(h.horizontalPlacedTextSymbolIndex), h.verticalPlacedTextSymbolIndex >= 0 && this.addIndicesForPlacedTextSymbol(h.verticalPlacedTextSymbolIndex);
          var f = this.icon.placedSymbolArray.get(c);

          if (f.numGlyphs) {
            var y = f.vertexStartIndex;
            this.icon.indexArray.emplaceBack(y, y + 1, y + 2), this.icon.indexArray.emplaceBack(y + 1, y + 2, y + 3);
          }
        }
    ...
    }), Bs.MAX_GLYPHS = 65535, Bs.addDynamicAttributes = ks;

    var Es = new Dn({
      "symbol-placement": new Mn(mt.layout_symbol["symbol-placement"]),
      "symbol-spacing": new Mn(mt.layout_symbol["symbol-spacing"]),
      "symbol-avoid-edges": new Mn(mt.layout_symbol["symbol-avoid-edges"]),
      "symbol-sort-key": new Tn(mt.layout_symbol["symbol-sort-key"]),
      "symbol-z-order": new Mn(mt.layout_symbol["symbol-z-order"]),
      "icon-allow-overlap": new Mn(mt.layout_symbol["icon-allow-overlap"]),
      "icon-ignore-placement": new Mn(mt.layout_symbol["icon-ignore-placement"]),
      "icon-optional": new Mn(mt.layout_symbol["icon-optional"]),
      "icon-rotation-alignment": new Mn(mt.layout_symbol["icon-rotation-alignment"]),
      "icon-size": new Tn(mt.layout_symbol["icon-size"]),
      "icon-text-fit": new Mn(mt.layout_symbol["icon-text-fit"]),
      "icon-text-fit-padding": new Mn(mt.layout_symbol["icon-text-fit-padding"]),
      "icon-image": new Tn(mt.layout_symbol["icon-image"]),
      "icon-rotate": new Tn(mt.layout_symbol["icon-rotate"]),
      "icon-padding": new Mn(mt.layout_symbol["icon-padding"]),
      "icon-keep-upright": new Mn(mt.layout_symbol["icon-keep-upright"]),
      "icon-offset": new Tn(mt.layout_symbol["icon-offset"]),
      "icon-anchor": new Tn(mt.layout_symbol["icon-anchor"]),
      "icon-pitch-alignment": new Mn(mt.layout_symbol["icon-pitch-alignment"]),
      "text-pitch-alignment": new Mn(mt.layout_symbol["text-pitch-alignment"]),
      "text-rotation-alignment": new Mn(mt.layout_symbol["text-rotation-alignment"]),
      "text-field": new Tn(mt.layout_symbol["text-field"]),
      "text-font": new Tn(mt.layout_symbol["text-font"]),
      "text-size": new Tn(mt.layout_symbol["text-size"]),
      "text-max-width": new Tn(mt.layout_symbol["text-max-width"]),
      "text-line-height": new Mn(mt.layout_symbol["text-line-height"]),
      "text-letter-spacing": new Tn(mt.layout_symbol["text-letter-spacing"]),
      "text-justify": new Tn(mt.layout_symbol["text-justify"]),
      "text-anchor": new Tn(mt.layout_symbol["text-anchor"]),
      "text-max-angle": new Mn(mt.layout_symbol["text-max-angle"]),
      "text-rotate": new Tn(mt.layout_symbol["text-rotate"]),
      "text-padding": new Mn(mt.layout_symbol["text-padding"]),
      "text-keep-upright": new Mn(mt.layout_symbol["text-keep-upright"]),
      "text-transform": new Tn(mt.layout_symbol["text-transform"]),
      "text-offset": new Tn(mt.layout_symbol["text-offset"]),
      "text-allow-overlap": new Mn(mt.layout_symbol["text-allow-overlap"]),
      "text-ignore-placement": new Mn(mt.layout_symbol["text-ignore-placement"]),
      "text-optional": new Mn(mt.layout_symbol["text-optional"])
    }),
        Ps = {
      paint: new Dn({
        "icon-opacity": new Tn(mt.paint_symbol["icon-opacity"]),
        "icon-color": new Tn(mt.paint_symbol["icon-color"]),
        "icon-halo-color": new Tn(mt.paint_symbol["icon-halo-color"]),
        "icon-halo-width": new Tn(mt.paint_symbol["icon-halo-width"]),
        "icon-halo-blur": new Tn(mt.paint_symbol["icon-halo-blur"]),
        "icon-translate": new Mn(mt.paint_symbol["icon-translate"]),
        "icon-translate-anchor": new Mn(mt.paint_symbol["icon-translate-anchor"]),
        "text-opacity": new Tn(mt.paint_symbol["text-opacity"]),
        "text-color": new Tn(mt.paint_symbol["text-color"]),
        "text-halo-color": new Tn(mt.paint_symbol["text-halo-color"]),
        "text-halo-width": new Tn(mt.paint_symbol["text-halo-width"]),
        "text-halo-blur": new Tn(mt.paint_symbol["text-halo-blur"]),
        "text-translate": new Mn(mt.paint_symbol["text-translate"]),
        "text-translate-anchor": new Mn(mt.paint_symbol["text-translate-anchor"])
      }),
      layout: Es
    },
        Vs = function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.recalculate = function (e) {
        ...
        return i.isDataDriven() || yr(i.value) ? n : (r = e.properties, n.replace(/{([^{}]+)}/g, function (t, e) {
        ...
        Cs = {
      paint: new Dn({
        "background-color": new Mn(mt.paint_background["background-color"]),
        "background-pattern": new Ln(mt.paint_background["background-pattern"]),
        "background-opacity": new Mn(mt.paint_background["background-opacity"])
      })
    },
        Ms = function (t) {
      function e(e) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e;
        ...
        Ts = {
      paint: new Dn({
        "raster-opacity": new Mn(mt.paint_raster["raster-opacity"]),
        "raster-hue-rotate": new Mn(mt.paint_raster["raster-hue-rotate"]),
        "raster-brightness-min": new Mn(mt.paint_raster["raster-brightness-min"]),
        "raster-brightness-max": new Mn(mt.paint_raster["raster-brightness-max"]),
        "raster-saturation": new Mn(mt.paint_raster["raster-saturation"]),
        "raster-contrast": new Mn(mt.paint_raster["raster-contrast"]),
        "raster-resampling": new Mn(mt.paint_raster["raster-resampling"]),
        "raster-fade-duration": new Mn(mt.paint_raster["raster-fade-duration"])
      })
    },
        Fs = function (t) {
      function e(e) {
    ...
    var Ls = function (t) {
      ...
      }, e.prototype.recalculate = function () {}, e.prototype.updateTransitions = function () {}, e.prototype.hasTransition = function () {}, e.prototype.serialize = function () {}, e.prototype.resize = function () {
        this.viewportFrame && (this.viewportFrame.destroy(), this.viewportFrame = null);
    ...
    var qs = function (t, e) {
      ...
      this.image = y, this.iconPositions = r, this.patternPositions = n;
    };

    sn("ImagePosition", Us), sn("ImageAtlas", qs);

    var Rs = self.HTMLImageElement,
        Ns = self.HTMLCanvasElement,
        Ks = self.HTMLVideoElement,
        Gs = self.ImageData,
        Xs = function (t, e, r, n) {
    ...
    Js.prototype = {
      ...
      readVarint: function (t) {
        ...
        return e = 127 & (r = n[this.pos++]), r < 128 ? e : (e |= (127 & (r = n[this.pos++])) << 7, r < 128 ? e : (e |= (127 & (r = n[this.pos++])) << 14, r < 128 ? e : (e |= (127 & (r = n[this.pos++])) << 21, r < 128 ? e : function (t, e, r) {
          var n,
              i,
              a = r.buf;
          if (i = a[r.pos++], n = (112 & i) >> 4, i < 128) return Ws(t, n, e);
          if (i = a[r.pos++], n |= (127 & i) << 3, i < 128) return Ws(t, n, e);
          if (i = a[r.pos++], n |= (127 & i) << 10, i < 128) return Ws(t, n, e);
          if (i = a[r.pos++], n |= (127 & i) << 17, i < 128) return Ws(t, n, e);
          if (i = a[r.pos++], n |= (127 & i) << 24, i < 128) return Ws(t, n, e);
          if (i = a[r.pos++], n |= (1 & i) << 31, i < 128) return Ws(t, n, e);
      ...
      skip: function (t) {
        var e = 7 & t;
        if (e === Js.Varint) for (; this.buf[this.pos++] > 127;);else if (e === Js.Bytes) this.pos = this.readVarint() + this.pos;else if (e === Js.Fixed32) this.pos += 4;else {
      ...
      writePackedVarint: function (t, e) {
        this.writeMessage(t, tu, e);
      },
      writePackedSVarint: function (t, e) {
        this.writeMessage(t, eu, e);
      },
      writePackedBoolean: function (t, e) {
        this.writeMessage(t, iu, e);
      },
      writePackedFloat: function (t, e) {
        this.writeMessage(t, ru, e);
      },
      writePackedDouble: function (t, e) {
        this.writeMessage(t, nu, e);
      },
      writePackedFixed32: function (t, e) {
        this.writeMessage(t, au, e);
      },
      writePackedSFixed32: function (t, e) {
        this.writeMessage(t, ou, e);
      },
      writePackedFixed64: function (t, e) {
        this.writeMessage(t, su, e);
      },
      writePackedSFixed64: function (t, e) {
        this.writeMessage(t, uu, e);
      },
    ...
    function fu(t, e, r) {
      1 === t && r.readMessage(yu, e);
    }

    function yu(t, e, r) {
      if (3 === t) {
        var n = r.readMessage(du, {}),
            i = n.id,
            a = n.bitmap,
            o = n.width,
            s = n.height,
    ...
    vu.prototype.send = function (t, e, r, n) {
      var i = this,
    ...
    }, vu.prototype.receive = function (t) {
      var e,
          r = this,
          n = t.data,
          i = n.id;
      ...
      if (!n.targetMapId || this.mapId === n.targetMapId) {
        ...
        if ("<response>" === n.type || "<cancel>" === n.type) e = this.callbacks[n.id], delete this.callbacks[n.id], e && n.error ? e(pn(n.error)) : e && e(null, pn(n.data));else if (void 0 !== n.id && this.parent[n.type]) {
          this.callbacks[n.id] = null;
          var o = this.parent[n.type](n.sourceMapId, pn(n.data), a);
          o && null === this.callbacks[n.id] && (this.callbacks[n.id] = o);
        } else if (void 0 !== n.id && this.parent.getWorkerSource) {
          var s = n.type.split("."),
              u = pn(n.data);
          this.parent.getWorkerSource(n.sourceMapId, s[0], u.source)[s[1]](u, a);
        } else this.parent[n.type](pn(n.data));
      }
    ...
    xu.prototype.setNorthEast = function (t) {
      return this._ne = t instanceof bu ? new bu(t.lng, t.lat) : bu.convert(t), this;
    }, xu.prototype.setSouthWest = function (t) {
      return this._sw = t instanceof bu ? new bu(t.lng, t.lat) : bu.convert(t), this;
    }, xu.prototype.extend = function (t) {
      var e,
          r,
          n = this._sw,
          i = this._ne;
      if (t instanceof bu) e = t, r = t;else {
        if (!(t instanceof xu)) return Array.isArray(t) ? t.every(Array.isArray) ? this.extend(xu.convert(t)) : this.extend(bu.convert(t)) : this;
        if (e = t._sw, r = t._ne, !e || !r) return this;
      }
      return n || i ? (n.lng = Math.min(e.lng, n.lng), n.lat = Math.min(e.lat, n.lat), i.lng = Math.max(r.lng, i.lng), i.lat = Math.max(r.lat, i.lat)) : (this._sw = new bu(e.lng, e.lat), this._ne = new bu(r.lng, r.lat)), this;
    ...
    }, xu.convert = function (t) {
      return !t || t instanceof xu ? t : new xu(t);
    };
    ...
    }, bu.prototype.toBounds = function (t) {
      void 0 === t && (t = 0);
      var e = 360 * t / 40075017,
          r = e / Math.cos(Math.PI / 180 * this.lat);
      return new xu(new bu(this.lng - r, this.lat - e), new bu(this.lng + r, this.lat + e));
    }, bu.convert = function (t) {
      if (t instanceof bu) return t;
      if (Array.isArray(t) && (2 === t.length || 3 === t.length)) return new bu(Number(t[0]), Number(t[1]));
      if (!Array.isArray(t) && "object" == typeof t && null !== t) return new bu(Number("lng" in t ? t.lng : t.lon), Number(t.lat));
    ...
    zu.fromLngLat = function (t, e) {
      void 0 === e && (e = 0);
      var r = bu.convert(t);
      return new zu(wu(r.lng), Au(r.lat), Su(e, r.lat));
    }, zu.prototype.toLngLat = function () {
      return new bu(360 * this.x - 180, ku(this.y));
    }, zu.prototype.toAltitude = function () {
      return t = this.z, e = this.y, t * _u(ku(e));
      var t, e;
    };

    var Iu = function (t, e, r) {
      this.z = t, this.x = e, this.y = r, this.key = Pu(0, t, e, r);
    };

    Iu.prototype.equals = function (t) {
      return this.z === t.z && this.x === t.x && this.y === t.y;
    }, Iu.prototype.url = function (t, e) {
      var r,
          n,
          i,
          a,
          o,
          s = (r = this.x, n = this.y, i = this.z, a = gu(256 * r, 256 * (n = Math.pow(2, i) - n - 1), i), o = gu(256 * (r + 1), 256 * (n + 1), i), a[0] + "," + a[1] + "," + o[0] + "," + o[1]),
          u = function (t, e, r) {
      ...
      return new i((t.x * e - this.x) * Yi, (t.y * e - this.y) * Yi);
    };

    var Bu = function (t, e) {
      this.wrap = t, this.canonical = e, this.key = Pu(t, e.z, e.x, e.y);
    },
        Eu = function (t, e, r, n, i) {
      this.overscaledZ = t, this.wrap = e, this.canonical = new Iu(r, +n, +i), this.key = Pu(e, t, n, i);
    };
    ...
    }, Eu.prototype.scaledTo = function (t) {
      var e = this.canonical.z - t;
      return t > this.canonical.z ? new Eu(t, this.wrap, this.canonical.z, this.canonical.x, this.canonical.y) : new Eu(t, this.wrap, t, this.canonical.x >> e, this.canonical.y >> e);
    }, Eu.prototype.isChildOf = function (t) {
    ...
    }, Eu.prototype.children = function (t) {
      if (this.overscaledZ >= t) return [new Eu(this.overscaledZ + 1, this.wrap, this.canonical.z, this.canonical.x, this.canonical.y)];
      var e = this.canonical.z + 1,
          r = 2 * this.canonical.x,
          n = 2 * this.canonical.y;
      return [new Eu(e, this.wrap, e, r, n), new Eu(e, this.wrap, e, r + 1, n), new Eu(e, this.wrap, e, r, n + 1), new Eu(e, this.wrap, e, r + 1, n + 1)];
    }, Eu.prototype.isLessThan = function (t) {
    ...
    }, Eu.prototype.unwrapTo = function (t) {
      return new Eu(this.overscaledZ, t, this.canonical.z, this.canonical.x, this.canonical.y);
    ...
    }, Eu.prototype.getTilePoint = function (t) {
      return this.canonical.getTilePoint(new zu(t.x - this.wrap, t.y));
    }, sn("CanonicalTileID", Iu), sn("OverscaledTileID", Eu, {
      omit: ["posMatrix"]
    });
    ...
    var Vu = function (t, e, r) {
      ...
      for (var i = e.data, a = "terrarium" === r ? this._unpackTerrarium : this._unpackMapbox, o = 0; o < n; o++) for (var s = 0; s < n; s++) {
        var u = 4 * (o * n + s);
    ...
    Vu.prototype.set = function (t, e, r) {
    ...
    }, Vu.prototype.backfillBorder = function (t, e, r) {
      ...
      for (var s = -e * this.dim, u = -r * this.dim, l = a; l < o; l++) for (var p = n; p < i; p++) this.set(p, l, t.get(p + s, l + u));
    }, sn("DEMData", Vu);
    var Cu = Nn([{
      name: "a_pos",
      type: "Int16",
    ...
    Lu.prototype.updateState = function (t, e, r) {
      var n = String(e);
      if (this.stateChanges[t] = this.stateChanges[t] || {}, this.stateChanges[t][n] = this.stateChanges[t][n] || {}, c(this.stateChanges[t][n], r), null === this.deletedStates[t]) for (var i in this.deletedStates[t] = {}, this.state[t]) i !== n && (this.deletedStates[t][i] = null);else if (this.deletedStates[t] && null === this.deletedStates[t][n]) for (var a in this.deletedStates[t][n] = {}, this.state[t][n]) r[a] || (this.deletedStates[t][n][a] = null);else for (var o in r) {
        this.deletedStates[t] && this.deletedStates[t][n] && null === this.deletedStates[t][n][o] && delete this.deletedStates[t][n][o];
      }
    }, Lu.prototype.removeFeatureState = function (t, e, r) {
    ...
    }, Lu.prototype.getState = function (t, e) {
      var r = String(e),
          n = this.state[t] || {},
      ...
      return a;
    }, Lu.prototype.initializeTileState = function (t, e) {
      t.setFeatureState(this.state, e);
    }, Lu.prototype.coalesceChanges = function (t, e) {
      var r = {};
    ...
    var Ou = function (t, e, r) {
      this.tileID = t, this.x = t.canonical.x, this.y = t.canonical.y, this.z = t.canonical.z, this.grid = e || new en(Yi, 16, 0), this.grid3D = new en(Yi, 16, 0), this.featureIndexArray = r || new Ai();
    };
    ...
    Ou.prototype.insert = function (t, e, r, n, i, a) {
      ...
      for (var s = a ? this.grid3D : this.grid, u = 0; u < e.length; u++) {
        ...
        p[0] < Yi && p[1] < Yi && p[2] >= 0 && p[3] >= 0 && s.insert(o, p[0], p[1], p[2], p[3]);
      }
    ...
    }, Ou.prototype.query = function (t, e, r) {
      var n = this;
      this.loadVTLayers();

      for (var a = t.params || {}, o = Yi / t.tileSize / t.scale, s = Er(a.filter), u = t.queryGeometry, l = t.queryPadding * o, p = Du(u), c = this.grid.query(p.minX - l, p.minY - l, p.maxX + l, p.maxY + l), h = Du(t.cameraQueryGeometry), f = this.grid3D.query(h.minX - l, h.minY - l, h.maxX + l, h.maxY + l, function (e, r, n, a) {
        return function (t, e, r, n, a) {
          ...
          if (t.length > 2) for (var p = 0, c = l; p < c.length; p += 1) if (pa(t, c[p])) return !0;
      ...
      return g;
    }, Ou.prototype.loadMatchingFeature = function (t, e, r, n, i, a, o, s) {
      ...
      if (!a || function (t, e) {
        ...
        if (i(new Sn(this.tileID.overscaledZ), p)) for (var c = 0; c < u.length; c++) {
          var h = u[c];
    ...
    }, Ou.prototype.lookupSymbolFeatures = function (t, e, r, n, i, a) {
      var o = {};
      this.loadVTLayers();

      for (var s = Er(n), u = 0, l = t; u < l.length; u += 1) {
        var p = l[u];
        this.loadMatchingFeature(o, e, r, p, s, i, a);
      }

      return o;
    }, Ou.prototype.hasLayer = function (t) {
      for (var e = 0, r = this.bucketLayerIDs; e < r.length; e += 1) for (var n = 0, i = r[e]; n < i.length; n += 1) {
        if (t === i[n]) return !0;
      }
    ...
    ju.prototype.registerFadeDuration = function (t) {
    ...
    }, ju.prototype.loadVectorData = function (t, e, r) {
    ...
    }, ju.prototype.getBucket = function (t) {
      return this.buckets[t.id];
    }, ju.prototype.upload = function (t) {
      ...
      var n = t.gl;
      this.imageAtlas && !this.imageAtlas.uploaded && (this.imageAtlasTexture = new Xs(t, this.imageAtlas.image, n.RGBA), this.imageAtlas.uploaded = !0), this.glyphAtlasImage && (this.glyphAtlasTexture = new Xs(t, this.glyphAtlasImage, n.ALPHA), this.glyphAtlasImage = null);
    }, ju.prototype.queryRenderedFeatures = function (t, e, r, n, i, a, o, s, u) {
    ...
    }, ju.prototype.querySourceFeatures = function (t, e) {
      if (this.latestFeatureIndex && this.latestFeatureIndex.rawTileData) {
        var r = this.latestFeatureIndex.loadVTLayers(),
            n = e ? e.sourceLayer : "",
            i = r._geojsonTileLayer || r[n];
        if (i) for (var a = Er(e && e.filter), o = this.tileID.canonical, s = o.z, u = o.x, l = o.y, p = {
          z: s,
          x: u,
          y: l
        }, c = 0; c < i.length; c++) {
          ...
          if (a(new Sn(this.tileID.overscaledZ), h)) {
    ...
    }, ju.prototype.setMask = function (t, e) {
      if (!o(this.mask, t) && (this.mask = t, this.clearMask(), !o(t, {
        0: !0
      }))) {
        var r = new Xn(),
            n = new si();
        this.segments = new zi(), this.segments.prepareSegment(0, r, n);
        ...
        this.maskedBoundsBuffer = e.createVertexBuffer(r, Cu.members), this.maskedIndexBuffer = e.createIndexBuffer(n);
      }
    }, ju.prototype.hasData = function () {
      return "loaded" === this.state || "reloading" === this.state || "expired" === this.state;
    }, ju.prototype.patternsLoaded = function () {
      return this.imageAtlas && !!Object.keys(this.imageAtlas.patternPositions).length;
    }, ju.prototype.setExpiryData = function (t) {
    ...
    }, ju.prototype.setFeatureState = function (t, e) {
    ...
    }, ju.prototype.setHoldDuration = function (t) {
    ...
    Ru.fromFeature = function (t, e) {
      for (var r = new Ru(), n = 0; n < t.sections.length; n++) {
        var i = t.sections[n];
        r.sections.push({
          scale: i.scale || 1,
    ...
    }, Ru.prototype.getSection = function (t) {
      return this.sections[this.sectionIndex[t]];
    }, Ru.prototype.getCharCode = function (t) {
      return this.text.charCodeAt(t);
    }, Ru.prototype.verticalizePunctuation = function () {
      this.text = function (t) {
        for (var e = "", r = 0; r < t.length; r++) {
          var n = t.charCodeAt(r + 1) || null,
              i = t.charCodeAt(r - 1) || null;
          n && mn(n) && !gs[t[r + 1]] || i && mn(i) && !gs[t[r - 1]] || !gs[t[r]] ? e += t[r] : e += gs[t[r]];
        }

        return e;
      }(this.text);
    }, Ru.prototype.trim = function () {
      for (var t = 0, e = 0; e < this.text.length && Nu[this.text.charCodeAt(e)]; e++) t++;

      for (var r = this.text.length, n = this.text.length - 1; n >= 0 && n >= t && Nu[this.text.charCodeAt(n)]; n--) r--;

      this.text = this.text.substring(t, r), this.sectionIndex = this.sectionIndex.slice(t, r);
    }, Ru.prototype.substring = function (t, e) {
      var r = new Ru();
      ...
      return this.text;
    }, Ru.prototype.getMaxScale = function () {
      var t = this;
    ...
    function Zu(t, e, r, n, i, a) {
      for (var o = null, s = Gu(e, r, i, a), u = 0, l = n; u < l.length; u += 1) {
        var p = l[u],
            c = Gu(e - p.x, r, i, a) + p.badness;
        c <= s && (o = p, s = c);
      }
    ...
    function Hu(t, e, r, n) {
      ...
      for (var i, a = [], o = function (t, e, r, n) {
        ...
        var l = t.getSection(u),
            ...
            c = n[l.fontStack],
            h = c && c[p];
        h && !Nu[p] && (s += h.metrics.advance * l.scale + e), u < t.length() - 1 && (Ku[p] || !((i = p) < 11904) && (hn["Bopomofo Extended"](i) || hn.Bopomofo(i) || hn["CJK Compatibility Forms"](i) || hn["CJK Compatibility Ideographs"](i) || hn["CJK Compatibility"](i) || hn["CJK Radicals Supplement"](i) || hn["CJK Strokes"](i) || hn["CJK Symbols and Punctuation"](i) || hn["CJK Unified Ideographs Extension A"](i) || hn["CJK Unified Ideographs"](i) || hn["Enclosed CJK Letters and Months"](i) || hn["Halfwidth and Fullwidth Forms"](i) || hn.Hiragana(i) || hn["Ideographic Description Characters"](i) || hn["Kangxi Radicals"](i) || hn["Katakana Phonetic Extensions"](i) || hn.Katakana(i) || hn["Vertical Forms"](i) || hn["Yi Radicals"](i) || hn["Yi Syllables"](i))) && a.push(Zu(u + 1, s, o, a, Xu(p, t.getCharCode(u + 1)), !1));
      }

      return function t(e) {
        return e ? t(e.priorBreak).concat(e.index) : [];
      }(Zu(t.length(), s, o, a, 0, !0));
    }
    ...
    function Ju(t, e, r, n, i) {
      if (i) {
        var a = t[n],
            o = e[a.fontStack],
            s = o && o[a.glyph];
        if (s) for (var u = s.metrics.advance * a.scale, l = (t[n].x + u) * i, p = r; p <= n; p++) t[p].x -= l;
      }
    }

    Ku[10] = !0, Ku[32] = !0, Ku[38] = !0, Ku[40] = !0, Ku[41] = !0, Ku[43] = !0, Ku[45] = !0, Ku[47] = !0, Ku[173] = !0, Ku[183] = !0, Ku[8203] = !0, Ku[8208] = !0, Ku[8211] = !0, Ku[8231] = !0, t.createCommonjsModule = e, t.window = self, t.Point = i, t.browser = V, t.getJSON = function (t, e) {
      return at(c(t, {
        type: "json"
      }), e);
    }, t.normalizeSpriteURL = function (t, e, r, n) {
      var i = X(t);
      return U(t) ? (i.path = "/styles/v1" + i.path + "/sprite" + e + r, D(i, n)) : (i.path += "" + e + r, Z(i));
    }, t.ResourceType = et, t.getImage = pt, t.RGBAImage = qa, t.ImagePosition = Us, t.Texture = Xs, t.potpack = Ds, t.normalizeGlyphsURL = function (t, e) {
      if (!U(t)) return t;
      var r = X(t);
      return r.path = "/fonts/v1" + r.path, D(r, e);
    }, t.getArrayBuffer = ot, t.parseGlyphPBF = function (t) {
      return new Ys(t).readFields(fu, []);
    ...
    }, t.isChar = hn, t.AlphaImage = ja, t.Properties = Dn, t.DataConstantProperty = Mn, t.styleSpec = mt, t.validateLight = $r, t.endsWith = v, t.emitValidationErrors = tn, t.validateStyle = Jr, t.extend = c, t.Evented = dt, t.sphericalToCartesian = function (t) {
      var e = t[0],
          r = t[1],
          n = t[2];
    ...
    }, t.number = le, t.Transitionable = In, t.warnOnce = w, t.uniqueId = f, t.Actor = vu, t.normalizeSourceURL = function (t, e) {
      if (!U(t)) return t;
      var r = X(t);
      return r.path = "/v4/" + r.authority + ".json", r.params.push("secure"), D(r, e);
    }, t.pick = function (t, e) {
      ...
      return r;
    }, t.canonicalizeTileset = function (t, e) {
      if (!U(e)) return t.tiles || [];
      ...
      return r;
    }, t.LngLatBounds = xu, t.mercatorXfromLng = wu, t.mercatorYfromLat = Au, t.Event = ft, t.ErrorEvent = yt, t.postTurnstileEvent = W, t.postMapLoadEvent = tt, t.normalizeTileURL = function (t, e, r) {
      if (!e || !U(e)) return t;
      var n = X(t),
          i = V.devicePixelRatio >= 2 || 512 === r ? "@2x" : "",
          a = M.supported ? ".webp" : "$1";
      return n.path = n.path.replace(R, "" + i + a), n.path = "/v4" + n.path, D(n);
    }, t.OverscaledTileID = Eu, t.EXTENT = Yi, t.MercatorCoordinate = zu, t.CanonicalTileID = Iu, t.StructArrayLayout4i8 = Xn, t.rasterBoundsAttributes = Cu, t.SegmentVector = zi, t.getVideo = function (t, e) {
      var r,
          n,
    ...
    }, t.ValidationError = vt, t.bindAll = m, t.multiply = function (t, e, r) {
      var n = e[0],
          i = e[1],
          a = e[2],
          o = e[3],
    ...
    }, t.Color = Dt, t.isEqual = o, t.keysDifference = function (t, e) {
      var r = [];

      for (var n in t) n in e || r.push(n);

      return r;
    }, t.Tile = ju, t.SourceFeatureState = Lu, t.refProperties = ["type", "source", "source-layer", "minzoom", "maxzoom", "filter", "layout"], t.rotateZ = function (t, e, r) {
      var n = Math.sin(r),
          i = Math.cos(r),
          a = e[0],
          o = e[1],
      ...
      if ("camera" === t.functionType) {
        var n = t.propertyValue,
            i = t.zoomRange,
            a = t.sizeRange,
            o = l(br(n, r.specification).interpolationFactor(e, i.min, i.max), 0, 1);
        return {
          uSizeT: 0,
      ...
      var s = t.propertyValue,
          u = t.zoomRange;
      return {
        uSizeT: l(br(s, r.specification).interpolationFactor(e, u.min, u.max), 0, 1),
        uSize: 0
      };
    }, t.WritingMode = qu, t.transformMat4 = Sa, t.evaluateSizeForFeature = function (t, e, r) {
      var n = e;
      return "source" === t.functionType ? r.lowerSize / bs : "composite" === t.functionType ? le(r.lowerSize / bs, r.upperSize / bs, n.uSizeT) : n.uSize;
    }, t.addDynamicAttributes = ks, t.properties = Ps, t.polygonIntersectsPolygon = ea, t.isMapboxURL = U, t.normalizeStyleURL = function (t, e) {
      if (!U(t)) return t;
      var r = X(t);
      return r.path = "/styles/v1" + r.path, D(r, e);
    }, t.createStyleLayer = function (t) {
      return "custom" === t.type ? new Ls(t) : new Os[t.type](t);
    }, t.clone = b, t.validateCustomStyleLayer = function (t) {
      var e = [],
          r = t.id;
    ...
    }, t.filterObject = x, t.mapObject = g, t.evented = wn, t.makeRequest = at, t.registerForPluginAvailability = function (t) {
      return bn ? t({
        pluginURL: bn,
        completionCallback: gn
      }) : wn.once("pluginAvailable", t), t;
    }, t.ZoomHistory = cn, t.getReferrer = it, t.createLayout = Nn, t.UniformMatrix4f = Di, t.Uniform3f = Ti, t.Uniform1f = Ci, t.Uniform1i = Vi, t.Uniform2f = Mi, t.Uniform4f = Fi, t.create = ga, t.fromRotation = function (t, e) {
      var r = Math.sin(e),
          n = Math.cos(e);
      ...
      var t = new va(16);
      return va != Float32Array && (t[1] = 0, t[2] = 0, t[3] = 0, t[4] = 0, t[6] = 0, t[7] = 0, t[8] = 0, t[9] = 0, t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0), t[0] = 1, t[5] = 1, t[10] = 1, t[15] = 1, t;
      ...
      var t = new va(4);
      return va != Float32Array && (t[1] = 0, t[2] = 0), t[0] = 1, t[3] = 1, t;
    ...
    }, t.LngLat = bu, t.UnwrappedTileID = Bu, t.perspective = function (t, e, r, n, i) {
      var a,
          o = 1 / Math.tan(e / 2);
    ...
    }, t.mercatorZfromAltitude = Su, t.invert = function (t, e) {
      var r = e[0],
          n = e[1],
          i = e[2],
          a = e[3],
          ...
          B = c * v - f * d,
          E = h * v - f * m,
          P = g * E - x * B + b * I + _ * z - w * k + A * S;

      return P ? (P = 1 / P, t[0] = (s * E - u * B + l * I) * P, t[1] = (i * B - n * E - a * I) * P, t[2] = (d * A - m * w + v * _) * P, t[3] = (h * w - c * A - f * _) * P, t[4] = (u * z - o * E - l * k) * P, t[5] = (r * E - i * z + a * k) * P, t[6] = (m * b - y * A - v * x) * P, t[7] = (p * A - h * b + f * x) * P, t[8] = (o * B - s * z + l * S) * P, t[9] = (n * z - r * B - a * S) * P, t[10] = (y * w - d * b + v * g) * P, t[11] = (c * b - p * w - f * g) * P, t[12] = (s * k - o * I - u * S) * P, t[13] = (r * I - n * k + i * S) * P, t[14] = (d * x - y * _ - m * g) * P, t[15] = (p * _ - c * x + h * g) * P, t) : null;
    }, t.ease = u, t.bezier = s, t.config = C, t.webpSupported = M, t.EvaluationParameters = Sn, t.version = "0.53.0-beta.1", t.setRTLTextPlugin = function (t, e) {
      if (xn) throw new Error("setRTLTextPlugin cannot be called multiple times.");
      xn = !0, bn = V.resolveURL(t), gn = function (t) {
        t ? (xn = !1, bn = null, e && e(t)) : _n = !0;
      }, wn.fire(new ft("pluginAvailable", {
        pluginURL: bn,
        completionCallback: gn
      }));
    }, t.featureFilter = Er, t.values = function (t) {
      var e = [];

      for (var r in t) e.push(t[r]);

      return e;
    }, t.Anchor = xs, t.GLYPH_PBF_BORDER = mu, t.distToSegmentSquared = ua, t.allowsLetterSpacing = function (t) {
      for (var e = 0, r = t; e < r.length; e += 1) if (!yn(r[e].charCodeAt(0))) return !1;

      return !0;
    }, t.shapeText = function (t, e, r, n, i, a, o, s, u, l, p) {
      var c = Ru.fromFeature(t, r);
      p === qu.vertical && c.verticalizePunctuation();
      var h,
          f = [],
          y = {
        positionedGlyphs: f,
        ...
        writingMode: p
          ...
          d = An.processBidirectionalText,
          m = An.processStyledBidirectionalText;

      if (d && 1 === c.sections.length) {
        h = [];

        for (var v = 0, g = d(c.toString(), Hu(c, s, n, e)); v < g.length; v += 1) {
          var x = g[v],
              b = new Ru();
          b.text = x, b.sections = c.sections;

          for (var _ = 0; _ < x.length; _++) b.sectionIndex.push(0);
        ...
        for (var w = 0, A = m(c.text, c.sectionIndex, Hu(c, s, n, e)); w < A.length; w += 1) {
          var S = A[w],
              k = new Ru();
          k.text = S[0], k.sectionIndex = S[1], k.sections = c.sections, h.push(k);
        }
      } else h = function (t, e) {
      ...
      return function (t, e, r, n, i, a, o, s, u) {
        for (var l = 0, p = -17, c = 0, h = t.positionedGlyphs, f = "right" === a ? 1 : "left" === a ? 0 : .5, y = 0, d = r; y < d.length; y += 1) {
          var m = d[y];
          m.trim();
          var v = m.getMaxScale();
          ...
          if (m.length()) {
            for (var g = h.length, x = 0; x < m.length(); x++) {
              ...
              S && (dn(_) && o !== qu.horizontal ? (h.push({
                ...
                scale: b.scale,
                fontStack: b.fontStack
              }), l += S.metrics.advance * b.scale + s));
            }

            if (h.length !== g) {
              var k = l - s;
              c = Math.max(k, c), Ju(h, e, g, h.length - 1, f);
            }
        ...
        }(h, f, I, B, c, n, r.length);
        var E = p - -17;
        t.top += -B * E, t.bottom = t.top + E, t.left += -I * c, t.right = t.left + c;
      }(y, e, h, i, a, o, p, s, l), !!f.length && (y.text = y.text.toString(), y);
    }, t.allowsVerticalWritingMode = fn, t.shapeIcon = function (t, e, r) {
      var n = Yu(r),
          i = n.horizontalAlign,
          a = n.verticalAlign,
          o = e[0],
  ...
  define(["./shared.js"], function (e) {
    ...
    function t(e) {
      ...
      if (Array.isArray(e)) {
        for (var n = "[", o = 0, i = e; o < i.length; o += 1) {
          n += t(i[o]) + ",";
        }
    ...
    function r(r) {
      for (var n = "", o = 0, i = e.refProperties; o < i.length; o += 1) {
        n += "/" + t(r[i[o]]);
      }
    ...
    function o(e, t, r, n, o) {
      ...
      for (var i = t, a = t.segment + 1, s = 0; s > -r / 2;) {
        if (--a < 0) return !1;
        s -= e[a].dist(i), i = e[a];
      }
      ...
      for (var l = [], u = 0; s < r / 2;) {
        var h = e[a - 1],
            ...
            p = e[a + 1];
        if (!p) return !1;
        var f = h.angleTo(c) - c.angleTo(p);

        for (f = Math.abs((f + 3 * Math.PI) % (2 * Math.PI) - Math.PI), l.push({
          distance: s,
          angleDelta: f
        }), u += f; s - l[0].distance > n;) u -= l.shift().angleDelta;
    ...
    function l(t, r, n, l, u, h) {
      for (var c = a(n, u, h), p = s(n, l) * h, f = 0, d = i(t) / 2, g = 0; g < t.length - 1; g++) {
        var m = t[g],
            v = t[g + 1],
            y = m.dist(v);
        ...
        if (f + y > d) {
          var x = (d - f) / y,
              ...
              M = e.number(m.y, v.y, x),
              S = new e.Anchor(w, M, v.angleTo(m), g);
          return S._round(), !c || o(t, S, p, c, r) ? S : void 0;
        }
    ...
    function u(t, r, n, l, u, h, c, p, f) {
      var d = a(l, h, c),
          g = s(l, u),
          m = g * c,
          v = 0 === t[0].x || t[0].x === f || 0 === t[0].y || t[0].y === f;
      return r - m < r / 4 && (r = m + r / 4), function t(r, n, a, s, l, u, h, c, p) {
        var f = u / 2;
        var d = i(r);
        var g = 0,
            m = n - a;
        ...
        for (var y = 0; y < r.length - 1; y++) {
          for (var x = r[y], w = r[y + 1], M = x.dist(w), S = w.angleTo(x); m + a < g + M;) {
            var _ = ((m += a) - g) / M,
                P = e.number(x.x, w.x, _),
                b = e.number(x.y, w.y, _);

            if (P >= 0 && P < p && b >= 0 && b < p && m - f >= 0 && m + f <= d) {
              var T = new e.Anchor(P, b, S, y);
              T._round(), s && !o(r, T, u, s, l) || v.push(T);
            }
          }
        ...
        c || v.length || h || (v = t(r, g / 2, a, s, l, u, h, !0, p));
        return v;
      }(t, v ? r / 2 * p % r : (g / 2 + 2 * h) * c * p % r, r, d, n, m, v, !1, f);
    }

    n.prototype.replace = function (e) {
      this._layerConfigs = {}, this._layers = {}, this.update(e, []);
    }, n.prototype.update = function (t, n) {
      for (var o = this, i = 0, a = t; i < a.length; i += 1) {
        var s = a[i];
    ...
    var h = function (t, r, n, o, i, a, s, l, u, h, c, p) {
      var f = s.top * l - u,
          d = s.bottom * l + u,
          g = s.left * l - u,
          m = s.right * l + u;
      ...
      if (this.boxStartIndex = t.length, h) {
        var v = d - f,
            y = m - g;
        v > 0 && (v = Math.max(10 * l, v), this._addLineCollisionCircles(t, r, n, n.segment, y, v, o, i, a, c));
      } else {
        if (p) {
          var x = new e.Point(g, f),
              w = new e.Point(m, f),
              M = new e.Point(g, d),
              S = new e.Point(m, d),
              _ = p * Math.PI / 180;

          x._rotate(_), w._rotate(_), M._rotate(_), S._rotate(_), g = Math.min(x.x, w.x, M.x, S.x), m = Math.max(x.x, w.x, M.x, S.x), f = Math.min(x.y, w.y, M.y, S.y), d = Math.max(x.y, w.y, M.y, S.y);
        }

        t.emplaceBack(n.x, n.y, g, f, m, d, o, i, a, 0, 0);
      }

      this.boxEndIndex = t.length;
    };

    h.prototype._addLineCollisionCircles = function (e, t, r, n, o, i, a, s, l, u) {
      var h = i / 2,
          c = Math.floor(o / h) || 1,
          p = 1 + .4 * Math.log(u) / Math.LN2,
          f = Math.floor(c * p / 2),
          d = -i / 2,
          g = r,
          m = n + 1,
      ...
      for (var w = t[m].dist(t[m + 1]), M = -f; M < c + f; M++) {
        var S = M * h,
            _ = y + S;

        if (S < 0 && (_ += S), S > o && (_ += S - o), !(_ < v)) {
          for (; v + w < _;) {
          ...
          var P = _ - v,
              b = t[m],
              T = t[m + 1].sub(b)._unit()._mult(P)._add(b)._round(),
              I = Math.abs(_ - d) < h ? 0 : .8 * (_ - d);

          e.emplaceBack(T.x, T.y, -i / 2, -i / 2, i / 2, i / 2, a, s, l, i / 2, I);
        }
      }
    };

    var c = function (e, t) {
      if (void 0 === e && (e = []), void 0 === t && (t = p), this.data = e, this.length = this.data.length, this.compare = t, this.length > 0) for (var r = (this.length >> 1) - 1; r >= 0; r--) this._down(r);
    };
    ...
    function f(t, r, n) {
      ...
      for (var o = 1 / 0, i = 1 / 0, a = -1 / 0, s = -1 / 0, l = t[0], u = 0; u < l.length; u++) {
        var h = l[u];
        (!u || h.x < o) && (o = h.x), (!u || h.y < i) && (i = h.y), (!u || h.x > a) && (a = h.x), (!u || h.y > s) && (s = h.y);
      }
      ...
      var p = a - o,
          ...
          v = m / 2,
          y = new c([], d);
      if (0 === m) return new e.Point(o, i);

      for (var x = o; x < a; x += m) for (var w = i; w < s; w += m) y.push(new g(x + v, w + v, v, t));

      for (var M = function (e) {
        for (var t = 0, r = 0, n = 0, o = e[0], i = 0, a = o.length, s = a - 1; i < a; s = i++) {
          var l = o[i],
              u = o[s],
              h = l.x * u.y - u.x * l.y;
        ...
        return new g(r / t, n / t, 0, e);
      }(t), S = y.length; y.length;) {
        var _ = y.pop();

        (_.d > M.d || !M.d) && (M = _, n && console.log("found best %d after %d probes", Math.round(1e4 * _.d) / 1e4, S)), _.max - M.d <= r || (v = _.h / 2, y.push(new g(_.p.x - v, _.p.y - v, v, t)), y.push(new g(_.p.x + v, _.p.y - v, v, t)), y.push(new g(_.p.x - v, _.p.y + v, v, t)), y.push(new g(_.p.x + v, _.p.y + v, v, t)), S += 4);
      }

      return n && (console.log("num probes: " + S), console.log("best distance: " + M.d)), M.p;
    }
    ...
    function g(t, r, n, o) {
      this.p = new e.Point(t, r), this.h = n, this.d = function (t, r) {
        for (var n = !1, o = 1 / 0, i = 0; i < r.length; i++) for (var a = r[i], s = 0, l = a.length, u = l - 1; s < l; u = s++) {
          var h = a[s],
              c = a[u];
          h.y > t.y != c.y > t.y && t.x < (c.x - h.x) * (t.y - h.y) / (c.y - h.y) + h.x && (n = !n), o = Math.min(o, e.distToSegmentSquared(t, h, c));
        }
    ...
    var m = e.createCommonjsModule(function (e) {
      e.exports = function (e, t) {
        var r, n, o, i, a, s, l, u;

        for (r = 3 & e.length, n = e.length - r, o = t, a = 3432918353, s = 461845907, u = 0; u < n;) l = 255 & e.charCodeAt(u) | (255 & e.charCodeAt(++u)) << 8 | (255 & e.charCodeAt(++u)) << 16 | (255 & e.charCodeAt(++u)) << 24, ++u, o = 27492 + (65535 & (i = 5 * (65535 & (o = (o ^= l = (65535 & (l = (l = (65535 & l) * a + (((l >>> 16) * a & 65535) << 16) & 4294967295) << 15 | l >>> 17)) * s + (((l >>> 16) * s & 65535) << 16) & 4294967295) << 13 | o >>> 19)) + ((5 * (o >>> 16) & 65535) << 16) & 4294967295)) + ((58964 + (i >>> 16) & 65535) << 16);
        ...
        v = e.createCommonjsModule(function (e) {
      e.exports = function (e, t) {
        for (var r, n = e.length, o = t ^ n, i = 0; n >= 4;) r = 1540483477 * (65535 & (r = 255 & e.charCodeAt(i) | (255 & e.charCodeAt(++i)) << 8 | (255 & e.charCodeAt(++i)) << 16 | (255 & e.charCodeAt(++i)) << 24)) + ((1540483477 * (r >>> 16) & 65535) << 16), o = 1540483477 * (65535 & o) + ((1540483477 * (o >>> 16) & 65535) << 16) ^ (r = 1540483477 * (65535 & (r ^= r >>> 24)) + ((1540483477 * (r >>> 16) & 65535) << 16)), n -= 4, ++i;
        ...
        switch (n) {
          ...
          case 1:
            o = 1540483477 * (65535 & (o ^= 255 & e.charCodeAt(i))) + ((1540483477 * (o >>> 16) & 65535) << 16);
        }
    ...
    function M(t, r, n, o, i, a) {
      ...
      if ("composite" === t.textSizeData.functionType) {
        var c = t.textSizeData.zoomRange,
            p = c.min,
            f = c.max;
        h.compositeTextSizes = [u["text-size"].possiblyEvaluate(new e.EvaluationParameters(p)), u["text-size"].possiblyEvaluate(new e.EvaluationParameters(f))];
      }
      ...
      for (var v = 24 * l.get("text-line-height"), y = "map" === l.get("text-rotation-alignment") && "point" !== l.get("symbol-placement"), x = l.get("text-keep-upright"), w = 0, M = t.features; w < M.length; w += 1) {
        var _ = M[w],
            P = l.get("text-font").evaluate(_, {}).join(","),
            b = n,
            T = {},
            I = _.text;
        ...
        if (I) {
          var k = I.toString(),
              z = l.get("text-offset").evaluate(_, {}).map(function (e) {
            return 24 * e;
          }),
              C = 24 * l.get("text-letter-spacing").evaluate(_, {}),
              E = e.allowsLetterSpacing(k) ? C : 0,
              A = l.get("text-anchor").evaluate(_, {}),
              L = l.get("text-justify").evaluate(_, {}),
              D = "point" === l.get("symbol-placement") ? 24 * l.get("text-max-width").evaluate(_, {}) : 0;
          T.horizontal = e.shapeText(I, r, P, D, v, A, L, E, z, 24, e.WritingMode.horizontal), e.allowsVerticalWritingMode(k) && y && x && (T.vertical = e.shapeText(I, r, P, D, v, A, L, E, z, 24, e.WritingMode.vertical));
        }
        ...
        if (_.icon) {
          var N = o[_.icon];
          N && (O = e.shapeIcon(i[_.icon], l.get("icon-offset").evaluate(_, {}), l.get("icon-anchor").evaluate(_, {})), void 0 === t.sdfIcons ? t.sdfIcons = N.sdf : t.sdfIcons !== N.sdf && e.warnOnce("Style sheet warning: Cannot mix SDF and non-SDF icons in one buffer"), N.pixelRatio !== t.pixelRatio ? t.iconsNeedLinear = !0 : 0 !== l.get("icon-rotate").constantOr(1) && (t.iconsNeedLinear = !0));
        }

        (T.horizontal || O) && S(t, _, T, O, b, h);
      }

      a && t.generateCollisionDebugBuffers();
    }

    function S(t, r, n, o, i, a) {
      var s = a.layoutTextSize.evaluate(r, {}),
          c = a.layoutIconSize.evaluate(r, {}),
          p = a.textMaxSize.evaluate(r, {});
      void 0 === p && (p = s);

      var d = t.layers[0].layout,
          g = d.get("text-offset").evaluate(r, {}),
          m = d.get("icon-offset").evaluate(r, {}),
          v = s / 24,
          x = t.tilePixelRatio * v,
          w = t.tilePixelRatio * p / 24,
          M = t.tilePixelRatio * c,
          S = t.tilePixelRatio * d.get("symbol-spacing"),
          T = d.get("text-padding") * t.tilePixelRatio,
          I = d.get("icon-padding") * t.tilePixelRatio,
          k = d.get("text-max-angle") / 180 * Math.PI,
          z = "map" === d.get("text-rotation-alignment") && "point" !== d.get("symbol-placement"),
          C = "map" === d.get("icon-rotation-alignment") && "point" !== d.get("symbol-placement"),
          E = d.get("symbol-placement"),
          A = S / 2,
          L = function (s, l) {
        l.x < 0 || l.x >= e.EXTENT || l.y < 0 || l.y >= e.EXTENT || function (t, r, n, o, i, a, s, l, u, c, p, f, d, g, m, v, x, w, M, S, b) {
          var T,
              I,
              k = t.addToLineVertexArray(r, n),
              z = 0,
              C = 0,
              E = 0,
              A = y(o.horizontal ? o.horizontal.text : ""),
              L = [];

          if (o.horizontal) {
            var D = a.layout.get("text-rotate").evaluate(M, {});
            T = new h(s, n, r, l, u, c, o.horizontal, p, f, d, t.overscaling, D), C += P(t, r, o.horizontal, a, d, M, g, k, o.vertical ? e.WritingMode.horizontal : e.WritingMode.horizontalOnly, L, S, b), o.vertical && (E += P(t, r, o.vertical, a, d, M, g, k, e.WritingMode.vertical, L, S, b));
          }

          var O = T ? T.boxStartIndex : t.collisionBoxArray.length,
              N = T ? T.boxEndIndex : t.collisionBoxArray.length;

          if (i) {
            var R = function (t, r, n, o, i, a) {
              var s,
                  l,
                  u,
                  h,
                  c = r.image,
                  p = n.layout,
                  f = r.top - 1 / c.pixelRatio,
                  d = r.left - 1 / c.pixelRatio,
                  g = r.bottom + 1 / c.pixelRatio,
                  m = r.right + 1 / c.pixelRatio;

              if ("none" !== p.get("icon-text-fit") && i) {
                var v = m - d,
                    y = g - f,
                    x = p.get("text-size").evaluate(a, {}) / 24,
                    w = i.left * x,
                    M = i.right * x,
                    S = i.top * x,
                    _ = M - w,
                    P = i.bottom * x - S,
                    b = p.get("icon-text-fit-padding")[0],
                    T = p.get("icon-text-fit-padding")[1],
                    I = p.get("icon-text-fit-padding")[2],
                    k = p.get("icon-text-fit-padding")[3],
                    z = "width" === p.get("icon-text-fit") ? .5 * (P - y) : 0,
                    C = "height" === p.get("icon-text-fit") ? .5 * (_ - v) : 0,
                    E = "width" === p.get("icon-text-fit") || "both" === p.get("icon-text-fit") ? _ : v,
                    A = "height" === p.get("icon-text-fit") || "both" === p.get("icon-text-fit") ? P : y;

                s = new e.Point(w + C - k, S + z - b), l = new e.Point(w + C + T + E, S + z - b), u = new e.Point(w + C + T + E, S + z + I + A), h = new e.Point(w + C - k, S + z + I + A);
              } else s = new e.Point(d, f), l = new e.Point(m, f), u = new e.Point(m, g), h = new e.Point(d, g);

              var L = n.layout.get("icon-rotate").evaluate(a, {}) * Math.PI / 180;

              if (L) {
                var D = Math.sin(L),
                    O = Math.cos(L),
                    N = [O, -D, D, O];
                s._matMult(N), l._matMult(N), h._matMult(N), u._matMult(N);
              }
            ...
            }(0, i, a, 0, o.horizontal, M),
                F = a.layout.get("icon-rotate").evaluate(M, {});

            I = new h(s, n, r, l, u, c, i, m, v, !1, t.overscaling, F), z = 4 * R.length;
            var B = t.iconSizeData,
                Z = null;
            "source" === B.functionType ? (Z = [e.SIZE_PACK_FACTOR * a.layout.get("icon-size").evaluate(M, {})])[0] > _ && e.warnOnce(t.layerIds[0] + ': Value for "icon-size" is >= 256. Reduce your "icon-size".') : "composite" === B.functionType && ((Z = [e.SIZE_PACK_FACTOR * b.compositeIconSizes[0].evaluate(M, {}), e.SIZE_PACK_FACTOR * b.compositeIconSizes[1].evaluate(M, {})])[0] > _ || Z[1] > _) && e.warnOnce(t.layerIds[0] + ': Value for "icon-size" is >= 256. Reduce your "icon-size".'), t.addSymbols(t.icon, R, Z, w, x, M, !1, r, k.lineStartIndex, k.lineLength);
          }

          var j = I ? I.boxStartIndex : t.collisionBoxArray.length,
              G = I ? I.boxEndIndex : t.collisionBoxArray.length;
          ...
          t.symbolInstances.emplaceBack(r.x, r.y, L.length > 0 ? L[0] : -1, L.length > 1 ? L[1] : -1, A, O, N, j, G, l, C, E, z, 0);
        }(t, l, s, n, o, t.layers[0], t.collisionBoxArray, r.index, r.sourceLayerIndex, t.index, x, T, z, g, M, I, C, m, r, i, a);
      };

      if ("line" === E) for (var D = 0, O = function (t, r, n, o, i) {
        for (var a = [], s = 0; s < t.length; s++) for (var l = t[s], u = void 0, h = 0; h < l.length - 1; h++) {
          var c = l[h],
              p = l[h + 1];
          c.x < r && p.x < r || (c.x < r ? c = new e.Point(r, c.y + (p.y - c.y) * ((r - c.x) / (p.x - c.x)))._round() : p.x < r && (p = new e.Point(r, c.y + (p.y - c.y) * ((r - c.x) / (p.x - c.x)))._round()), c.y < n && p.y < n || (c.y < n ? c = new e.Point(c.x + (p.x - c.x) * ((n - c.y) / (p.y - c.y)), n)._round() : p.y < n && (p = new e.Point(c.x + (p.x - c.x) * ((n - c.y) / (p.y - c.y)), n)._round()), c.x >= o && p.x >= o || (c.x >= o ? c = new e.Point(o, c.y + (p.y - c.y) * ((o - c.x) / (p.x - c.x)))._round() : p.x >= o && (p = new e.Point(o, c.y + (p.y - c.y) * ((o - c.x) / (p.x - c.x)))._round()), c.y >= i && p.y >= i || (c.y >= i ? c = new e.Point(c.x + (p.x - c.x) * ((i - c.y) / (p.y - c.y)), i)._round() : p.y >= i && (p = new e.Point(c.x + (p.x - c.x) * ((i - c.y) / (p.y - c.y)), i)._round()), u && c.equals(u[u.length - 1]) || (u = [c], a.push(u)), u.push(p)))));
        }

        return a;
      }(r.geometry, 0, 0, e.EXTENT, e.EXTENT); D < O.length; D += 1) for (var N = O[D], R = 0, F = u(N, S, k, n.vertical || n.horizontal, o, 24, w, t.overscaling, e.EXTENT); R < F.length; R += 1) {
        var B = F[R],
            Z = n.horizontal;
        Z && b(t, Z.text, A, B) || L(N, B);
      } else if ("line-center" === E) for (var j = 0, G = r.geometry; j < G.length; j += 1) {
        var J = G[j];

        if (J.length > 1) {
          var X = l(J, k, n.vertical || n.horizontal, o, 24, w);
          X && L(J, X);
        }
      } else if ("Polygon" === r.type) for (var V = 0, W = e.classifyRings(r.geometry, 0); V < W.length; V += 1) {
        var Y = W[V],
            q = f(Y, 16);
        L(Y[0], new e.Anchor(q.x, q.y, 0));
      } else if ("LineString" === r.type) for (var U = 0, K = r.geometry; U < K.length; U += 1) {
        var H = K[U];
        L(H, new e.Anchor(H[0].x, H[0].y, 0));
      } else if ("Point" === r.type) for (var Q = 0, $ = r.geometry; Q < $.length; Q += 1) for (var ee = 0, te = $[Q]; ee < te.length; ee += 1) {
        var re = te[ee];
        L([re], new e.Anchor(re.x, re.y, 0));
      }
    }
    ...
    function P(t, r, n, o, i, a, s, l, u, h, c, p) {
      var f = function (t, r, n, o, i, a) {
        for (var s = n.layout.get("text-rotate").evaluate(i, {}) * Math.PI / 180, l = n.layout.get("text-offset").evaluate(i, {}).map(function (e) {
          return 24 * e;
          ...
          if (d) {
            ...
            if (g) {
              var m = e.GLYPH_PBF_BORDER + 1,
                  v = d.metrics.advance * p.scale / 2,
                  y = o ? [p.x + v, p.y] : [0, 0],
                  x = o ? [0, 0] : [p.x + v + l[0], p.y + l[1]],
                  w = (d.metrics.left - m) * p.scale - v + x[0],
                  M = (-d.metrics.top - m) * p.scale + x[1],
                  S = w + g.w * p.scale,
                  _ = M + g.h * p.scale,
                  P = new e.Point(w, M),
                  b = new e.Point(S, M),
              ...
              if (o && p.vertical) {
                var k = new e.Point(-v, v),
                    z = -Math.PI / 2,
                    C = new e.Point(5, 0);
                P._rotateAround(z, k)._add(C), b._rotateAround(z, k)._add(C), T._rotateAround(z, k)._add(C), I._rotateAround(z, k)._add(C);
              }
              ...
              if (s) {
                var E = Math.sin(s),
                    A = Math.cos(s),
                    L = [A, -E, E, A];
                P._matMult(L), b._matMult(L), T._matMult(L), I._matMult(L);
              }
      ...
      return "source" === d.functionType ? (g = [e.SIZE_PACK_FACTOR * o.layout.get("text-size").evaluate(a, {})])[0] > _ && e.warnOnce(t.layerIds[0] + ': Value for "text-size" is >= 256. Reduce your "text-size".') : "composite" === d.functionType && ((g = [e.SIZE_PACK_FACTOR * p.compositeTextSizes[0].evaluate(a, {}), e.SIZE_PACK_FACTOR * p.compositeTextSizes[1].evaluate(a, {})])[0] > _ || g[1] > _) && e.warnOnce(t.layerIds[0] + ': Value for "text-size" is >= 256. Reduce your "text-size".'), t.addSymbols(t.text, f, g, s, i, a, u, r, l.lineStartIndex, l.lineLength), h.push(t.text.placedSymbolArray.length - 1), 4 * f.length;
    }
    ...
    function b(e, t, r, n) {
      ...
      if (t in o) {
        for (var i = o[t], a = i.length - 1; a >= 0; a--) if (n.dist(i[a]) < r) return !0;
      } else o[t] = [];
    ...
    function k(t, r) {
      for (var n = new e.EvaluationParameters(r), o = 0, i = t; o < i.length; o += 1) {
        i[o].recalculate(n);
      }
    }

    I.prototype.parse = function (t, r, n, o) {
      var i = this;
      ...
      for (var g in d) {
        ...
        if (m) {
          1 === m.version && e.warnOnce('Vector tile source "' + this.source + '" layer "' + g + '" does not use vector tile spec v2 and therefore may have some rendering errors.');

          for (var v = a.encode(g), y = [], x = 0; x < m.length; x++) {
            var w = m.feature(x);
            y.push({
              feature: w,
              index: x,
          ...
          for (var S = 0, _ = d[g]; S < _.length; S += 1) {
            var P = _[S],
                b = P[0];
            if (!(b.minzoom && this.zoom < Math.floor(b.minzoom))) if (!(b.maxzoom && this.zoom >= b.maxzoom)) if ("none" !== b.visibility) k(P, this.zoom), (p[b.id] = b.createBucket({
            ...
            })).populate(y, f), s.bucketLayerIDs.push(P.map(function (e) {
              return e.id;
            }));
          }
        }
      ...
      var I = e.mapObject(f.glyphDependencies, function (e) {
      ...
      var z = Object.keys(f.iconDependencies);
      z.length ? n.send("getImages", {
        icons: z
      }, function (e, t) {
        l || (l = e, h = t, E.call(i));
      }) : h = {};
      ...
      function E() {
        ...
        if (u && h && c) {
          var t = new T(u),
              r = new e.ImageAtlas(h, c);

          for (var n in p) {
            var i = p[n];
            i instanceof e.SymbolBucket ? (k(i.layers, this.zoom), M(i, u, t.positions, h, r.iconPositions, this.showCollisionBoxes)) : i.hasPattern && (i instanceof e.LineBucket || i instanceof e.FillBucket || i instanceof e.FillExtrusionBucket) && (k(i.layers, this.zoom), i.addFeatures(f, r.patternPositions));
          }

          this.status = "done", o(null, {
            buckets: e.values(p).filter(function (e) {
              return !e.isEmpty();
            }),
            featureIndex: s,
            collisionBoxArray: this.collisionBoxArray,
    ...
    var z = "undefined" != typeof performance,
        C = {
      getEntriesByName: function (e) {
        return !!(z && performance && performance.getEntriesByName) && performance.getEntriesByName(e);
      },
      mark: function (e) {
        return !!(z && performance && performance.mark) && performance.mark(e);
      },
      measure: function (e, t, r) {
        return !!(z && performance && performance.measure) && performance.measure(e, t, r);
      },
      clearMarks: function (e) {
        return !!(z && performance && performance.clearMarks) && performance.clearMarks(e);
      },
      clearMeasures: function (e) {
        return !!(z && performance && performance.clearMeasures) && performance.clearMeasures(e);
      }
    },
        E = function (e) {
      this._marks = {
      ...
      }, C.mark(this._marks.start);
    };

    function A(t, r) {
      var n = e.getArrayBuffer(t.request, function (t, n, o, i) {
        t ? r(t) : n && r(null, {
          vectorTile: new e.mvt.VectorTile(new e.Protobuf(n)),
          rawData: n,
          cacheControl: o,
          expires: i
        });
    ...
    E.prototype.finish = function () {
      ...
      var e = C.getEntriesByName(this._marks.measure);
      return 0 === e.length && (C.measure(this._marks.measure, this._marks.start, this._marks.end), e = C.getEntriesByName(this._marks.measure), C.clearMarks(this._marks.start), C.clearMarks(this._marks.end), C.clearMeasures(this._marks.measure)), e;
    }, C.Performance = E;

    var L = function (e, t, r) {
      this.actor = e, this.layerIndex = t, this.loadVectorData = r || A, this.loading = {}, this.loaded = {};
    };
    ...
    L.prototype.loadTile = function (t, r) {
      ...
      var i = !!(t && t.request && t.request.collectResourceTiming) && new C.Performance(t.request),
          a = this.loading[o] = new I(t);
      a.abort = this.loadVectorData(t, function (t, s) {
        if (delete n.loading[o], t || !s) return a.status = "done", n.loaded[o] = a, r(t);
        var l = s.rawData,
            u = {};
        ...
        }), n.loaded = n.loaded || {}, n.loaded[o] = a;
      });
      ...
      if (r && r[n]) {
        ...
        var a = function (e, r) {
          var n = i.reloadCallback;
          n && (delete i.reloadCallback, i.parse(i.vectorTile, o.layerIndex, o.actor, n)), t(e, r);
        };
    ...
    D.prototype.loadTile = function (t, r) {
      var n = t.uid,
          o = t.encoding,
          i = t.rawImageData,
          a = new e.DEMData(n, i, o);
    ...
    function N(e) {
      ...
      if (e && e.length > 0) {
        ...
        for (var r = 1; r < e.length; r++) t -= Math.abs(R(e[r]));
      }
    ...
    function R(e) {
      ...
      if (l > 2) {
        for (a = 0; a < l; a++) a === l - 2 ? (n = l - 2, o = l - 1, i = 0) : a === l - 1 ? (n = l - 1, o = 0, i = 1) : (n = a, o = a + 1, i = a + 2), t = e[n], r = e[o], s += (F(e[i][0]) - F(t[0])) * Math.sin(F(r[1]));

        s = s * O.RADIUS * O.RADIUS / 2;
      }
    ...
    var B = {
      geometry: function e(t) {
        ...
        switch (t.type) {
          ...
          case "MultiPolygon":
            for (r = 0; r < t.coordinates.length; r++) n += N(t.coordinates[r]);
      ...
      switch (t && t.type || null) {
        case "FeatureCollection":
          return t.features = t.features.map(j(e, r)), t;

        case "GeometryCollection":
          return t.geometries = t.geometries.map(j(e, r)), t;
        ...
        case "MultiPolygon":
          return function (e, t) {
            "Polygon" === e.type ? e.coordinates = G(e.coordinates, t) : "MultiPolygon" === e.type && (e.coordinates = e.coordinates.map(j(G, t)));
            return e;
          }(t, r);
    ...
    function G(e, t) {
      ...
      for (var r = 1; r < e.length; r++) e[r] = J(e[r], !t);
    ...
    var X = e.mvt.VectorTileFeature.prototype.toGeoJSON,
        V = function (t) {
    ...
    V.prototype.loadGeometry = function () {
      ...
      return i;
    }, V.prototype.toGeoJSON = function (e, t, r) {
    ...
    W.prototype.feature = function (e) {
      return new V(this._features[e]);
    };

    var Y = e.vectorTile.VectorTileFeature,
        q = U;
    ...
    U.prototype.feature = function (e) {
      ...
      for (var r = 0; r < t.length; r++) {
        for (var n = t[r], o = [], i = 0; i < n.length; i++) o.push(new e.Point$1(n[i][0], n[i][1]));
      ...
      for (var e = this.geometry, t = 1 / 0, r = -1 / 0, n = 1 / 0, o = -1 / 0, i = 0; i < e.length; i++) for (var a = e[i], s = 0; s < a.length; s++) {
        var l = a[s];
    ...
    var H = te,
      ...
      for (var n in e) r[n] = new q(e[n].features, t), r[n].name = n, r[n].version = t.version, r[n].extent = t.extent;
    ...
    function te(t) {
      var r = new e.pbf();
      return function (e, t) {
        for (var r in e.layers) t.writeMessage(3, re, e.layers[r]);
      }(t, r), r.finish();
    }
    ...
    function re(e, t) {
      ...
      for (r = 0; r < i.length; r++) t.writeMessage(4, le, i[r]);
    }

    function ne(e, t) {
      var r = e.feature;
      void 0 !== r.id && t.writeVarintField(1, r.id), t.writeMessage(2, oe, e), t.writeVarintField(3, r.type), t.writeMessage(4, se, r);
    }
    ...
    function oe(e, t) {
      ...
      for (var s in r.properties) {
        var l = i[s];
        void 0 === l && (n.push(s), l = n.length - 1, i[s] = l), t.writeVarint(l);
    ...
    function se(e, t) {
      for (var r = e.loadGeometry(), n = e.type, o = 0, i = 0, a = r.length, s = 0; s < a; s++) {
        var l = r[s],
            u = 1;
        1 === n && (u = l.length), t.writeVarint(ie(1, u));

        for (var h = 3 === n ? l.length - 1 : l.length, c = 0; c < h; c++) {
          1 === c && 1 !== n && t.writeVarint(ie(2, h - 1));
          var p = l[c].x - o,
              f = l[c].y - i;
          t.writeVarint(ae(p)), t.writeVarint(ae(f)), o += p, i += f;
        }

        3 === n && t.writeVarint(ie(7, 1));
      }
    }
          ...
          for (; i > o;) {
            if (i - o > 600) {
              var s = i - o + 1,
                  ...
                  p = Math.max(o, Math.floor(n - l * h / s + c)),
                  f = Math.min(i, Math.floor(n + (s - l) * h / s + c));
              e(t, r, n, p, f, a);
            }
            ...
            for (he(t, r, o, n), r[2 * i + a] > d && he(t, r, o, i); g < m;) {
              for (he(t, r, g, m), g++, m--; r[2 * g + a] < d;) g++;

              for (; r[2 * m + a] > d;) m--;
            }

            r[2 * o + a] === d ? he(t, r, o, m) : he(t, r, ++m, i), m <= n && (o = m + 1), n <= m && (i = m - 1);
          }
        }(e, t, a, n, o, i % 2), ue(e, t, r, n, a - 1, i + 1), ue(e, t, r, a + 1, o, i + 1);
      }
    }

    function he(e, t, r, n) {
      ce(e, r, n), ce(t, 2 * r, 2 * n), ce(t, 2 * r + 1, 2 * n + 1);
    }
    ...
    var fe = function (e) {
      ...
      void 0 === t && (t = fe), void 0 === r && (r = de), void 0 === n && (n = 64), void 0 === o && (o = Float64Array), this.nodeSize = n, this.points = e;

      for (var i = e.length < 65536 ? Uint16Array : Uint32Array, a = this.ids = new i(e.length), s = this.coords = new o(2 * e.length), l = 0; l < e.length; l++) a[l] = l, s[2 * l] = t(e[l]), s[2 * l + 1] = r(e[l]);

      ue(a, s, n, 0, a.length - 1, 0);
    };

    ge.prototype.range = function (e, t, r, n) {
      return function (e, t, r, n, o, i, a) {
        for (var s, l, u = [0, e.length - 1, 0], h = []; u.length;) {
          var c = u.pop(),
              p = u.pop(),
              f = u.pop();
          if (p - f <= a) for (var d = f; d <= p; d++) s = t[2 * d], l = t[2 * d + 1], s >= r && s <= o && l >= n && l <= i && h.push(e[d]);else {
            var g = Math.floor((f + p) / 2);
            s = t[2 * g], l = t[2 * g + 1], s >= r && s <= o && l >= n && l <= i && h.push(e[g]);
            var m = (c + 1) % 2;
            (0 === c ? r <= s : n <= l) && (u.push(f), u.push(g - 1), u.push(m)), (0 === c ? o >= s : i >= l) && (u.push(g + 1), u.push(p), u.push(m));
          }
        }

        return h;
      }(this.ids, this.coords, e, t, r, n, this.nodeSize);
    }, ge.prototype.within = function (e, t, r) {
      return function (e, t, r, n, o, i) {
        for (var a = [0, e.length - 1, 0], s = [], l = o * o; a.length;) {
          var u = a.pop(),
              h = a.pop(),
              c = a.pop();
          if (h - c <= i) for (var p = c; p <= h; p++) pe(t[2 * p], t[2 * p + 1], r, n) <= l && s.push(e[p]);else {
            var f = Math.floor((c + h) / 2),
                d = t[2 * f],
                g = t[2 * f + 1];
            pe(d, g, r, n) <= l && s.push(e[f]);
            var m = (u + 1) % 2;
            (0 === u ? r - o <= d : n - o <= g) && (a.push(c), a.push(f - 1), a.push(m)), (0 === u ? r + o >= d : n + o >= g) && (a.push(f + 1), a.push(h), a.push(m));
          }
        }
    ...
    var me = {
      ...
      map: function (e) {
        ...
        ve = function (e) {
      this.options = Pe(Object.create(me), e), this.trees = new Array(this.options.maxZoom + 1);
    };
    ...
    function ke(e, t, r, n) {
      ...
      return function (e) {
        var t = e.geometry,
            r = e.type;
        if ("Point" === r || "MultiPoint" === r || "LineString" === r) ze(e, t);else if ("Polygon" === r || "MultiLineString" === r) for (var n = 0; n < t.length; n++) ze(e, t[n]);else if ("MultiPolygon" === r) for (n = 0; n < t.length; n++) for (var o = 0; o < t[n].length; o++) ze(e, t[n][o]);
      }(o), o;
    }
    ...
    function Ce(e, t, r, n) {
      if (t.geometry) {
        var o = t.geometry.coordinates,
            ...
            s = [],
            l = t.id;
        if (r.promoteId ? l = t.properties[r.promoteId] : r.generateId && (l = n || 0), "Point" === i) Ee(o, s);else if ("MultiPoint" === i) for (var u = 0; u < o.length; u++) Ee(o[u], s);else if ("LineString" === i) Ae(o, s, a, !1);else if ("MultiLineString" === i) {
          if (r.lineMetrics) {
            for (u = 0; u < o.length; u++) s = [], Ae(o[u], s, a, !1), e.push(ke(l, "LineString", s, t.properties));

            return;
          }

          Le(o, s, a, !1);
        } else if ("Polygon" === i) Le(o, s, a, !0);else {
          if ("MultiPolygon" !== i) {
            if ("GeometryCollection" === i) {
              for (u = 0; u < t.geometry.geometries.length; u++) Ce(e, {
                id: l,
          ...
          for (u = 0; u < o.length; u++) {
            var h = [];
            Le(o[u], h, a, !0), s.push(h);
          }
        }
        e.push(ke(l, i, s, t.properties));
      }
    }

    function Ee(e, t) {
      t.push(De(e[0])), t.push(Oe(e[1])), t.push(0);
    }
    ...
    function Ae(e, t, r, n) {
      for (var o, i, a = 0, s = 0; s < e.length; s++) {
        var l = De(e[s][0]),
            u = Oe(e[s][1]);
        t.push(l), t.push(u), t.push(0), s > 0 && (a += n ? (o * u - l * i) / 2 : Math.sqrt(Math.pow(l - o, 2) + Math.pow(u - i, 2))), o = l, i = u;
      }

      var h = t.length - 3;
      t[2] = 1, function e(t, r, n, o) {
        for (var i, a = o, s = n - r >> 1, l = n - r, u = t[r], h = t[r + 1], c = t[n], p = t[n + 1], f = r + 3; f < n; f += 3) {
        ...
        a > o && (i - r > 3 && e(t, r, i, o), t[i + 2] = a, n - i > 3 && e(t, i, n, o));
    ...
    function Ne(e, t, r, n, o, i, a, s) {
      if (n /= t, i >= (r /= t) && a < n) return e;
      if (a < r || i >= n) return null;
      ...
      for (var l = [], u = 0; u < e.length; u++) {
        var h = e[u],
            ...
            f = 0 === o ? h.minX : h.minY,
            d = 0 === o ? h.maxX : h.maxY;
        if (f >= r && d < n) l.push(h);else if (!(d < r || f >= n)) {
          var g = [];
          if ("Point" === p || "MultiPoint" === p) Re(c, g, r, n, o);else if ("LineString" === p) Fe(c, g, r, n, o, !1, s.lineMetrics);else if ("MultiLineString" === p) Ze(c, g, r, n, o, !1);else if ("Polygon" === p) Ze(c, g, r, n, o, !0);else if ("MultiPolygon" === p) for (var m = 0; m < c.length; m++) {
            var v = [];
            Ze(c[m], v, r, n, o, !0), v.length && g.push(v);
          }

          if (g.length) {
            if (s.lineMetrics && "LineString" === p) {
              for (m = 0; m < g.length; m++) l.push(ke(h.id, p, g[m], h.tags));

              continue;
            }

            "LineString" !== p && "MultiLineString" !== p || (1 === g.length ? (p = "LineString", g = g[0]) : p = "MultiLineString"), "Point" !== p && "MultiPoint" !== p || (p = 3 === g.length ? "Point" : "MultiPoint"), l.push(ke(h.id, p, g, h.tags));
          }
        }
      }
    ...
    function Re(e, t, r, n, o) {
      for (var i = 0; i < e.length; i += 3) {
        var a = e[i + o];
        a >= r && a <= n && (t.push(e[i]), t.push(e[i + 1]), t.push(e[i + 2]));
      }
    }

    function Fe(e, t, r, n, o, i, a) {
      for (var s, l, u = Be(e), h = 0 === o ? Ge : Je, c = e.start, p = 0; p < e.length - 3; p += 3) {
        var f = e[p],
            d = e[p + 1],
            g = e[p + 2],
            m = e[p + 3],
            ...
            x = 0 === o ? m : v,
            w = !1;
        a && (s = Math.sqrt(Math.pow(f - m, 2) + Math.pow(d - v, 2))), y < r ? x > r && (l = h(u, f, d, m, v, r), a && (u.start = c + s * l)) : y > n ? x < n && (l = h(u, f, d, m, v, n), a && (u.start = c + s * l)) : je(u, f, d, g), x < r && y >= r && (l = h(u, f, d, m, v, r), w = !0), x > n && y <= n && (l = h(u, f, d, m, v, n), w = !0), !i && w && (a && (u.end = c + s * l), t.push(u), u = Be(e)), a && (c += s);
      }

      var M = e.length - 3;
      f = e[M], d = e[M + 1], g = e[M + 2], (y = 0 === o ? f : d) >= r && y <= n && je(u, f, d, g), M = u.length - 3, i && M >= 3 && (u[M] !== u[0] || u[M + 1] !== u[1]) && je(u, u[0], u[1], u[2]), u.length && t.push(u);
    }
    ...
    function Ze(e, t, r, n, o, i) {
      for (var a = 0; a < e.length; a++) Fe(e[a], t, r, n, o, i, !1);
    }
    ...
    function Ge(e, t, r, n, o, i) {
      var a = (i - t) / (n - t);
      return e.push(i), e.push(r + (o - r) * a), e.push(1), a;
    }

    function Je(e, t, r, n, o, i) {
      var a = (i - r) / (o - r);
      return e.push(t + (n - t) * a), e.push(i), e.push(1), a;
    }
    ...
    function Xe(e, t) {
      for (var r = [], n = 0; n < e.length; n++) {
        var o,
            i = e[n],
            a = i.type;
        if ("Point" === a || "MultiPoint" === a || "LineString" === a) o = Ve(i.geometry, t);else if ("MultiLineString" === a || "Polygon" === a) {
          o = [];

          for (var s = 0; s < i.geometry.length; s++) o.push(Ve(i.geometry[s], t));
        } else if ("MultiPolygon" === a) for (o = [], s = 0; s < i.geometry.length; s++) {
          for (var l = [], u = 0; u < i.geometry[s].length; u++) l.push(Ve(i.geometry[s][u], t));

          o.push(l);
        }
        r.push(ke(i.id, a, o, i.tags));
      }
    ...
    function We(e, t) {
      ...
      for (r = 0; r < e.features.length; r++) {
        var l = e.features[r],
            u = l.geometry,
            h = l.type;
        if (l.geometry = [], 1 === h) for (n = 0; n < u.length; n += 2) l.geometry.push(Ye(u[n], u[n + 1], t, i, a, s));else for (n = 0; n < u.length; n++) {
          var c = [];

          for (o = 0; o < u[n].length; o += 2) c.push(Ye(u[n][o], u[n][o + 1], t, i, a, s));
    ...
    function qe(e, t, r, n, o) {
      for (var i = t === o.maxZoom ? 0 : o.tolerance / ((1 << t) * o.extent), a = {
        features: [],
        numPoints: 0,
        numSimplified: 0,
        numFeatures: 0,
    ...
    function Ue(e, t, r, n) {
      var o = t.geometry,
          i = t.type,
          a = [];
      if ("Point" === i || "MultiPoint" === i) for (var s = 0; s < o.length; s += 3) a.push(o[s]), a.push(o[s + 1]), e.numPoints++, e.numSimplified++;else if ("LineString" === i) Ke(a, o, e, r, !1, !1);else if ("MultiLineString" === i || "Polygon" === i) for (s = 0; s < o.length; s++) Ke(a, o[s], e, r, "Polygon" === i, 0 === s);else if ("MultiPolygon" === i) for (var l = 0; l < o.length; l++) {
        var u = o[l];

        for (s = 0; s < u.length; s++) Ke(a, u[s], e, r, !0, 0 === s);
      }
    ...
    function Ke(e, t, r, n, o, i) {
      var a = n * n;
      if (n > 0 && t.size < (o ? a : n)) r.numPoints += t.length / 3;else {
        for (var s = [], l = 0; l < t.length; l += 3) (0 === n || t[l + 2] > a) && (r.numSimplified++, s.push(t[l]), s.push(t[l + 1])), r.numPoints++;

        o && function (e, t) {
          for (var r = 0, n = 0, o = e.length, i = o - 2; n < o; i = n, n += 2) r += (e[n] - e[i]) * (e[n + 1] + e[i + 1]);

          if (r > 0 === t) for (n = 0, o = e.length; n < o / 2; n += 2) {
            var a = e[n],
                s = e[n + 1];
            e[n] = e[o - 2 - n], e[n + 1] = e[o - 1 - n], e[o - 2 - n] = a, e[o - 1 - n] = s;
          }
        }(s, i), e.push(s);
      }
    }
    ...
    function He(e, t) {
      ...
      var n = function (e, t) {
        var r = [];
        if ("FeatureCollection" === e.type) for (var n = 0; n < e.features.length; n++) Ce(r, e.features[n], t, n);else "Feature" === e.type ? Ce(r, e, t) : Ce(r, {
          geometry: e
        }, t);
        return r;
      }(e, t);
      ...
      this.tiles = {}, this.tileCoords = [], r && (console.timeEnd("preprocess data"), console.log("index: maxZoom: %d, maxPoints: %d", t.indexMaxZoom, t.indexMaxPoints), console.time("generate tiles"), this.stats = {}, this.total = 0), (n = function (e, t) {
        var r = t.buffer / t.extent,
            n = e,
            o = Ne(e, 1, -1 - r, r, 0, -1, 2, t),
            i = Ne(e, 1, 1 - r, 2 + r, 0, -1, 2, t);
        return (o || i) && (n = Ne(e, 1, -r, 1 + r, 0, -1, 2, t) || [], o && (n = Xe(o, 1).concat(n)), i && (n = n.concat(Xe(i, -1)))), n;
    ...
    ve.prototype.load = function (e) {
      ...
      for (var s = [], l = 0; l < e.length; l++) e[l].geometry && s.push(xe(e[l], l));

      this.trees[o + 1] = new ge(s, be, Te, i, Float32Array), r && console.timeEnd(a);

      for (var u = o; u >= n; u--) {
        var h = +Date.now();
        s = this._cluster(s, u), this.trees[u] = new ge(s, be, Te, i, Float32Array), r && console.log("z%d: %d clusters in %dms", u, s.length, +Date.now() - h);
      }

      return r && console.timeEnd("total time"), this;
    }, ve.prototype.getClusters = function (e, t) {
      ...
      if (e[2] - e[0] >= 360) r = -180, o = 180;else if (r > o) {
        var a = this.getClusters([r, n, 180, i], t),
            s = this.getClusters([-180, n, o, i], t);
        return a.concat(s);
      }

      for (var l = this.trees[this._limitZoom(t)], u = [], h = 0, c = l.range(Se(r), _e(i), Se(o), _e(n)); h < c.length; h += 1) {
        var p = c[h],
            f = l.points[p];
        u.push(f.numPoints ? we(f) : this.points[f.index]);
      }

      return u;
    }, ve.prototype.getChildren = function (e) {
      var t = e >> 5,
          r = e % 32,
      ...
      for (var a = this.options.radius / (this.options.extent * Math.pow(2, r - 1)), s = [], l = 0, u = o.within(i.x, i.y, a); l < u.length; l += 1) {
        var h = u[l],
            c = o.points[h];
        c.parentId === e && s.push(c.numPoints ? we(c) : this.points[c.index]);
      }

      if (0 === s.length) throw new Error(n);
      return s;
    }, ve.prototype.getLeaves = function (e, t, r) {
      t = t || 10, r = r || 0;
      var n = [];
      ...
      return this._addTileFeatures(n.range((t - s) / o, l, (t + 1 + s) / o, u), n.points, t, r, o, h), 0 === t && this._addTileFeatures(n.range(1 - s / o, l, 1, u), n.points, o, r, o, h), t === o - 1 && this._addTileFeatures(n.range(0, l, s / o, u), n.points, -1, r, o, h), h.features.length ? h : null;
    }, ve.prototype.getClusterExpansionZoom = function (e) {
      ...
      return t;
    }, ve.prototype._appendLeaves = function (e, t, r, n, o) {
      for (var i = 0, a = this.getChildren(t); i < a.length; i += 1) {
        var s = a[i],
            l = s.properties;
        if (l && l.cluster ? o + l.point_count <= n ? o += l.point_count : o = this._appendLeaves(e, l.cluster_id, r, n, o) : o < n ? o++ : e.push(s), e.length === r) break;
      }

      return o;
    }, ve.prototype._addTileFeatures = function (e, t, r, n, o, i) {
      for (var a = 0, s = e; a < s.length; a += 1) {
        var l = t[s[a]],
            u = {
          type: 1,
          geometry: [[Math.round(this.options.extent * (l.x * o - r)), Math.round(this.options.extent * (l.y * o - n))]],
          tags: l.numPoints ? Me(l) : this.points[l.index].properties
        },
            h = l.numPoints ? l.id : this.points[l.index].id;
        void 0 !== h && (u.id = h), i.features.push(u);
      }
    }, ve.prototype._limitZoom = function (e) {
      return Math.max(this.options.minZoom, Math.min(e, this.options.maxZoom + 1));
    }, ve.prototype._cluster = function (e, t) {
      for (var r = [], n = this.options, o = n.radius, i = n.extent, a = n.reduce, s = o / (i * Math.pow(2, t)), l = 0; l < e.length; l++) {
        var u = e[l];
        ...
        if (!(u.zoom <= t)) {
          ...
          for (var h = this.trees[t + 1], c = h.within(u.x, u.y, s), p = u.numPoints || 1, f = u.x * p, d = u.y * p, g = a ? this._map(u, !0) : null, m = (l << 5) + (t + 1), v = 0, y = c; v < y.length; v += 1) {
            ...
            if (!(w.zoom <= t)) {
              w.zoom = t;
              var M = w.numPoints || 1;
              f += w.x * M, d += w.y * M, p += M, w.parentId = m, a && a(g, this._map(w));
            }
          }

          1 === p ? r.push(u) : (u.parentId = m, r.push(ye(f / p, d / p, m, p, g)));
        }
      }

      return r;
    }, ve.prototype._map = function (e, t) {
      if (e.numPoints) return t ? Pe({}, e.properties) : e.properties;
      var r = this.points[e.index].properties,
          n = this.options.map(r);
      return t && n === r ? Pe({}, n) : n;
    }, He.prototype.options = {
      maxZoom: 14,
      indexMaxZoom: 5,
      indexMaxPoints: 1e5,
      tolerance: 3,
      ...
      generateId: !1,
      debug: 0
    }, He.prototype.splitTile = function (e, t, r, n, o, i, a) {
      for (var s = [e, t, r, n], l = this.options, u = l.debug; s.length;) {
        ...
        if (!p && (u > 1 && console.time("creation"), p = this.tiles[c] = qe(e, t, r, n, l), this.tileCoords.push({
          z: t,
          x: r,
          y: n
        }), u)) {
          u > 1 && (console.log("tile z%d-%d-%d (features: %d, points: %d, simplified: %d)", t, r, n, p.numFeatures, p.numPoints, p.numSimplified), console.timeEnd("creation"));
          var f = "z" + t;
        ...
        if (p.source = e, o) {
          ...
          var d = 1 << o - t;
          if (r !== Math.floor(i / d) || n !== Math.floor(a / d)) continue;
        ...
        if (p.source = null, 0 !== e.length) {
          ...
          var g,
              ...
              x,
              w,
              M = .5 * l.buffer / l.extent,
              S = .5 - M,
              _ = .5 + M,
              P = 1 + M;

          g = m = v = y = null, x = Ne(e, h, r - M, r + _, 0, p.minX, p.maxX, l), w = Ne(e, h, r + S, r + P, 0, p.minX, p.maxX, l), e = null, x && (g = Ne(x, h, n - M, n + _, 1, p.minY, p.maxY, l), m = Ne(x, h, n + S, n + P, 1, p.minY, p.maxY, l), x = null), w && (v = Ne(w, h, n - M, n + _, 1, p.minY, p.maxY, l), y = Ne(w, h, n + S, n + P, 1, p.minY, p.maxY, l), w = null), u > 1 && console.timeEnd("clipping"), s.push(g || [], t + 1, 2 * r, 2 * n), s.push(m || [], t + 1, 2 * r, 2 * n + 1), s.push(v || [], t + 1, 2 * r + 1, 2 * n), s.push(y || [], t + 1, 2 * r + 1, 2 * n + 1);
        }
      }
    }, He.prototype.getTile = function (e, t, r) {
      var n = this.options,
          o = n.extent,
          i = n.debug;
      ...
      var a = 1 << e,
          s = Qe(e, t = (t % a + a) % a, r);
      if (this.tiles[s]) return We(this.tiles[s], o);
      ...
      return l && l.source ? (i > 1 && console.log("found parent tile z%d-%d-%d", u, h, c), i > 1 && console.time("drilling down"), this.splitTile(l.source, u, h, c, e, t, r), i > 1 && console.timeEnd("drilling down"), this.tiles[s] ? We(this.tiles[s], o) : null) : null;
    };

    var et = function (t) {
      function r(e, r, n) {
        t.call(this, e, r, $e), n && (this.loadGeoJSON = n);
      }
      ...
      return t && (r.__proto__ = t), r.prototype = Object.create(t && t.prototype), r.prototype.constructor = r, r.prototype.loadData = function (e, t) {
        ...
        if (this._pendingCallback && this._pendingLoadDataParams) {
          ...
          var o = !!(n && n.request && n.request.collectResourceTiming) && new C.Performance(n.request);
          this.loadGeoJSON(n, function (i, a) {
            if (i || !a) return r(i);
            if ("object" != typeof a) return r(new Error("Input data is not a valid GeoJSON object."));
            Z(a, !0);

            try {
              t._geoJSONIndex = n.cluster ? new ve(function (t) {
                var r = t.superclusterOptions,
                    n = t.clusterProperties;
                if (!n || !r) return r;
                ...
                for (var o = {}, i = {}, a = {
                  ...
                  properties: null
                }, l = Object.keys(n), u = 0, h = l; u < h.length; u += 1) {
                  var c = h[u],
                      p = n[c],
                      f = p[0],
                      d = p[1],
                  ...
                  o[c] = g.value, i[c] = m.value;
                }

                return r.map = function (e) {
                  s.properties = e;

                  for (var t = {}, r = 0, n = l; r < n.length; r += 1) {
                    var i = n[r];
                  ...
                  for (var r = 0, n = l; r < n.length; r += 1) {
                    var o = n[r];
                    a.accumulated = e[o], e[o] = i[o].evaluate(a, s);
                  }
                }, r;
              }(n)).load(a.features) : function (e, t) {
                return new He(e, t);
            ...
            if (o) {
              var l = o.finish();
              l && (s.resourceTiming = {}, s.resourceTiming[n.source] = JSON.parse(JSON.stringify(l)));
            }
        ...
        var n = this.loaded,
            o = e.uid;
        return n && n[o] ? t.prototype.reloadTile.call(this, e, r) : this.loadTile(e, r);
    ...
    return tt.prototype.setReferrer = function (e, t) {
      this.referrer = t;
    }, tt.prototype.setLayers = function (e, t, r) {
      this.getLayerIndex(e).replace(t), r();
    }, tt.prototype.updateLayers = function (e, t, r) {
      this.getLayerIndex(e).update(t.layers, t.removedIds), r();
    }, tt.prototype.loadTile = function (e, t, r) {
      this.getWorkerSource(e, t.type, t.source).loadTile(t, r);
    }, tt.prototype.loadDEMTile = function (e, t, r) {
      this.getDEMWorkerSource(e, t.source).loadTile(t, r);
    }, tt.prototype.reloadTile = function (e, t, r) {
      this.getWorkerSource(e, t.type, t.source).reloadTile(t, r);
    }, tt.prototype.abortTile = function (e, t, r) {
      this.getWorkerSource(e, t.type, t.source).abortTile(t, r);
    }, tt.prototype.removeTile = function (e, t, r) {
      this.getWorkerSource(e, t.type, t.source).removeTile(t, r);
    }, tt.prototype.removeDEMTile = function (e, t) {
      this.getDEMWorkerSource(e, t.source).removeTile(t);
    }, tt.prototype.removeSource = function (e, t, r) {
    ...
    }, tt.prototype.loadWorkerSource = function (e, t, r) {
      try {
        this.self.importScripts(t.url), r();
      } catch (e) {
        r(e.toString());
      }
    }, tt.prototype.loadRTLTextPlugin = function (t, r, n) {
      try {
    ...
    }, tt.prototype.getLayerIndex = function (e) {
      var t = this.layerIndexes[e];
      return t || (t = this.layerIndexes[e] = new n()), t;
    }, tt.prototype.getWorkerSource = function (e, t, r) {
      var n = this;

      if (this.workerSources[e] || (this.workerSources[e] = {}), this.workerSources[e][t] || (this.workerSources[e][t] = {}), !this.workerSources[e][t][r]) {
        var o = {
          send: function (t, r, o) {
            n.actor.send(t, r, o, e);
          }
        };
        this.workerSources[e][t][r] = new this.workerSourceTypes[t](o, this.getLayerIndex(e));
      }

      return this.workerSources[e][t][r];
    }, tt.prototype.getDEMWorkerSource = function (e, t) {
      return this.demWorkerSources[e] || (this.demWorkerSources[e] = {}), this.demWorkerSources[e][t] || (this.demWorkerSources[e][t] = new D()), this.demWorkerSources[e][t];
  ...
  define(["./shared.js"], function (t) {
    ...
    var h = function () {
      this.images = {}, this.loaded = !1, this.requestors = [], this.patterns = {}, this.atlasImage = new t.RGBAImage({
        width: 1,
        height: 1
      }), this.dirty = !0;
    };
    ...
    h.prototype.isLoaded = function () {
      return this.loaded;
    }, h.prototype.setLoaded = function (t) {
    ...
    }, h.prototype.addImage = function (t, e) {
      this.images[t] = e;
    }, h.prototype.removeImage = function (t) {
      delete this.images[t], delete this.patterns[t];
    }, h.prototype.listImages = function () {
      return Object.keys(this.images);
    }, h.prototype.getImages = function (t, e) {
      var i = !0;
      ...
      for (var i = {}, o = 0, r = t; o < r.length; o += 1) {
        var a = r[o],
            n = this.images[a];
        n && (i[a] = {
          data: n.data.clone(),
    ...
    }, h.prototype.getPattern = function (e) {
      var i = this.patterns[e];
      if (i) return i.position;
      var o = this.getImage(e);
      if (!o) return null;
      var r = {
        w: o.data.width + 2,
        h: o.data.height + 2,
    ...
    function f(t, e, i, o, r, a, n) {
      for (var s = 0; s < e; s++) {
        for (var l = 0; l < i; l++) o[l] = t[l * e + s];

        for (m(o, r, a, n, i), l = 0; l < i; l++) t[l * e + s] = r[l];
      }

      for (l = 0; l < i; l++) {
        for (s = 0; s < e; s++) o[s] = t[l * e + s];

        for (m(o, r, a, n, e), s = 0; s < e; s++) t[l * e + s] = Math.sqrt(r[s]);
      }
    }
    ...
    _.prototype.draw = function (t) {
      ...
      for (var e = this.ctx.getImageData(0, 0, this.size, this.size), i = new Uint8ClampedArray(this.size * this.size), o = 0; o < this.size * this.size; o++) {
        ...
        this.gridOuter[o] = 1 === r ? 0 : 0 === r ? d : Math.pow(Math.max(0, .5 - r), 2), this.gridInner[o] = 1 === r ? d : 0 === r ? 0 : Math.pow(Math.max(0, r - .5), 2);
      }
    ...
    g.prototype.setURL = function (t) {
      ...
      for (var a in e) for (var n = 0, s = e[a]; n < s.length; n += 1) {
        var l = s[n];
        r.push({
          stack: a,
          id: l
        ...
        if (void 0 === n) {
          if (n = o._tinySDF(a, i, r)) e(null, {
            ...
            if (256 * s > 65535) e(new Error("glyphs > 65535 not supported"));else {
              var l = a.requests[s];
              l || (l = a.requests[s] = [], g.loadGlyphRange(i, s, o.url, o.requestTransform, function (t, e) {
                if (e) for (var i in e) a.glyphs[+i] = e[+i];
    ...
    }, g.prototype._tinySDF = function (e, i, o) {
      ...
      if (r && (t.isChar["CJK Unified Ideographs"](o) || t.isChar["Hangul Syllables"](o))) {
        ...
        if (!a) {
          var n = "400";
          /bold/i.test(i) ? n = "900" : /medium/i.test(i) ? n = "500" : /light/i.test(i) && (n = "200"), a = e.tinySDF = new g.TinySDF(24, 3, 8, .25, r, n);
        }
    ...
    }, g.loadGlyphRange = function (e, i, o, r, a) {
      var n = 256 * i,
          s = n + 255,
          l = r(t.normalizeGlyphsURL(o).replace("{fontstack}", e).replace("{range}", n + "-" + s), t.ResourceType.Glyphs);
    ...
    v.prototype.possiblyEvaluate = function (e, i) {
      return t.sphericalToCartesian(e.expression.evaluate(i));
    }, v.prototype.interpolate = function (e, i, o) {
      return {
    ...
    var y = new t.Properties({
      ...
      intensity: new t.DataConstantProperty(t.styleSpec.light.intensity)
        ...
        x = function (e) {
      function i(i) {
        e.call(this), this._transitionable = new t.Transitionable(y), this.setLight(i), this._transitioning = this._transitionable.untransitioned();
      }
    ...
    b.prototype.getDash = function (t, e) {
      ...
      for (var s = this.width / a, l = s / 2, c = e.length % 2 == 1, u = -o; u <= o; u++) for (var h = this.nextRow + o + u, p = this.width * h, d = c ? -e[e.length - 1] : 0, _ = e[0], f = 1, m = 0; m < this.width; m++) {
    ...
    function E(e, i, o) {
      var r = function (i, r) {
        ...
        if (r) {
          var a = t.pick(r, ["tiles", "minzoom", "maxzoom", "attribution", "mapbox_logo", "bounds"]);
          r.vector_layers && (a.vectorLayers = r.vector_layers, a.vectorLayerIds = a.vectorLayers.map(function (t) {
            return t.id;
          })), e.url && (a.tiles = t.canonicalizeTileset(a, e.url)), o(null, a);
        }
      };

      return e.url ? t.getJSON(i(t.normalizeSourceURL(e.url), t.ResourceType.Source), r) : t.browser.frame(function () {
        return r(null, e);
      });
    }

    w.prototype.broadcast = function (e, i, o) {
      o = o || function () {}, t.asyncAll(this.actors, function (t, o) {
        t.send(e, i, o);
      }, o);
    }, w.prototype.send = function (t, e, i, o) {
    ...
    T.prototype.validateBounds = function (t) {
    ...
    var I = function (e) {
      ...
      return e && (i.__proto__ = e), i.prototype = Object.create(e && e.prototype), i.prototype.constructor = i, i.prototype.load = function () {
        ...
        this.fire(new t.Event("dataloading", {
          dataType: "source"
        })), this._tileJSONRequest = E(this._options, this.map._transformRequest, function (i, o) {
          e._tileJSONRequest = null, i ? e.fire(new t.ErrorEvent(i)) : o && (t.extend(e, o), o.bounds && (e.tileBounds = new T(o.bounds, e.minzoom, e.maxzoom)), t.postTurnstileEvent(o.tiles), t.postMapLoadEvent(o.tiles, e.map._getMapId()), e.fire(new t.Event("data", {
            dataType: "source",
        ...
        var o = t.normalizeTileURL(e.tileID.canonical.url(this.tiles, this.scheme), this.url),
            r = {
          request: this.map._transformRequest(o, t.ResourceType.Tile),
          uid: e.uid,
          tileID: e.tileID,
      ...
      return e && (i.__proto__ = e), i.prototype = Object.create(e && e.prototype), i.prototype.constructor = i, i.prototype.load = function () {
        ...
        var o = this,
            r = t.normalizeTileURL(e.tileID.canonical.url(this.tiles, this.scheme), this.url, this.tileSize);
        e.request = t.getImage(this.map._transformRequest(r, t.ResourceType.Tile), function (r, a) {
      ...
      return e && (i.__proto__ = e), i.prototype = Object.create(e && e.prototype), i.prototype.constructor = i, i.prototype.serialize = function () {
        ...
        var o = t.normalizeTileURL(e.tileID.canonical.url(this.tiles, this.scheme), this.url, this.tileSize);
      ...
      return e && (i.__proto__ = e), i.prototype = Object.create(e && e.prototype), i.prototype.constructor = i, i.prototype.load = function () {
        ...
        var i = this,
            ...
            r = this._data;
        "string" == typeof r ? (o.request = this.map._transformRequest(t.browser.resolveURL(r), t.ResourceType.Source), o.request.collectResourceTiming = this._collectResourceTiming) : o.data = JSON.stringify(r), this.workerID = this.dispatcher.send(this.type + ".loadData", o, function (t, r) {
      ...
      return e && (i.__proto__ = e), i.prototype = Object.create(e && e.prototype), i.prototype.constructor = i, i.prototype.load = function (e, i) {
        ...
        this.fire(new t.Event("dataloading", {
          dataType: "source"
        })), this.url = this.options.url, t.getImage(this.map._transformRequest(this.url, t.ResourceType.Image), function (r, a) {
      ...
      video: function (e) {
        ...
        return e && (i.__proto__ = e), i.prototype = Object.create(e && e.prototype), i.prototype.constructor = i, i.prototype.load = function () {
          ...
          for (var o = 0, r = i.urls; o < r.length; o += 1) {
            var a = r[o];
            this.urls.push(this.map._transformRequest(a, t.ResourceType.Source).url);
          }
    ...
    function M(t, e, i, o, r) {
      ...
      for (var l = [], c = 0, u = s; c < u.length; c += 1) {
        ...
        l.push({
          ...
          queryResults: h.tile.queryRenderedFeatures(e, t._state, h.queryGeometry, h.cameraQueryGeometry, h.scale, o, r, n, R(t.transform, h.tileID))
        });
      }
    ...
    }, k.prototype.getAndRemove = function (t) {
      return this.has(t) ? this._getAndRemoveByKey(t.wrapped().key) : null;
    }, k.prototype._getAndRemoveByKey = function (t) {
    ...
    }, k.prototype.setMaxSize = function (t) {
    ...
    }, B.prototype.updateData = function (t) {
    ...
    }, F.prototype.enableAttributes = function (t, e) {
      for (var i = 0; i < this.attributes.length; i++) {
        var o = this.attributes[i],
            r = e.attributes[o.name];
        void 0 !== r && t.enableVertexAttribArray(r);
      }
    }, F.prototype.setVertexAttribPointers = function (t, e, i) {
      for (var o = 0; o < this.attributes.length; o++) {
        var r = this.attributes[o],
            a = e.attributes[r.name];
        void 0 !== a && t.vertexAttribPointer(a, r.components, t[O[r.type]], !1, this.itemSize, r.offset + this.itemSize * (i || 0));
      }
    ...
    U.prototype.get = function () {
      return this.current;
    }, U.prototype.set = function (t) {}, U.prototype.getDefault = function () {
      return this.default;
    ...
    var N = function (e) {
      ...
      this.colorAttachment = new vt(t, r), this.depthAttachment = new yt(t, r);
    };
    ...
    }, It.prototype.createIndexBuffer = function (t, e) {
      return new B(this, t, e);
    }, It.prototype.createVertexBuffer = function (t, e, i) {
      return new F(this, t, e, i);
    }, It.prototype.createRenderbuffer = function (t, e, i) {
      var o = this.gl,
    ...
    }, It.prototype.createFramebuffer = function (t, e) {
      return new xt(this, t, e);
    }, It.prototype.clear = function (t) {
      var e = t.color,
          i = t.depth,
          o = this.gl,
          r = 0;
    ...
    }, It.prototype.setStencilMode = function (t) {
    ...
    }, It.prototype.setColorMode = function (e) {
      t.isEqual(e.blendFunction, Et.Replace) ? this.blend.set(!1) : (this.blend.set(!0), this.blendFunc.set(e.blendFunction), this.blendColor.set(e.blendColor)), this.colorMask.set(e.mask);
    ...
    var Ct = function (e) {
      function i(i, o, r) {
        ...
        e.call(this), this.id = i, this.dispatcher = r, this.on("data", function (t) {
          ...
          a._sourceErrored = !0;
        }), this._source = D(i, o, r, this), this._tiles = {}, this._cache = new k(0, this._unloadTile.bind(this)), this._timers = {}, this._cacheTimers = {}, this._maxTileCacheSize = null, this._coveredTiles = {}, this._state = new t.SourceFeatureState();
      }
    ...
    Pt.prototype.acquire = function (t) {
      if (!this.workers) for (this.workers = []; this.workers.length < Pt.workerCount;) this.workers.push(new Lt());
      return this.active[t] = !0, this.workers.slice();
    }, Pt.prototype.release = function (t) {
    ...
    function At(t) {
      ...
      for (var o = 0; o < t.length; o++) "ref" in t[o] && (t[o] = Mt(t[o], e[t[o].ref]));
    ...
    function Ut(e, i, o) {
      ...
      for (r in e[o]) if (e[o].hasOwnProperty(r) && "data" !== r && !t.isEqual(e[o][r], i[o][r])) return !1;

      for (r in i[o]) if (i[o].hasOwnProperty(r) && "data" !== r && !t.isEqual(e[o][r], i[o][r])) return !1;

      return !0;
    }

    function Nt(e, i, o, r, a, n) {
      var s;

      for (s in i = i || {}, e = e || {}) e.hasOwnProperty(s) && (t.isEqual(e[s], i[s]) || o.push({
        command: n,
        args: [r, s, i[s], a]
      }));

      for (s in i) i.hasOwnProperty(s) && !e.hasOwnProperty(s) && (t.isEqual(e[s], i[s]) || o.push({
        command: n,
        args: [r, s, i[s], a]
      }));
    }
    ...
    function Vt(e, i) {
      ...
      try {
        if (!t.isEqual(e.version, i.version)) return [{
          command: kt.setStyle,
          args: [i]
        }];
        t.isEqual(e.center, i.center) || o.push({
          command: kt.setCenter,
          args: [i.center]
        }), t.isEqual(e.zoom, i.zoom) || o.push({
          command: kt.setZoom,
          args: [i.zoom]
        }), t.isEqual(e.bearing, i.bearing) || o.push({
          command: kt.setBearing,
          args: [i.bearing]
        }), t.isEqual(e.pitch, i.pitch) || o.push({
          command: kt.setPitch,
          args: [i.pitch]
        }), t.isEqual(e.sprite, i.sprite) || o.push({
          command: kt.setSprite,
          args: [i.sprite]
        }), t.isEqual(e.glyphs, i.glyphs) || o.push({
          command: kt.setGlyphs,
          args: [i.glyphs]
        }), t.isEqual(e.transition, i.transition) || o.push({
          command: kt.setTransition,
          args: [i.transition]
        }), t.isEqual(e.light, i.light) || o.push({
          command: kt.setLight,
          args: [i.light]
        });
        var r = {},
        ...
        !function (e, i, o, r) {
          ...
          for (a in i = i || {}, e = e || {}) e.hasOwnProperty(a) && (i.hasOwnProperty(a) || Ot(a, o, r));

          for (a in i) i.hasOwnProperty(a) && (e.hasOwnProperty(a) ? t.isEqual(e[a], i[a]) || ("geojson" === e[a].type && "geojson" === i[a].type && Ut(e, i, a) ? o.push({
            command: kt.setGeoJSONSourceData,
            args: [a, i[a].data]
          }) : Ft(a, i, o, r)) : Bt(a, i, o));
        ...
        e.layers && e.layers.forEach(function (t) {
          ...
          for (r = 0; r < p.length; r++) if (s = d[n = p[r]], l = _[n], !m[n] && !t.isEqual(s, l)) if (t.isEqual(s.source, l.source) && t.isEqual(s["source-layer"], l["source-layer"]) && t.isEqual(s.type, l.type)) {
            for (u in Nt(s.layout, l.layout, o, n, null, kt.setLayoutProperty), Nt(s.paint, l.paint, o, n, null, kt.setPaintProperty), t.isEqual(s.filter, l.filter) || o.push({
              command: kt.setFilter,
              args: [n, l.filter]
            }), t.isEqual(s.minzoom, l.minzoom) && t.isEqual(s.maxzoom, l.maxzoom) || o.push({
              command: kt.setLayerZoomRange,
              args: [n, l.minzoom, l.maxzoom]
            }), s) s.hasOwnProperty(u) && "layout" !== u && "paint" !== u && "filter" !== u && "metadata" !== u && "minzoom" !== u && "maxzoom" !== u && (0 === u.indexOf("paint.") ? Nt(s[u], l[u], o, n, u.slice(6), kt.setPaintProperty) : t.isEqual(s[u], l[u]) || o.push({
              command: kt.setLayerProperty,
              args: [n, u, l[u]]
            }));

            for (u in l) l.hasOwnProperty(u) && !s.hasOwnProperty(u) && "layout" !== u && "paint" !== u && "filter" !== u && "metadata" !== u && "minzoom" !== u && "maxzoom" !== u && (0 === u.indexOf("paint.") ? Nt(s[u], l[u], o, n, u.slice(6), kt.setPaintProperty) : t.isEqual(s[u], l[u]) || o.push({
              command: kt.setLayerProperty,
              args: [n, u, l[u]]
            }));
          } else o.push({
    ...
    }, qt.prototype.insert = function (t, e, i, o, r) {
    ...
    }, qt.prototype.insertCircle = function (t, e, i, o) {
    ...
    }, qt.prototype._insertBoxCell = function (t, e, i, o, r, a) {
      this.boxCells[r].push(a);
    }, qt.prototype._insertCircleCell = function (t, e, i, o, r, a) {
      this.circleCells[r].push(a);
    }, qt.prototype._query = function (t, e, i, o, r, a) {
    ...
    }, qt.prototype._queryCircle = function (t, e, i, o, r) {
      var a = t - i,
          n = t + i,
          s = e - i,
          l = e + i;
    ...
    }, qt.prototype.query = function (t, e, i, o, r) {
      return this._query(t, e, i, o, !1, r);
    }, qt.prototype.hitTest = function (t, e, i, o, r) {
      return this._query(t, e, i, o, !0, r);
    }, qt.prototype.hitTestCircle = function (t, e, i, o) {
      return this._queryCircle(t, e, i, !0, o);
    }, qt.prototype._queryCell = function (t, e, i, o, r, a, n, s) {
      var l = n.seenUids,
          c = this.boxCells[r];
    ...
    }, qt.prototype._queryCellCircle = function (t, e, i, o, r, a, n, s) {
      var l = n.circle,
          c = n.seenUids,
          u = this.boxCells[r];
    ...
    }, qt.prototype._forEachCell = function (t, e, i, o, r, a, n, s) {
      for (var l = this._convertToXCellCoord(t), c = this._convertToYCellCoord(e), u = this._convertToXCellCoord(i), h = this._convertToYCellCoord(o), p = l; p <= u; p++) for (var d = c; d <= h; d++) {
    ...
    }, qt.prototype._circlesCollide = function (t, e, i, o, r, a) {
      var n = o - t,
          s = r - e,
          l = i + a;
      return l * l > n * n + s * s;
    }, qt.prototype._circleAndRectCollide = function (t, e, i, o, r, a, n) {
      var s = (a - o) / 2,
          l = Math.abs(t - (o + s));
      if (l > s + i) return !1;
      var c = (n - r) / 2,
    ...
    function Wt(e, i, o, r, a) {
      var n = t.identity(new Float32Array(16));
      return i ? (t.identity(n), t.scale(n, n, [1 / a, 1 / a, 1]), o || t.rotateZ(n, n, r.angle)) : (t.scale(n, n, [r.width / 2, -r.height / 2, 1]), t.translate(n, n, [1, -1, 0]), t.multiply(n, n, e)), n;
    }

    function Xt(e, i, o, r, a) {
      var n = t.identity(new Float32Array(16));
      return i ? (t.multiply(n, n, e), t.scale(n, n, [a, a, 1]), o || t.rotateZ(n, n, -r.angle)) : (t.scale(n, n, [1, -1, 1]), t.translate(n, n, [-1, -1, 0]), t.scale(n, n, [2 / r.width, 2 / r.height, 1])), n;
    }
    ...
    function Yt(e, i, o, r, a, n, s, l) {
      var c = r ? e.textSizeData : e.iconSizeData,
          u = t.evaluateSizeForZoom(c, o.transform.zoom, Gt.properties[r ? "text-size" : "icon-size"]),
      ...
      for (var d = e.lineVertexArray, _ = r ? e.text.placedSymbolArray : e.icon.placedSymbolArray, f = o.transform.width / o.transform.height, m = !1, g = 0; g < _.length; g++) {
        ...
        if (v.hidden || v.writingMode === t.WritingMode.vertical && !m) oe(v.numGlyphs, p);else {
          m = !1;
          var y = [v.anchorX, v.anchorY, 0, 1];

          if (t.transformMat4(y, y, i), Kt(y, h)) {
            var x = .5 + y[3] / o.transform.cameraToCenterDistance * .5,
                ...
                T = Ht(E, a).point,
                I = {},
                C = $t(v, w, !1, l, i, a, n, e.glyphOffsetArray, d, p, T, E, I, f);
            m = C.useVertical, (C.notEnoughRoom || m || C.needsFlipping && $t(v, w, !0, l, i, a, n, e.glyphOffsetArray, d, p, T, E, I, f).notEnoughRoom) && oe(v.numGlyphs, p);
          } else oe(v.numGlyphs, p);
        }
      }
    ...
    function Jt(t, e, i, o, r, a, n, s, l, c, u, h) {
      var p = s.glyphStartIndex + s.numGlyphs,
          d = s.lineStartIndex,
          _ = s.lineStartIndex + s.lineLength,
          f = e.getoffsetX(s.glyphStartIndex),
          m = e.getoffsetX(p - 1),
          g = ee(t * f, i, o, r, a, n, s.segment, d, _, l, c, u, h);

      if (!g) return null;
      var v = ee(t * m, i, o, r, a, n, s.segment, d, _, l, c, u, h);
      return v ? {
        first: g,
        last: v
      } : null;
    ...
    function $t(e, i, o, r, a, n, s, l, c, u, h, p, d, _) {
      var f,
          m = i / 24,
          g = e.lineOffsetX * i,
          v = e.lineOffsetY * i;
      ...
      if (e.numGlyphs > 1) {
        var y = e.glyphStartIndex + e.numGlyphs,
            ...
            w = Jt(m, l, g, v, o, h, p, e, c, n, d, !1);
        if (!w) return {
          notEnoughRoom: !0
        };
        var E = Ht(w.first.point, s).point,
            T = Ht(w.last.point, s).point;

        if (r && !o) {
          var I = Qt(e.writingMode, E, T, _);
          if (I) return I;
        }

        f = [w.first];

        for (var C = e.glyphStartIndex + 1; C < y - 1; C++) f.push(ee(m * l.getoffsetX(C), g, v, o, h, p, e.segment, x, b, c, n, d, !1));
        ...
        if (r && !o) {
          var S = Ht(p, a).point,
              ...
              L = new t.Point(c.getx(z), c.gety(z)),
              P = Ht(L, a),
              D = P.signedDistanceFromCamera > 0 ? P.point : te(p, L, S, 1, a),
              R = Qt(e.writingMode, S, D, _);
          if (R) return R;
        }

        var M = ee(m * l.getoffsetX(e.glyphStartIndex), g, v, o, h, p, e.segment, e.lineStartIndex, e.lineStartIndex + e.lineLength, c, n, d, !1);
        if (!M) return {
          notEnoughRoom: !0
        };
        f = [M];
    ...
    function te(t, e, i, o, r) {
      var a = Ht(t.add(t.sub(e)._unit()), r).point,
          n = i.sub(a);
      return i.add(n._mult(o / n.mag()));
    }

    function ee(e, i, o, r, a, n, s, l, c, u, h, p, d) {
      var _ = r ? e - i : e + i,
          f = _ > 0 ? 1 : -1,
          m = 0;
      ...
      for (var g = f > 0 ? l + s : l + s + 1, v = g, y = a, x = a, b = 0, w = 0, E = Math.abs(_); b + w <= E;) {
        ...
        if (x = y, void 0 === (y = p[g])) {
          ...
          if (I.signedDistanceFromCamera > 0) y = p[g] = I.point;else {
            var C = g - f;
            y = te(0 === b ? n : new t.Point(u.getx(C), u.gety(C)), T, x, E - b + 1, h);
          }
        }
      ...
      return L._add(z._unit()._perp()._mult(o * f)), {
        point: L,
    ...
    function oe(t, e) {
      for (var i = 0; i < t; i++) {
        var o = e.length;
        e.resize(o + 4), e.float32.set(ie, 3 * o);
      }
    }
    ...
    var ae = function (t, e, i) {
      void 0 === e && (e = new qt(t.width + 200, t.height + 200, 25)), void 0 === i && (i = new qt(t.width + 200, t.height + 200, 25)), this.transform = t, this.grid = e, this.ignoredGrid = i, this.pitchfactor = Math.cos(t._pitch) * t.cameraToCenterDistance, this.screenRightBoundary = t.width + 100, this.screenBottomBoundary = t.height + 100, this.gridRightBoundary = t.width + 200, this.gridBottomBoundary = t.height + 200;
    };
    ...
    ae.prototype.placeCollisionBox = function (t, e, i, o, r) {
    ...
    }, ae.prototype.approximateTileDistance = function (t, e, i, o, r) {
      var a = r ? 1 : o / this.pitchfactor,
          n = t.lastSegmentViewportDistance * i;
      return t.prevTileDistance + n + (a - 1) * n * Math.abs(Math.sin(e));
    }, ae.prototype.placeCollisionCircles = function (e, i, o, r, a, n, s, l, c, u, h, p, d) {
      var _ = [],
          ...
          x = Jt(m, s, g, v, !1, Ht(y, u).point, y, a, n, u, {}, !0),
          b = !1,
          w = !1,
          E = !0,
      ...
      for (var z = 0; z < e.length; z += 5) {
        var L = e[z],
            ...
            D = e[z + 2],
            R = e[z + 3];
        if (!x || R < -C || R > S) ne(e, z, !1);else {
          var M = this.projectPoint(c, L, P),
              A = D * T;

          if (_.length > 0) {
            var k = M.x - _[_.length - 4],
                B = M.y - _[_.length - 3];
          ...
          var F = z / 5;
          _.push(M.x, M.y, A, F), ne(e, z, !0);
          var U = M.x - A,
              N = M.y - A,
              Z = M.x + A,
              j = M.y + A;

          if (E = E && this.isOffscreen(U, N, Z, j), w = w || this.isInsideGrid(U, N, Z, j), !i && this.grid.hitTestCircle(M.x, M.y, A, d)) {
            if (!h) return {
              circles: [],
              offscreen: !1
            };
    ...
    }, ae.prototype.queryRenderedSymbols = function (e) {
      ...
      return p;
    }, ae.prototype.insertCollisionBox = function (t, e, i, o, r) {
      var a = {
        bucketInstanceId: i,
        featureIndex: o,
        collisionGroupID: r
    ...
    }, ae.prototype.insertCollisionCircles = function (t, e, i, o, r) {
      for (var a = e ? this.ignoredGrid : this.grid, n = {
        bucketInstanceId: i,
        featureIndex: o,
        collisionGroupID: r
      }, s = 0; s < t.length; s += 4) a.insertCircle(n, t[s], t[s + 1], t[s + 2]);
    }, ae.prototype.projectAnchor = function (t, e, i) {
      var o = [e, i, 0, 1];
      return re(o, o, t), {
        perspectiveRatio: .5 + this.transform.cameraToCenterDistance / o[3] * .5,
        cameraDistance: o[3]
      };
    }, ae.prototype.projectPoint = function (e, i, o) {
      var r = [i, o, 0, 1];
      return re(r, r, e), new t.Point((r[0] / r[3] + 1) / 2 * this.transform.width + 100, (-r[1] / r[3] + 1) / 2 * this.transform.height + 100);
    }, ae.prototype.projectAndGetPerspectiveRatio = function (e, i, o) {
      var r = [i, o, 0, 1];
      return re(r, r, e), {
    ...
    }, ae.prototype.isOffscreen = function (t, e, i, o) {
      return i < 100 || t >= this.screenRightBoundary || o < 100 || e > this.screenBottomBoundary;
    }, ae.prototype.isInsideGrid = function (t, e, i, o) {
    ...
    var ce = function (t, e, i, o, r) {
      this.text = new le(t ? t.text : null, e, i, r), this.icon = new le(t ? t.icon : null, e, o, r);
    };
    ...
    var de = function (t, e, i) {
      this.transform = t.clone(), this.collisionIndex = new ae(this.transform), this.placements = {}, this.opacities = {}, this.stale = !1, this.commitTime = 0, this.fadeDuration = e, this.retainedQueryData = {}, this.collisionGroups = new pe(i);
    };
    ...
    de.prototype.placeLayerTile = function (e, i, o, r) {
      var a = i.getBucket(e),
      ...
      if (a && n && e.id === a.layerIds[0]) {
        var s = i.collisionBoxArray,
            ...
            p = Wt(h, "map" === l.get("text-pitch-alignment"), "map" === l.get("text-rotation-alignment"), this.transform, se(i, 1, this.transform.zoom)),
            d = Wt(h, "map" === l.get("icon-pitch-alignment"), "map" === l.get("icon-rotation-alignment"), this.transform, se(i, 1, this.transform.zoom));
        this.retainedQueryData[a.bucketInstanceId] = new he(a.bucketInstanceId, n, a.sourceLayerIndex, a.index, i.tileID), this.placeLayerBucket(a, h, p, d, c, u, o, i.holdingForFade(), r, s);
      }
    }, de.prototype.placeLayerBucket = function (e, i, o, r, a, n, s, l, c, u) {
      ...
      for (var x = 0; x < e.symbolInstances.length; x++) {
        ...
        if (!c[b.crossTileID]) {
          if (l) {
            this.placements[b.crossTileID] = new ue(!1, !1, !1);
            continue;
          }
          ...
          var w = !1,
              ...
              z = 0,
              L = 0,
              P = e.collisionArrays[x];
          P.textFeatureIndex && (z = P.textFeatureIndex), P.textBox && (w = (I = this.collisionIndex.placeCollisionBox(P.textBox, h.get("text-allow-overlap"), n, i, y.predicate)).box.length > 0, T = T && I.offscreen);
          var D = P.textCircles;

          if (D) {
            var R = e.text.placedSymbolArray.get(b.horizontalPlacedTextSymbolIndex),
                M = t.evaluateSizeForFeature(e.textSizeData, p, R);
            C = this.collisionIndex.placeCollisionCircles(D, h.get("text-allow-overlap"), a, n, R, e.lineVertexArray, e.glyphOffsetArray, M, i, o, s, "map" === h.get("text-pitch-alignment"), y.predicate), w = h.get("text-allow-overlap") || C.circles.length > 0, T = T && C.offscreen;
          }

          P.iconFeatureIndex && (L = P.iconFeatureIndex), P.iconBox && (E = (S = this.collisionIndex.placeCollisionBox(P.iconBox, h.get("icon-allow-overlap"), n, i, y.predicate)).box.length > 0, T = T && S.offscreen);
          var A = d || 0 === b.numGlyphVertices && 0 === b.numVerticalGlyphVertices,
              k = _ || 0 === b.numIconVertices;
          A || k ? k ? A || (E = E && w) : w = E && w : E = w = E && w, w && I && this.collisionIndex.insertCollisionBox(I.box, h.get("text-ignore-placement"), e.bucketInstanceId, z, y.ID), E && S && this.collisionIndex.insertCollisionBox(S.box, h.get("icon-ignore-placement"), e.bucketInstanceId, L, y.ID), w && C && this.collisionIndex.insertCollisionCircles(C.circles, h.get("text-ignore-placement"), e.bucketInstanceId, z, y.ID), this.placements[b.crossTileID] = new ue(w || g, E || v, T || e.justReloaded), c[b.crossTileID] = !0;
        }
      }

      e.justReloaded = !1;
    }, de.prototype.commit = function (t, e) {
      this.commitTime = e;
      var i = !1,
          o = t && 0 !== this.fadeDuration ? (this.commitTime - t.commitTime) / this.fadeDuration : 1,
          r = t ? t.opacities : {};

      for (var a in this.placements) {
        var n = this.placements[a],
            s = r[a];
        s ? (this.opacities[a] = new ce(s, o, n.text, n.icon), i = i || n.text !== s.text.placed || n.icon !== s.icon.placed) : (this.opacities[a] = new ce(null, o, n.text, n.icon, n.skipFade), i = i || n.text || n.icon);
      }
      ...
      for (var l in r) {
        ...
        if (!this.opacities[l]) {
          var u = new ce(c, o, !1, !1);
          u.isHidden() || (this.opacities[l] = u, i = i || c.text.placed || c.icon.placed);
        }
      }
    ...
    }, de.prototype.updateLayerOpacities = function (t, e) {
    ...
    }, de.prototype.updateBucketOpacities = function (t, e, i) {
      ...
      var o = t.layers[0].layout,
          r = new ce(null, 0, !1, !1, !0),
          a = o.get("text-allow-overlap"),
          n = o.get("icon-allow-overlap"),
          s = new ce(null, 0, a && (n || !t.hasIconData() || o.get("icon-optional")), n && (a || !t.hasTextData() || o.get("text-optional")), !0);
      ...
      for (var l = 0; l < t.symbolInstances.length; l++) {
        var c = t.symbolInstances.get(l),
            u = e[c.crossTileID],
            h = this.opacities[c.crossTileID];
        u ? h = r : h || (h = s, this.opacities[c.crossTileID] = h), e[c.crossTileID] = !0;
        var p = c.numGlyphVertices > 0 || c.numVerticalGlyphVertices > 0,
            d = c.numIconVertices > 0;

        if (p) {
          for (var _ = we(h.text), f = (c.numGlyphVertices + c.numVerticalGlyphVertices) / 4, m = 0; m < f; m++) t.text.opacityVertexArray.emplaceBack(_);

          t.text.placedSymbolArray.get(c.horizontalPlacedTextSymbolIndex).hidden = h.text.isHidden(), c.verticalPlacedTextSymbolIndex >= 0 && (t.text.placedSymbolArray.get(c.verticalPlacedTextSymbolIndex).hidden = h.text.isHidden());
        }

        if (d) {
          for (var g = we(h.icon), v = 0; v < c.numIconVertices / 4; v++) t.icon.opacityVertexArray.emplaceBack(g);

          t.icon.placedSymbolArray.get(l).hidden = h.icon.isHidden();
        }

        if (t.hasCollisionBoxData() || t.hasCollisionCircleData()) {
          var y = t.collisionArrays[l];

          if (y) {
            y.textBox && _e(t.collisionBox.collisionVertexArray, h.text.placed, !1), y.iconBox && _e(t.collisionBox.collisionVertexArray, h.icon.placed, !1);
            var x = y.textCircles;
            if (x && t.hasCollisionCircleData()) for (var b = 0; b < x.length; b += 5) {
              var w = u || 0 === x[b + 4];

              _e(t.collisionCircle.collisionVertexArray, h.text.placed, w);
            }
          }
        }
      }
    ...
    function we(t) {
      ...
      return i * fe + e * me + i * ge + e * ve + i * ye + e * xe + i * be + e;
    }
    ...
    Ee.prototype.continuePlacement = function (t, e, i, o, r) {
    ...
    var Te = function (t, e, i, o, r, a) {
      this.placement = new de(t, r, a), this._currentPlacementIndex = e.length - 1, this._forceFullPlacement = i, this._showCollisionBoxes = o, this._done = !1;
    };

    Te.prototype.isDone = function () {
      return this._done;
    }, Te.prototype.continuePlacement = function (e, i, o) {
      for (var r = this, a = t.browser.now(), n = function () {
        ...
        if ("symbol" === s.type && (!s.minzoom || s.minzoom <= l) && (!s.maxzoom || s.maxzoom > l)) {
          if (this._inProgressLayer || (this._inProgressLayer = new Ee()), this._inProgressLayer.continuePlacement(o[s.source], this.placement, this._showCollisionBoxes, s, n)) return;
    ...
    Ce.prototype.getScaledCoordinates = function (e, i) {
    ...
    }, Ce.prototype.findMatches = function (t, e, i) {
    ...
    ze.prototype.handleWrapJump = function (t) {
      ...
      this.lng = t;
    }, ze.prototype.addBucket = function (t, e, i) {
      ...
      return void 0 === this.indexes[t.overscaledZ] && (this.indexes[t.overscaledZ] = {}), this.indexes[t.overscaledZ][t.key] = new Ce(t, e.symbolInstances, e.bucketInstanceId), !0;
    }, ze.prototype.removeBucketCrossTileIDs = function (t, e) {
      for (var i in e.indexedSymbolInstances) for (var o = 0, r = e.indexedSymbolInstances[i]; o < r.length; o += 1) {
        var a = r[o];
    ...
    Le.prototype.addLayer = function (t, e, i) {
      var o = this.layerIndexes[t.id];
      void 0 === o && (o = this.layerIndexes[t.id] = new ze());
      var r = !1,
          a = {};
      o.handleWrapJump(i);
    ...
    }, Le.prototype.pruneUnusedLayers = function (t) {
      var e = {};
    ...
    var Pe = function (e, i) {
      return t.emitValidationErrors(e, i && i.filter(function (t) {
        ...
        De = t.pick(kt, ["addLayer", "removeLayer", "setPaintProperty", "setLayoutProperty", "setFilter", "addSource", "removeSource", "setLayerZoomRange", "setLight", "setTransition", "setGeoJSONSourceData"]),
        Re = t.pick(kt, ["setCenter", "setZoom", "setBearing", "setPitch"]),
        Me = function (e) {
      function i(o, r) {
        var a = this;
        void 0 === r && (r = {}), e.call(this), this.map = o, this.dispatcher = new w((Dt || (Dt = new Pt()), Dt), this), this.imageManager = new h(), this.glyphManager = new g(o._transformRequest, r.localIdeographFontFamily), this.lineAtlas = new b(256, 512), this.crossTileSymbolIndex = new Le(), this._layers = {}, this._order = [], this.sourceCaches = {}, this.zoomHistory = new t.ZoomHistory(), this._loaded = !1, this._resetUpdates(), this.dispatcher.broadcast("setReferrer", t.getReferrer());
        var n = this;
      ...
      return e && (i.__proto__ = e), i.prototype = Object.create(e && e.prototype), i.prototype.constructor = i, i.prototype.loadURL = function (e, i) {
        ...
        var a = this.map._transformRequest(e, t.ResourceType.Style);
        ...
        if (!i || !Pe(this, t.validateStyle(e))) {
          ...
          e.sprite ? this._spriteRequest = function (e, i, o) {
            var r,
                ...
                l = t.getJSON(i(t.normalizeSpriteURL(e, s, ".json"), t.ResourceType.SpriteJSON), function (t, e) {
              l = null, n || (n = t, r = e, u());
            }),
                c = t.getImage(i(t.normalizeSpriteURL(e, s, ".png"), t.ResourceType.SpriteImage), function (t, e) {
              c = null, n || (n = t, a = e, u());
            });
            ...
            if (o._spriteRequest = null, e) o.fire(new t.ErrorEvent(e));else if (i) for (var r in i) o.imageManager.addImage(r, i[r]);
            o.imageManager.setLoaded(!0), o.fire(new t.Event("data", {
              dataType: "style"
            }));
          }) : this.imageManager.setLoaded(!0), this.glyphManager.setURL(e.glyphs);
          var a = At(this.stylesheet.layers);
          ...
          this.dispatcher.broadcast("setLayers", this._serializeLayers(this._order)), this.light = new x(this.stylesheet.light), this.fire(new t.Event("data", {
            dataType: "style"
        ...
        var i = this;
        if (this._checkLoaded(), Pe(this, t.validateStyle(e))) return !1;
        (e = t.clone(e)).layers = At(e.layers);
        var o = Vt(this.serialize(), e).filter(function (t) {
          return !(t.command in Re);
        });
        if (0 === o.length) return !1;
        var r = o.filter(function (t) {
          return !(t.command in De);
        });
        ...
        if (!(["vector", "raster", "geojson", "video", "image"].indexOf(i.type) >= 0) || !this._validate(t.validateStyle.source, "sources." + e, i, null, o)) {
          ...
          var a = this.sourceCaches[e] = new Ct(e, i, this.dispatcher);
        ...
        if (this.getLayer(r)) this.fire(new t.ErrorEvent(new Error('Layer with id "' + r + '" already exists on this map')));else {
          ...
          if ("custom" === e.type) {
            if (Pe(this, t.validateCustomStyleLayer(e))) return;
            a = t.createStyleLayer(e);
          } else {
            if ("object" == typeof e.source && (this.addSource(r, e.source), e = t.clone(e), e = t.extend(e, {
              source: r
        ...
        if (r) {
          if (!t.isEqual(r.filter, i)) return null == i ? (r.filter = void 0, void this._updateLayer(r)) : void (this._validate(t.validateStyle.filter, "layers." + r.id + ".filter", i, null, o) || (r.filter = t.clone(i), this._updateLayer(r)));
        ...
        a ? t.isEqual(a.getLayoutProperty(i), o) || (a.setLayoutProperty(i, o, r), this._updateLayer(a)) : this.fire(new t.ErrorEvent(new Error("The layer '" + e + "' does not exist in the map's style and cannot be styled.")));
        ...
        void 0 === r && (r = {}), this._checkLoaded();
        var a = this.getLayer(e);
        a ? t.isEqual(a.getPaintProperty(i), o) || (a.setPaintProperty(i, o, r) && this._updateLayer(a), this._changed = !0, this._updatedPaintProps[e] = !0) : this.fire(new t.ErrorEvent(new Error("The layer '" + e + "' does not exist in the map's style and cannot be styled.")));
        ...
        for (var e = [], i = [], o = this._order.length - 1; o >= 0; o--) for (var r = this._order[o], a = 0, n = t; a < n.length; a += 1) {
          var s = n[a][r];
          if (s) if ("fill-extrusion" === this._layers[r].type) for (var l = 0, c = s; l < c.length; l += 1) {
            var u = c[l];
            i.push(u);
          } else for (var h = 0, p = s; h < p.length; h += 1) {
            var d = p[h];
            e.push(d.feature);
          }
        }
        ...
        for (var u in this.sourceCaches) i.layers && !r[u] || c.push(M(this.sourceCaches[u], this._layers, e, i, o));
        ...
        for (var a in e) if (!t.isEqual(e[a], o[a])) {
          r = !0;
          break;
        }
        ...
        return void 0 === a && (a = {}), (!a || !1 !== a.validate) && Pe(this, e.call(t.validateStyle, t.extend({
          key: i,
    ...
    Me.getSourceType = function (t) {
      return P[t];
    }, Me.setSourceType = function (t, e) {
      P[t] = e;
    ...
    var li = Object.freeze({
      ...
      fill: Ge,
      fillOutline: We,
      fillOutlinePattern: Xe,
      fillPattern: He,
      fillExtrusion: Ke,
      fillExtrusionPattern: Ye,
      extrusionTexture: Je,
      hillshadePrepare: Qe,
      hillshade: $e,
      line: ti,
    ...
    ci.prototype.bind = function (t, e, i, o, r, a, n, s) {
      this.context = t;
    ...
    }, ci.prototype.freshBind = function (t, e, i, o, r, a, n) {
      var s,
          l = t.numAttributes,
          c = this.context,
          u = c.gl;
    ...
    var ui = function (e, i, o, r, a) {
      ...
      var l = s.concat(ke.fragmentSource, i.fragmentSource).join("\n"),
      ...
      for (var p = o.layoutAttributes || [], d = 0; d < p.length; d++) n.bindAttribLocation(this.program, d, p[d].name);
    ...
    function hi(e, i, o) {
      var r = 1 / se(o, 1, i.transform.tileZoom),
    ...
    ui.prototype.draw = function (t, e, i, o, r, a, n, s, l, c, u, h, p, d, _, f) {
      var m,
          g = t.gl;
      ...
      for (var y = (m = {}, m[g.LINES] = 2, m[g.TRIANGLES] = 3, m[g.LINE_STRIP] = 1, m)[e], x = 0, b = u.get(); x < b.length; x += 1) {
        var w = b[x],
            E = w.vaos || (w.vaos = {});
        (E[s] || (E[s] = new ci())).bind(t, this, l, d ? d.getPaintVertexBuffers() : [], c, w.vertexOffset, _, f), g.drawElements(e, w.primitiveLength * y, g.UNSIGNED_SHORT, w.primitiveOffset * y * 2);
      }
    };

    var pi = function (e, i, o) {
      var r = i.style.light,
          a = r.properties.get("position"),
          n = [a.x, a.y, a.z],
          s = t.create();
      "viewport" === r.properties.get("anchor") && t.fromRotation(s, -i.transform.angle), t.transformMat3(n, n, s);
      var l = r.properties.get("color");
      return {
        u_matrix: e,
        u_lightpos: n,
        ...
        di = function (e, i, o, r, a, n) {
      return t.extend(pi(e, i, o), hi(a, i, n), {
      ...
      return {
        ...
        vi = function (e, i, o, r, a) {
      return t.extend(mi(e, i, o, r), {
        u_world: a
      });
    },
        yi = function (t, e, i, o) {
    ...
    var ki = function (t, e, i, o, r) {
      return {
        ...
        u_spin_weights: Bi(r.paint.get("raster-hue-rotate"))
      };
      var a, n;
    };
    ...
    var Oi = function (t, e, i, o, r, a, n, s, l, c) {
      var u = r.transform;
      return {
        ...
        Fi = function (e, i, o, r, a, n, s, l, c, u, h) {
      var p = a.transform;
      return t.extend(Oi(e, i, o, r, a, n, s, l, c, u), {
      ...
      return t.extend(function (t, e, i, o) {
        ...
        return {
          ...
          u_scale_b: e.toScale,
          u_tile_units_to_pixels: 1 / se(o, 1, i.transform.tileZoom),
    ...
    function qi(t, e, i, o, r) {
      for (var a = t.context, n = a.gl, s = r ? t.useProgram("collisionCircle") : t.useProgram("collisionBox"), l = 0; l < o.length; l++) {
        ...
        if (h) {
          ...
          p && s.draw(a, r ? n.TRIANGLES : n.LINES, bt.disabled, wt.disabled, t.colorModeForRenderPass(), Tt.disabled, bi(c.posMatrix, t.transform, u), i.id, p.layoutVertexBuffer, p.indexBuffer, p.segments, null, t.transform.zoom, null, null, p.collisionVertexBuffer);
        }
      }
    }

    var Gi = t.identity(new Float32Array(16)),
        Wi = t.properties.layout;

    function Xi(e, i, o, r, a, n, s, l, c, u, h, p) {
      for (var d, _, f = e.context, m = f.gl, g = e.transform, v = "map" === l, y = "map" === c, x = v && "point" !== o.layout.get("symbol-placement"), b = v && !y && !x, w = void 0 !== o.layout.get("symbol-sort-key").constantOr(1), E = e.depthModeForSublayer(0, bt.ReadOnly), T = [], I = 0, C = r; I < C.length; I += 1) {
        var S = C[I],
            z = i.getTile(S),
            L = z.getBucket(o);

        if (L) {
          var P = a ? L.text : L.icon;

          if (P && P.segments.get().length) {
            var D = P.programConfigurations.get(o.id),
                R = a || L.sdfIcons,
                M = a ? L.textSizeData : L.iconSizeData;
            d || (d = e.useProgram(R ? "symbolSDF" : "symbolIcon", D), _ = t.evaluateSizeForZoom(M, g.zoom, Wi.properties[a ? "text-size" : "icon-size"])), f.activeTexture.set(m.TEXTURE0);
            var A = void 0,
                k = void 0,
                B = void 0;
            if (a) k = z.glyphAtlasTexture, B = m.LINEAR, A = z.glyphAtlasTexture.size;else {
              var O = 1 !== o.layout.get("icon-size").constantOr(0) || L.iconsNeedLinear,
                  F = y || 0 !== g.pitch;
              k = z.imageAtlasTexture, B = R || e.options.rotating || e.options.zooming || O || F ? m.LINEAR : m.NEAREST, A = z.imageAtlasTexture.size;
            }
            var U = se(z, 1, e.transform.zoom),
                N = Wt(S.posMatrix, y, v, e.transform, U),
                Z = Xt(S.posMatrix, y, v, e.transform, U);
            x && Yt(L, S.posMatrix, e, a, N, Z, y, u);
            var j = e.translatePosMatrix(S.posMatrix, z, n, s),
                V = x ? Gi : N,
                q = e.translatePosMatrix(Z, z, n, s, !0),
                G = R && 0 !== o.paint.get(a ? "text-halo-width" : "icon-halo-width").constantOr(1),
                W = {
              program: d,
              buffers: P,
              uniformValues: R ? Fi(M.functionType, _, b, y, e, j, V, q, a, A, !0) : Oi(M.functionType, _, b, y, e, j, V, q, a, A),
              atlasTexture: k,
              atlasInterpolation: B,
              isSDF: R,
              hasHalo: G
            };
            if (w) for (var X = 0, H = P.segments.get(); X < H.length; X += 1) {
              var K = H[X];
              T.push({
                segments: new t.SegmentVector([K]),
                sortKey: K.sortKey,
                state: W
              });
            } else T.push({
      ...
      w && T.sort(function (t, e) {
        return t.sortKey - e.sortKey;
      });

      for (var Y = 0, J = T; Y < J.length; Y += 1) {
        var Q = J[Y],
            $ = Q.state;

        if ($.atlasTexture.bind($.atlasInterpolation, m.CLAMP_TO_EDGE), $.isSDF) {
          var tt = $.uniformValues;
          $.hasHalo && (tt.u_is_halo = 1, Hi($.buffers, Q.segments, o, e, $.program, E, h, p, tt)), tt.u_is_halo = 0;
        }

        Hi($.buffers, Q.segments, o, e, $.program, E, h, p, $.uniformValues);
      }
    }

    function Hi(t, e, i, o, r, a, n, s, l) {
      var c = o.context,
          u = c.gl;
      r.draw(c, u.TRIANGLES, a, n, s, Tt.disabled, l, i.id, t.layoutVertexBuffer, t.indexBuffer, e, i.paint, o.transform.zoom, t.programConfigurations.get(i.id), t.dynamicLayoutVertexBuffer, t.opacityVertexBuffer);
    }
        ...
        if (!_ || y.patternsLoaded()) {
          ...
          if (x) {
            ...
            if (n) {
              ...
              c = "fillOutlinePattern" === l && _ ? vi(C, t, f, y, S) : gi(C, S);
            } else u = x.indexBuffer, h = x.segments, c = _ ? mi(C, t, f, y) : fi(C);

            w.draw(t.context, s, r, t.stencilModeForClipping(v), a, Tt.disabled, c, i.id, x.layoutVertexBuffer, u, h, i.paint, t.transform.zoom, b);
          }
        }
      }
    }
    ...
    function Yi(e, i) {
      ...
      if (e.depthRboNeedsClear && e.setupOffscreenDepthRenderbuffer(), !a) {
        var n = new t.Texture(o, {
          width: e.width,
          height: e.height,
          data: null
        }, r.RGBA);
        n.bind(r.LINEAR, r.CLAMP_TO_EDGE), (a = i.viewportFrame = o.createFramebuffer(e.width, e.height)).colorAttachment.set(n.texture);
      }

      o.bindFramebuffer.set(a.framebuffer), a.depthAttachment.set(e.depthRbo), e.depthRboNeedsClear && (o.clear({
        depth: 1
      }), e.depthRboNeedsClear = !1), o.clear({
        color: t.Color.transparent
      }), o.setStencilMode(wt.disabled), o.setDepthMode(new bt(r.LEQUAL, bt.ReadWrite, [0, 1])), o.setColorMode(e.colorModeForRenderPass());
    }

    function Ji(t, e, i) {
      var o = e.viewportFrame;

      if (o) {
        var r = t.context,
            a = r.gl;
        r.activeTexture.set(a.TEXTURE0), a.bindTexture(a.TEXTURE_2D, o.colorAttachment.get()), t.useProgram("extrusionTexture").draw(r, a.TRIANGLES, bt.disabled, wt.disabled, t.colorModeForRenderPass(), Tt.disabled, _i(t, i, 0), e.id, t.viewportBuffer, t.quadTriangleIndexBuffer, t.viewportSegments, e.paint, t.transform.zoom);
      }
    }

    function Qi(t, e, i, o, r, a) {
      var n = t.context,
          s = n.gl,
          l = e.fbo;
      ...
      if (l) {
        ...
        var u = Ci(t, e, i);
        e.maskedBoundsBuffer && e.maskedIndexBuffer && e.segments ? c.draw(n, s.TRIANGLES, o, r, a, Tt.disabled, u, i.id, e.maskedBoundsBuffer, e.maskedIndexBuffer, e.segments) : c.draw(n, s.TRIANGLES, o, r, a, Tt.disabled, u, i.id, t.rasterBoundsBuffer, t.quadTriangleIndexBuffer, t.rasterBoundsSegments);
      }
    }

    function $i(e, i, o, r, a, n, s) {
      var l = e.context,
          c = l.gl;
      ...
      if (i.dem && i.dem.data) {
        ...
        l.bindFramebuffer.set(_.framebuffer), l.viewport.set([0, 0, u, u]), e.useProgram("hillshadePrepare").draw(l, c.TRIANGLES, a, n, s, Tt.disabled, Si(i, r), o.id, e.rasterBoundsBuffer, e.quadTriangleIndexBuffer, e.rasterBoundsSegments), i.needsHillshadePrepare = !1;
      }
    }

    function to(e, i, o, r, a) {
    ...
    function eo(e, i, o) {
      var r = e.context,
          ...
          h = "$debug";
      s.draw(r, a.LINE_STRIP, l, c, u, Tt.disabled, wi(n, t.Color.red), h, e.debugBuffer, e.tileBorderIndexBuffer, e.debugSegments);

      for (var p = function (t, e, i, o) {
        o = o || 1;
        var r,
            a,
            n,
        ...
        for (r = 0, a = t.length; r < a; r++) if (l = io[t[r]]) {
        ...
        return p;
      }(o.toString(), 50, 200, 5), d = new t.StructArrayLayout2i4(), _ = new t.StructArrayLayout2ui4(), f = 0; f < p.length; f += 2) d.emplaceBack(p[f], p[f + 1]), _.emplaceBack(f, f + 1);

      for (var m = r.createVertexBuffer(d, Ae.members), g = r.createIndexBuffer(_), v = t.SegmentVector.simpleSegment(0, 0, d.length / 2, d.length / 2), y = i.getTile(o).tileSize, x = t.EXTENT / (Math.pow(2, e.transform.zoom - o.overscaledZ) * y), b = [[-1, -1], [-1, 1], [1, -1], [1, 1]], w = 0; w < b.length; w++) {
        var E = b[w];
        s.draw(r, a.LINES, l, c, u, Tt.disabled, wi(t.translate([], n, [x * E[0], x * E[1], 0]), t.Color.white), h, m, g, v);
      }

      s.draw(r, a.LINES, l, c, u, Tt.disabled, wi(n, t.Color.black), h, m, g, v);
    }
    ...
    var oo = {
      ...
      circle: function (t, e, i, o) {
        if ("translucent" === t.renderPass) {
          ...
          if (0 !== r.constantOr(1) || 0 !== a.constantOr(1) && 0 !== n.constantOr(1)) for (var s = t.context, l = s.gl, c = t.depthModeForSublayer(0, bt.ReadOnly), u = wt.disabled, h = t.colorModeForRenderPass(), p = 0; p < o.length; p++) {
            var d = o[p],
                _ = e.getTile(d),
                f = _.getBucket(i);
            ...
            if (f) {
              ...
              t.useProgram("circle", m).draw(s, l.TRIANGLES, c, u, h, Tt.disabled, yi(t, d, _, i), i.id, f.layoutVertexBuffer, f.indexBuffer, f.segments, i.paint, t.transform.zoom, m);
            }
          }
        }
      },
      heatmap: function (e, i, o, r) {
        if (0 !== o.paint.get("heatmap-opacity")) if ("offscreen" === e.renderPass) {
          var a = e.context,
              n = a.gl,
              s = e.depthModeForSublayer(0, bt.ReadOnly),
              l = wt.disabled,
              c = new Et([n.ONE, n.ONE], t.Color.transparent, [!0, !0, !0, !0]);
          !function (t, e, i) {
            var o = t.gl;
          ...
          for (var u = 0; u < r.length; u++) {
            ...
            if (!i.hasRenderableParent(h)) {
              ...
              if (d) {
                ...
                f.draw(a, n.TRIANGLES, s, l, c, Tt.disabled, Ti(h.posMatrix, p, m, o.paint.get("heatmap-intensity")), o.id, d.layoutVertexBuffer, d.indexBuffer, d.segments, o.paint, e.transform.zoom, _);
              }
            }
          }
          ...
          if (a) {
            ...
            n || (n = i.colorRampTexture = new t.Texture(o, i.colorRamp, r.RGBA)), n.bind(r.LINEAR, r.CLAMP_TO_EDGE), e.useProgram("heatmapTexture").draw(o, r.TRIANGLES, bt.disabled, wt.disabled, e.colorModeForRenderPass(), Tt.disabled, Ii(e, i, 0, 1), i.id, e.viewportBuffer, e.quadTriangleIndexBuffer, e.viewportSegments, i.paint, e.transform.zoom);
          }
        }(e, o));
      },
      line: function (e, i, o, r) {
        if ("translucent" === e.renderPass) {
          ...
          if (0 !== a.constantOr(1) && 0 !== n.constantOr(1)) {
            var s = e.depthModeForSublayer(0, bt.ReadOnly),
            ...
            for (var y = 0, x = r; y < x.length; y += 1) {
              ...
              if (!h || w.patternsLoaded()) {
                ...
                if (E) {
                  ...
                  if (z && w.imageAtlas) {
                    var L = w.imageAtlas.patternPositions[z.to],
                        P = w.imageAtlas.patternPositions[z.from];
                    L && P && T.setConstantPatternPositions(L, P);
                  }

                  var D = c ? Ri(e, w, o, c, d) : h ? Di(e, w, o, d) : p ? Pi(e, w, o) : Li(e, w, o);
      ...
      fill: function (e, i, o, r) {
        ...
        if (0 !== n.constantOr(1)) {
          var s = e.colorModeForRenderPass(),
              l = o.paint.get("fill-pattern").constantOr(1) || 1 !== a.constantOr(t.Color.transparent).a || 1 !== n.constantOr(0) ? "translucent" : "opaque";

          if (e.renderPass === l) {
            var c = e.depthModeForSublayer(1, "opaque" === e.renderPass ? bt.ReadWrite : bt.ReadOnly);
            Ki(e, i, o, r, c, s, !1);
          }

          if ("translucent" === e.renderPass && o.paint.get("fill-antialias")) {
            var u = e.depthModeForSublayer(o.getPaintProperty("fill-outline-color") ? 2 : 0, bt.ReadOnly);
            Ki(e, i, o, r, u, s, !0);
          }
        }
      },
      "fill-extrusion": function (t, e, i, o) {
        if (0 !== i.paint.get("fill-extrusion-opacity")) if ("offscreen" === t.renderPass) {
          Yi(t, i);
          var r = new bt(t.context.gl.LEQUAL, bt.ReadWrite, [0, 1]),
              a = wt.disabled,
              n = t.colorModeForRenderPass();
          !function (t, e, i, o, r, a, n) {
            for (var s = t.context, l = s.gl, c = i.paint.get("fill-extrusion-pattern"), u = c.constantOr(1), h = i.getCrossfadeParameters(), p = 0, d = o; p < d.length; p += 1) {
              var _ = d[p],
                  f = e.getTile(_),
                  m = f.getBucket(i);

              if (m) {
                var g = m.programConfigurations.get(i.id),
                    v = t.useProgram(u ? "fillExtrusionPattern" : "fillExtrusion", g);
                u && (t.context.activeTexture.set(l.TEXTURE0), f.imageAtlasTexture.bind(l.LINEAR, l.CLAMP_TO_EDGE), g.updatePatternPaintBuffers(h));
                var y = c.constantOr(null);

                if (y && f.imageAtlas) {
                  var x = f.imageAtlas.patternPositions[y.to],
                      b = f.imageAtlas.patternPositions[y.from];
                  x && b && g.setConstantPatternPositions(x, b);
                }

                var w = t.translatePosMatrix(_.posMatrix, f, i.paint.get("fill-extrusion-translate"), i.paint.get("fill-extrusion-translate-anchor")),
                    E = i.paint.get("fill-extrusion-vertical-gradient"),
                    T = u ? di(w, t, E, _, h, f) : pi(w, t, E);
                v.draw(s, s.gl.TRIANGLES, r, a, n, Tt.backCCW, T, i.id, m.layoutVertexBuffer, m.indexBuffer, m.segments, i.paint, t.transform.zoom, g);
              }
            }
          }(t, e, i, o, r, a, n);
        } else "translucent" === t.renderPass && Ji(t, i, i.paint.get("fill-extrusion-opacity"));
      },
      hillshade: function (t, e, i, o) {
        if ("offscreen" === t.renderPass || "translucent" === t.renderPass) {
          for (var r = t.context, a = e.getSource().maxzoom, n = t.depthModeForSublayer(0, bt.ReadOnly), s = wt.disabled, l = t.colorModeForRenderPass(), c = 0, u = o; c < u.length; c += 1) {
            var h = u[c],
                p = e.getTile(h);
            p.needsHillshadePrepare && "offscreen" === t.renderPass ? $i(t, p, i, a, n, s, l) : "translucent" === t.renderPass && Qi(t, p, i, n, s, l);
          }
      ...
      raster: function (t, e, i, o) {
        if ("translucent" === t.renderPass && 0 !== i.paint.get("raster-opacity")) for (var r = t.context, a = r.gl, n = e.getSource(), s = t.useProgram("raster"), l = wt.disabled, c = t.colorModeForRenderPass(), u = o.length && o[0].overscaledZ, h = !t.options.moving, p = 0, d = o; p < d.length; p += 1) {
          var _ = d[p],
              f = t.depthModeForSublayer(_.overscaledZ - u, 1 === i.paint.get("raster-opacity") ? bt.ReadWrite : bt.ReadOnly, a.LESS),
              m = e.getTile(_),
      ...
      background: function (t, e, i) {
        ...
        if (0 !== r) {
          ...
          if (!t.isPatternMissing(c)) {
            ...
            if (t.renderPass === u) {
              var h = wt.disabled,
                  p = t.depthModeForSublayer(0, "opaque" === u ? bt.ReadWrite : bt.ReadOnly),
              ...
              for (var m = i.getCrossfadeParameters(), g = 0, v = f; g < v.length; g += 1) {
                ...
                _.draw(a, n.TRIANGLES, p, h, d, Tt.disabled, b, i.id, t.tileExtentBuffer, t.quadTriangleIndexBuffer, t.tileExtentSegments);
              }
            }
          }
        }
      ...
      debug: function (t, e, i) {
        for (var o = 0; o < i.length; o++) eo(t, e, i[o]);
      },
      custom: function (t, e, i) {
        ...
        if ("offscreen" === t.renderPass) {
          var a = r.prerender;
          a && (t.setCustomLayerDefaults(), a.call(r, o.gl, t.transform.customLayerMatrix()), o.setDirty(), t.setBaseState()), "3d" === r.renderingMode && (t.setCustomLayerDefaults(), Yi(t, i), r.render(o.gl, t.transform.customLayerMatrix()), o.setDirty(), t.setBaseState());
        } else if ("translucent" === t.renderPass) if ("3d" === r.renderingMode) Ji(t, i, 1);else {
          t.setCustomLayerDefaults(), o.setColorMode(t.colorModeForRenderPass()), o.setStencilMode(wt.disabled);
          var n = t.depthModeForSublayer(0, bt.ReadOnly);
          o.setDepthMode(n), r.render(o.gl, t.transform.customLayerMatrix()), o.setDirty(), t.setBaseState(), o.bindFramebuffer.set(null);
        }
      }
    },
        ro = function (e, i) {
      this.context = new It(e), this.transform = i, this._tileTextures = {}, this.setup(), this.numSublayers = Ct.maxUnderzooming + Ct.maxOverzooming + 1, this.depthEpsilon = 1 / Math.pow(2, 16), this.depthRboNeedsClear = !0, this.emptyProgramConfiguration = new t.ProgramConfiguration(), this.crossTileSymbolIndex = new Le();
    };
    ...
    function so(t, e, i, o, r, a) {
      var n,
          s = ao(t, e),
          l = ao(e, i),
          c = ao(i, t);
      s.dy > l.dy && (n = s, s = l, l = n), s.dy > c.dy && (n = s, s = c, c = n), l.dy > c.dy && (n = l, l = c, c = n), s.dy && no(c, s, o, r, a), l.dy && no(c, l, o, r, a);
    }

    ro.prototype.resize = function (e, i) {
      ...
      a.emplaceBack(0, 0), a.emplaceBack(1, 0), a.emplaceBack(0, 1), a.emplaceBack(1, 1), this.viewportBuffer = e.createVertexBuffer(a, Ae.members), this.viewportSegments = t.SegmentVector.simpleSegment(0, 0, 4, 2);
      ...
      var e = this.context,
          i = e.gl,
          o = t.create$1();
      t.ortho(o, 0, this.width, this.height, 0, 0, 1), t.scale(o, o, [i.drawingBufferWidth, i.drawingBufferHeight, 0]), this.useProgram("clippingMask").draw(e, i.TRIANGLES, bt.disabled, this.stencilClearMode, Et.disabled, Tt.disabled, Ei(o), "$clipping", this.viewportBuffer, this.quadTriangleIndexBuffer, this.viewportSegments);
    }, ro.prototype._renderTileClippingMasks = function (t) {
      var e = this.context,
          i = e.gl;
      e.setColorMode(Et.disabled), e.setDepthMode(bt.disabled);
      ...
      for (var a = 0, n = t; a < n.length; a += 1) {
        var s = n[a],
            l = this._tileClippingMaskIDs[s.key] = r++;
        o.draw(e, i.TRIANGLES, bt.disabled, new wt({
          func: i.ALWAYS,
          mask: 0
        }, l, 255, i.KEEP, i.KEEP, i.REPLACE), Et.disabled, Tt.disabled, Ei(s.posMatrix), "$clipping", this.tileExtentBuffer, this.quadTriangleIndexBuffer, this.tileExtentSegments);
      }
    }, ro.prototype.stencilModeForClipping = function (t) {
      var e = this.context.gl;
      return new wt({
        func: e.EQUAL,
        mask: 255
      ...
      if (this._showOverdrawInspector) {
        return new Et([e.CONSTANT_COLOR, e.ONE], new t.Color(1 / 8, 1 / 8, 1 / 8, 0), [!0, !0, !0, !0]);
      }

      return "opaque" === this.renderPass ? Et.unblended : Et.alphaBlended;
    }, ro.prototype.depthModeForSublayer = function (t, e, i) {
      var o = 1 - ((1 + this.currentLayer) * this.numSublayers + t) * this.depthEpsilon;
      return new bt(i || this.context.gl.LEQUAL, e, [o, o]);
    }, ro.prototype.render = function (e, i) {
      ...
      for (var h in r) {
        var p = r[h];
        l[h] = p.getVisibleCoordinates(), c[h] = l[h].slice().reverse(), u[h] = p.getVisibleCoordinates(!0).reverse();
      }
      ...
      for (var d in r) {
        ...
        if ("raster" === f.type || "raster-dem" === f.type) {
          for (var m = [], g = 0, v = l[d]; g < v.length; g += 1) {
            var y = v[g];
            m.push(_.getTile(y));
          }
      ...
      for (var x = 0, b = o; x < b.length; x += 1) {
        var w = b[x],
            E = this.style._layers[w];

        if (E.hasOffscreenPass() && !E.isHidden(this.transform.zoom)) {
          var T = c[E.source];
          ("custom" === E.type || T.length) && this.renderLayer(this, r[E.source], E, T);
        }
      }
      ...
      for (this.context.bindFramebuffer.set(null), this.context.clear({
        ...
        depth: 1
      }), this._showOverdrawInspector = i.showOverdrawInspector, this.depthRange = (e._order.length + 2) * this.numSublayers * this.depthEpsilon, this.renderPass = "opaque", this.currentLayer = o.length - 1; this.currentLayer >= 0; this.currentLayer--) {
        var I = this.style._layers[o[this.currentLayer]],
            C = r[I.source],
            S = l[I.source];
        I.source !== s && C && (this.clearStencil(), C.getSource().isTileClipped && this._renderTileClippingMasks(S)), this.renderLayer(this, C, I, S), s = I.source;
      }

      for (this.renderPass = "translucent", this.currentLayer = 0, s = null; this.currentLayer < o.length; this.currentLayer++) {
        var z = this.style._layers[o[this.currentLayer]],
            L = r[z.source],
            P = ("symbol" === z.type ? u : c)[z.source];
        z.source !== s && L && (this.clearStencil(), L.getSource().isTileClipped && this._renderTileClippingMasks(l[z.source])), this.renderLayer(this, L, z, P), s = z.source;
      }

      if (this.options.showTileBoundaries) for (var D in r) {
        oo.debug(this, r[D], l[D]);
        break;
      }
    ...
    }, ro.prototype.renderLayer = function (t, e, i, o) {
      i.isHidden(this.transform.zoom) || ("background" === i.type || "custom" === i.type || o.length) && (this.id = i.id, oo[i.type](t, e, i, o));
    }, ro.prototype.translatePosMatrix = function (e, i, o, r, a) {
      if (!o[0] && !o[1]) return e;
    ...
    lo.prototype.clone = function () {
      var t = new lo(this._minZoom, this._maxZoom, this._renderWorldCopies);
      ...
      return i;
    }, lo.prototype.coveringTiles = function (e) {
      ...
      return function (e, i, o, r) {
        ...
        function s(i, s, l) {
          var c, u, h, p;
          if (l >= 0 && l <= a) for (c = i; c < s; c++) u = Math.floor(c / a), h = (c % a + a) % a, 0 !== u && !0 !== r || (p = new t.OverscaledTileID(o, u, e, h, l), n[p.key] = p);
        }

        var l = i.map(function (e) {
          return new t.Point(e.x, e.y)._mult(a);
        });
        return so(l[0], l[1], l[2], 0, a, s), so(l[2], l[3], l[0], 0, a, s), Object.keys(n).map(function (t) {
          return n[t];
        });
    ...
    }, lo.prototype.resize = function (t, e) {
      this.width = t, this.height = e, this.pixelsToGLUnits = [2 / t, -2 / e], this._constrain(), this._calcMatrices();
    }, co.unmodified.get = function () {
      return this._unmodified;
    }, lo.prototype.zoomScale = function (t) {
      return Math.pow(2, t);
    }, lo.prototype.scaleZoom = function (t) {
      return Math.log(t) / Math.LN2;
    }, lo.prototype.project = function (e) {
    ...
    }, lo.prototype.locationPoint = function (t) {
      return this.coordinatePoint(this.locationCoordinate(t));
    }, lo.prototype.pointLocation = function (t) {
      return this.coordinateLocation(this.pointCoordinate(t));
    }, lo.prototype.locationCoordinate = function (e) {
      return t.MercatorCoordinate.fromLngLat(e);
    }, lo.prototype.coordinateLocation = function (t) {
      return t.toLngLat();
    }, lo.prototype.pointCoordinate = function (e) {
      var i = [e.x, e.y, 0, 1],
          o = [e.x, e.y, 1, 1];
    ...
    }, lo.prototype.coordinatePoint = function (e) {
    ...
    }, lo.prototype.setMaxBounds = function (t) {
    ...
    }, lo.prototype.calculatePosMatrix = function (e, i) {
      void 0 === i && (i = !1);
      var o = e.key,
      ...
      if (this.height) {
        ...
        if (t.translate(f, f, [d > .5 ? d - 1 : d, _ > .5 ? _ - 1 : _, 0]), this.alignedProjMatrix = f, l = t.create$1(), t.scale(l, l, [this.width / 2, -this.height / 2, 1]), t.translate(l, l, [1, -1, 0]), this.pixelMatrix = t.multiply(new Float64Array(16), l, this.projMatrix), !(l = t.invert(new Float64Array(16), this.pixelMatrix))) throw new Error("failed to invert matrix");
    ...
    }, lo.prototype.getCameraQueryGeometry = function (e) {
    ...
    var uo = function () {
      var e, i, o, r, a;
      t.bindAll(["_onHashChange", "_updateHash"], this), this._updateHash = (e = this._updateHashUnthrottled.bind(this), i = 300, o = !1, r = 0, a = function () {
        r = 0, o && (e(), r = setTimeout(a, i), o = !1);
      }, function () {
        return o = !0, r || a(), r;
      });
    };

    uo.prototype.addTo = function (e) {
    ...
    }, uo.prototype.getHashString = function (t) {
    ...
    }, fo.prototype._smoothOutEasing = function (e) {
      var i = t.ease;
    ...
    }, mo.prototype._onMouseUp = function (e) {
      if (0 === e.button) {
        var o = this._startPos,
    ...
    }, mo.prototype._onKeyDown = function (t) {
    ...
    }, mo.prototype._fireEvent = function (e, i) {
      return this._map.fire(new t.Event(e, {
        originalEvent: i
      }));
    };

    var go = t.bezier(0, 0, .25, 1),
        vo = function (e, i) {
    ...
    }, vo.prototype.onMouseDown = function (e) {
    ...
    }, vo.prototype._onMouseMove = function (t) {
      var e = i.mousePos(this._el, t);
    ...
    }, vo.prototype._onMouseUp = function (t) {
    ...
    }, vo.prototype._onBlur = function (t) {
      switch (this._state) {
        case "active":
    ...
    }, vo.prototype._inertialRotate = function (t) {
      var e = this;
    ...
    }, vo.prototype._fireEvent = function (e, i) {
    ...
    }, xo.prototype.onMouseDown = function (e) {
    ...
    }, xo.prototype.onTouchStart = function (e) {
    ...
    }, xo.prototype._onMove = function (e) {
      e.preventDefault();
      var o = i.mousePos(this._el, e);
    ...
    }, xo.prototype._onMouseUp = function (t) {
    ...
    }, xo.prototype._onTouchEnd = function (t) {
      switch (this._state) {
        case "active":
    ...
    }, xo.prototype._onBlur = function (t) {
      switch (this._state) {
        case "active":
    ...
    }, xo.prototype._inertialPan = function (t) {
    ...
    }, xo.prototype._fireEvent = function (e, i) {
      return this._map.fire(new t.Event(e, i ? {
        originalEvent: i
      } : {}));
    ...
    Eo.prototype.isEnabled = function () {
      ...
      this.isEnabled() && (this._enabled = !1);
    }, Eo.prototype.onTouchStart = function (t) {
      var e = this;
    ...
    }, Eo.prototype.onDblClick = function (t) {
      this.isEnabled() && (t.originalEvent.preventDefault(), this._zoom(t));
    }, Eo.prototype._zoom = function (t) {
    ...
    Io.prototype.isEnabled = function () {
      return !!this._enabled;
    }, Io.prototype.enable = function (t) {
    ...
    }, Io.prototype.onStart = function (e) {
    ...
    }, Io.prototype._getTouchEventData = function (t) {
    ...
    }, Io.prototype._onEnd = function (e) {
      i.removeEventListener(t.window.document, "touchmove", this._onMove, {
        passive: !1
    ...
    var So = function (e) {
      ...
      return e && (i.__proto__ = e), i.prototype = Object.create(e && e.prototype), i.prototype.constructor = i, i.prototype.getCenter = function () {
        ...
        if (t.isEqual(Object.keys(r.padding).sort(function (t, e) {
          return t < e ? -1 : t > e ? 1 : 0;
        ...
        if (Math.abs(x) < 1e-6 || !isFinite(P)) {
          if (Math.abs(v - y) < 1e-6) return this.easeTo(e, i);
          var D = y < v ? -1 : 1;
          P = Math.abs(Math.log(y / v)) / g, L = function () {
            return 0;
          }, z = function (t) {
        ...
        return e.maxDuration && e.duration > e.maxDuration && (e.duration = 0), this._zooming = !0, this._rotating = n !== c, this._pitching = u !== s, this._prepareEase(i, !1), this._ease(function (e) {
          ...
          var g = 1 === e ? _ : r.unproject(f.add(m.mult(L(h))).mult(d));
    ...
    zo.prototype.getDefaultPosition = function () {
      ...
      if (e) {
        ...
        e.href = t.config.FEEDBACK_URL + "/" + o + (this._map._hash ? this._map._hash.getHashString(!0) : "");
      }
    ...
    }, Po.prototype.remove = function (t) {
    ...
    var Do = t.window.HTMLImageElement,
      ...
      function r(e) {
        var r = this;
        if (null != (e = t.extend({}, Mo, e)).minZoom && null != e.maxZoom && e.minZoom > e.maxZoom) throw new Error("maxZoom must be greater than minZoom");
        var a = new lo(e.minZoom, e.maxZoom, e.renderWorldCopies);
        o.call(this, a, e), this._interactive = e.interactive, this._maxTileCacheSize = e.maxTileCacheSize, this._failIfMajorPerformanceCaveat = e.failIfMajorPerformanceCaveat, this._preserveDrawingBuffer = e.preserveDrawingBuffer, this._trackResize = e.trackResize, this._bearingSnap = e.bearingSnap, this._refreshExpiredTiles = e.refreshExpiredTiles, this._fadeDuration = e.fadeDuration, this._crossSourceCollisions = e.crossSourceCollisions, this._crossFadingFactor = 1, this._collectResourceTiming = e.collectResourceTiming, this._renderTaskQueue = new Po(), this._controls = [], this._mapId = t.uniqueId();
        var n = e.transformRequest;

        if (this._transformRequest = n ? function (t, e) {
          return n(t, e) || {
            url: t
          };
        } : function (t) {
        ...
        this.on("move", function () {
          ...
          for (var s in Co) t[s] = new Co[s](t, e), e.interactive && e[s] && t[s].enable(e[s]);

          i.addEventListener(o, "mouseout", function (e) {
            t.fire(new ho("mouseout", t, e));
          }), i.addEventListener(o, "mousedown", function (r) {
            a = !0, n = i.mousePos(o, r);
            var s = new ho("mousedown", t, r);
            ...
            r && !i && t.fire(new ho("contextmenu", t, r)), r = null, a = !1, t.fire(new ho("mouseup", t, e));
          }), i.addEventListener(o, "mousemove", function (e) {
            if (!t.dragPan.isActive() && !t.dragRotate.isActive()) {
              for (var i = e.target; i && i !== o;) i = i.parentNode;

              i === o && t.fire(new ho("mousemove", t, e));
            }
          }), i.addEventListener(o, "mouseover", function (e) {
            for (var i = e.target; i && i !== o;) i = i.parentNode;

            i === o && t.fire(new ho("mouseover", t, e));
          }), i.addEventListener(o, "touchstart", function (i) {
            var o = new po("touchstart", t, i);
      ...
      return r.prototype._getMapId = function () {
            ...
            return {
              ...
              delegates: {
                mousemove: function (o) {
                  ...
                  n.length ? a || (a = !0, i.call(r, new ho(t, r, o.originalEvent, {
                    features: n
                  }))) : a = !1;
                },
                mouseout: function () {
              ...
              delegates: {
                mousemove: function (o) {
                  (r.getLayer(e) ? r.queryRenderedFeatures(o.point, {
                    layers: [e]
                  }) : []).length ? n = !0 : n && (n = !1, i.call(r, new ho(t, r, o.originalEvent)));
                },
                mouseout: function (e) {
                  n && (n = !1, i.call(r, new ho(t, r, e.originalEvent)));
                }
              }
            };
          }
        ...
        return (!e || !1 !== e.diff && !e.localIdeographFontFamily) && this.style && t ? (this._diffStyle(t, e), this) : this._updateStyle(t, e);
      }, r.prototype._updateStyle = function (t, e) {
        return this.style && (this.style.setEventedParent(null), this.style._remove()), t ? (this.style = new Me(this, e || {}), this.style.setEventedParent(this, {
          style: this.style
        ...
        if ("string" == typeof e) {
          var r = t.normalizeStyleURL(e),
              a = this._transformRequest(r, t.ResourceType.Style);
        ...
        if (void 0 === a && (a = !1), i instanceof Do) {
        ...
        o ? (this.painter = new ro(o, this.transform), t.webpSupported.testSupport(o)) : this.fire(new t.ErrorEvent(new Error("Failed to initialize WebGL")));
        ...
        o && o.loseContext(), ko(this._canvasContainer), ko(this._controlContainer), ko(this._missingCSSCanary), this._container.classList.remove("mapboxgl-map"), this.fire(new t.Event("remove"));
    ...
    var Bo = {
      ...
      showZoom: !0
        ...
        Oo = function (e) {
      var o = this;
      this.options = t.extend({}, Bo, e), this._container = i.create("div", "mapboxgl-ctrl mapboxgl-ctrl-group"), this._container.addEventListener("contextmenu", function (t) {
    ...
    Oo.prototype._rotateCompassArrow = function () {
      ...
      return this._map = t, this.options.showCompass && (this._map.on("rotate", this._rotateCompassArrow), this._rotateCompassArrow(), this._handler = new vo(t, {
        button: "left",
    ...
    }, Oo.prototype._createButton = function (t, e, o) {
    ...
    function No(t, e, i) {
      ...
      for (var r in Uo) o.remove("mapboxgl-" + i + "-anchor-" + r);
    ...
    var Zo,
      ...
      function o(o, r) {
        if (e.call(this), (o instanceof t.window.HTMLElement || r) && (o = t.extend({
          ...
          a.setAttributeNS(null, "height", "41px"), a.setAttributeNS(null, "width", "27px"), a.setAttributeNS(null, "viewBox", "0 0 27 41");
      ...
      return e && (o.__proto__ = e), o.prototype = Object.create(e && e.prototype), o.prototype.constructor = o, o.prototype.addTo = function (t) {
        ...
        this._map && (this._map.transform.renderWorldCopies && (this._lngLat = Fo(this._lngLat, this._pos, this._map.transform)), this._pos = this._map.project(this._lngLat)._add(this._offset), t && "moveend" !== t.type || (this._pos = this._pos.round()), i.setTransform(this._element, Uo[this._anchor] + " translate(" + this._pos.x + "px, " + this._pos.y + "px)"), No(this._element, this._anchor, "marker"));
    ...
    var qo = function (e) {
      ...
      return e && (o.__proto__ = e), o.prototype = Object.create(e && e.prototype), o.prototype.constructor = o, o.prototype.onAdd = function (e) {
        var o;
        return this._map = e, this._container = i.create("div", "mapboxgl-ctrl mapboxgl-ctrl-group"), o = this._setupUI, void 0 !== Zo ? o(Zo) : void 0 !== t.window.navigator.permissions ? t.window.navigator.permissions.query({
          name: "geolocation"
        }).then(function (t) {
          Zo = "denied" !== t.state, o(Zo);
        }) : (Zo = !!t.window.navigator.geolocation, o(Zo)), this._container;
        ...
        this._map.fitBounds(i.toBounds(o), this.options.fitBoundsOptions, {
          geolocateSource: !0
        });
      ...
      unit: "metric"
        ...
        Wo = function (e) {
      this.options = t.extend({}, Go, e), t.bindAll(["_onMove", "setUnit"], this);
    };
    ...
    function Xo(t, e, i) {
      ...
      if (i && "imperial" === i.unit) {
        var p = 3.2808 * h;
        if (p > 5280) Ho(e, c, p / 5280, "mi");else Ho(e, c, p, "ft");
    ...
    }, Wo.prototype.setUnit = function (t) {
      this.options.unit = t, Xo(this._map, this._container, this.options);
    };
    ...
    Ko.prototype.onAdd = function (e) {
      ...
      var e = this._fullscreenButton = i.create("button", this._className + "-icon " + this._className + "-fullscreen", this._controlContainer);
    ...
    var Yo = {
      ...
      className: ""
        ...
        Jo = function (e) {
      function o(i) {
        e.call(this), this.options = t.extend(Object.create(Yo), i), t.bindAll(["_update", "_onClickClose", "remove"], this);
      }
      ...
      return e && (o.__proto__ = e), o.prototype = Object.create(e && e.prototype), o.prototype.constructor = o, o.prototype.addTo = function (e) {
        ...
        if (this._map && this._lngLat && this._content) {
          ...
          i.setTransform(this._container, Uo[r] + " translate(" + c.x + "px," + c.y + "px)"), No(this._container, r, "popup");
        }
    ...
    var Qo = {
      ...
      Map: Ao,
      NavigationControl: Oo,
      GeolocateControl: qo,
      AttributionControl: zo,
      ScaleControl: Wo,
      FullscreenControl: Ko,
      Popup: Jo,
      Marker: jo,
      Style: Me,
      LngLat: t.LngLat,
...
_mapboxGl.default.accessToken = 'pk.eyJ1IjoiYnJhbmRvbmJ1dHRhcnNmb3J0ZW0iLCJhIjoiY2pvZzAyNTNiMDl4azNxcWhwNWh4ZDBtaiJ9.5ebIfzM262wJoUfFraOHXA';
document.addEventListener('DOMContentLoaded', () => {
  (0, _memory.default)('HTML Map Test');
...
},{"mapbox-gl":"node_modules/mapbox-gl/dist/mapbox-gl.js","../memory":"../memory.js"}],"../../../../../.nvm/versions/node/v10.15.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
